...
> [!NOTE]
> For more information about Windows SKU enum values,  see [Device properties](../../intune-service/fundamentals/filters-device-properties.md#available-properties).
...
|           userId           |                                                                              User ID of the user who has this MAM app installed.                                                                              | 00001111-aaaa-2222-bbbb-3333cccc4444 |
|   applicationInstanceId    |                                              Unique identifier of the MAM app instance - similar to ApplicationInstanceKey, but the identifier is a natural key.                                              | 00001111-aaaa-2222-bbbb-3333cccc4444 |
...
| policyId                   | Unique identifier of the Policy in the data warehouse.                                                                                                 | 00001111-aaaa-2222-bbbb-3333cccc4444 |
...
|----------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------|
| userKey                    | Unique identifier of the user in the data warehouse -   surrogate key.                                                                                                                                                         | 123                                  |
| userId                     | Unique identifier of the user - similar to UserKey, but is   a natural key.                                                                                                                                                    | 00001111-aaaa-2222-bbbb-3333cccc4444 |
...
For more about the Intune Data Warehouse, see [Data Warehouse data model](ref-data-model.md).
