...
For more information, see [Intune Data Warehouse API endpoint](ref-api-endpoints.md).
...
13. Select **Get New Access Token**.
    ...
    :::image type="content" alt-text="Information for the access token." source="./media/setup-rest-client/reports-postman_getnewtoken.png":::
...
2. The return data appears in the Postman response body.
   ...
   :::image type="content" alt-text="Postman client status equals 200 OK." source="./media/setup-rest-client/reports-postman_200OK.png" lightbox="./media/setup-rest-client/reports-postman_200OK.png":::
...
7. Open `Program.cs` from the Solution Explorer.
   ...
   :::image type="content" alt-text="Program.cs and Solution Explorer in Visual Studio." source="./media/setup-rest-client/reports-get_rest_data_in.png" lightbox="./media/setup-rest-client/reports-get_rest_data_in.png":::
...
10. Press **Ctrl + F5** to build and execute the Intune.DataWarehouseAPIClient client in Debug mode.
    ...
    ![Date entity retrieved in JSON format.](./media/setup-rest-client/reports-get_rest_data_output.png)
