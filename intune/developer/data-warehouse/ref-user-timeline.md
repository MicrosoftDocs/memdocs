...
- To learn more about the **Current User** entity, see [Reference for current user entity](ref-data-model.md).
- To learn more about the **User** entity, see [Reference for user entity](ref-user.md).
