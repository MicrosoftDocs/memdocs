...
2. In the admin center, expand **Identity** > **Applications**, and then select **App registrations**.
   ...
   :::image type="content" source="./media/configure-graph-api-access/entra-app-reg.png" alt-text="Screenshot of Entra admin center app registrations menu location.":::
...
4. In the **Register an application** pane, specify the following:
    ...
    - A **Redirect URI** value. *This value is optional.*
        ...
        :::image type="content" source="./media/configure-graph-api-access/entra-add-new-app.png" alt-text="Screenshot of the new app properties and value page.":::
...
The following table summarizes the Intune API permission scopes.  The first column shows the name of the feature as displayed in the [Microsoft Intune admin center] and the second column provides the permission scope name.
