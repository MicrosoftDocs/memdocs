...
![Sharing data - iOS old sharing UI](./media/shared/sharing-ui-old.png)

New UI:

![Sharing data - iOS new sharing UI](./media/shared/sharing-ui-new.png)
...
[Plan the Integration]:ios-phase-1.md
[Enabling multi-identity]:ios-phase-5.md
[Stage 5: Multi-Identity]:ios-phase-5.md
[Stage 6: App Protection Conditional Access support]:ios-phase-6.md
[Stage 7: Web-view features]:ios-phase-7.md
[App Protection CA support]:ios-phase-6.md
[Appendix]:ios-appendix.md

<!-- external links -->
[application configuration policies for managed iOS Enterprise devices]:../../intune-service/apps/app-configuration-policies-use-ios
