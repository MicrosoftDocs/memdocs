...
The SDK fully supports Android API 28 (Android 9.0) through Android API 36 (Android 16).
In order to target Android API 36 (Android 16), you must use Intune App SDK `v12.0.0` or later.
...
[Stage 2: The MSAL Prerequisite]:android-phase-2.md
[Default Enrollment]:android-appendix.md#default-enrollment
...
[Policy for limiting data transfer between apps and device or cloud storage locations]:android-phase-7.md#policy-for-limiting-data-transfer-between-apps-and-device-or-cloud-storage-locations
[Policy for restricting content inside notifications]:android-phase-7.md#policy-for-restricting-content-inside-notifications
[Policy for protecting backup data]:android-phase-7.md#policy-for-protecting-backup-data
[Support App Protection CA]:android-phase-7.md#support-app-protection-ca
[Providing a Custom Theme]:android-phase-7.md#providing-a-custom-theme

<!-- Microsoft Learn documentation: Intune overview -->
[Intune App SDK overview]:../../intune-service/developer/app-sdk
[Microsoft Intune app management]:../../intune-service/apps/app-management
[Android app protection policy settings]:../../intune-service/apps/app-protection-policy-settings-android
...
[application configuration policies for managed Android Enterprise devices]:../../intune-service/apps/app-configuration-policies-use-android
[application configuration policies for managed apps]:../../intune-service/apps/app-configuration-policies-managed-app
[App Wrapping Tool for Android]:../../intune-service/developer/app-wrapper-prepare-android
[Prepare line-of-business apps for app protection policies]:../../intune-service/developer/apps-prepare-mobile-application-management
[Turn off Microsoft usage data collection]:../../intune-service/user-help/turn-off-microsoft-usage-data-collection-android
...
[Set up Intune]:../../intune-service/fundamentals/deployment-plan-setup
[Create users]:../../intune-service/fundamentals/users-add
[Create groups]:../../intune-service/fundamentals/groups-add
[Assign licenses]:../../intune-service/fundamentals/licenses-assign
[Create and assign app protection policies]:../../intune-service/apps/app-protection-policies
[app configuration policy]:../../intune-service/apps/app-configuration-policies-overview
