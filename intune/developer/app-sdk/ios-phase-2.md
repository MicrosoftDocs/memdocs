...
4. Ensure the steps to give your iOS app permissions to the Intune Mobile App Management (MAM) service are followed. Use the instructions in the [getting started with the Intune SDK guide](quickstart-integration.md#next-steps-after-integration) under [Give your app access to the Intune Mobile App Management service](quickstart-integration.md#give-your-app-access-to-the-intune-mobile-app-management-service).
...
[Stage 1: Planning the Integration]:ios-phase-1.md
[Stage 3: Intune SDK integration into your iOS app]:ios-phase-3.md
