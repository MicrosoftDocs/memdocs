...
:::image type="content" alt-text="Diagram of MAM-CA remediation flow." source="./media/shared/app-ca-flow.png" lightbox="./media/shared/app-ca-flow.png":::

### MAM compliance process flow

:::image type="content" alt-text="Diagram of MAM compliance process flow." source="./media/shared/mam-compliance-flow.png" lightbox="./media/shared/mam-compliance-flow.png":::
...
[Stage 1: Plan the Integration]:ios-phase-1.md
