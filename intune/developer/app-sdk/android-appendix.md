...
:::image type="content" source="media/shared/intune-app-sdk-android-process-flow.svg" alt-text="High-level architectural diagram for Microsoft Intune."  lightbox="media/shared/intune-app-sdk-android-process-flow.png" :::
...
[configure MSAL]: android-phase-2.md#configure-microsoft-authentication-library-msal

<!-- Other SDK Guide Markdown docs -->
[build tooling]:android-phase-3.md#build-tooling
[Stage 4's Registration vs Enrollment]:android-phase-4.md#registration-vs-enrollment

<!-- Other Intune docs -->
[Review client app protection logs]:../../intune-service/apps/app-protection-policy-settings-log#android-app-protection-policy-settings
[Android app protection policy settings in Microsoft Intune]:../../intune-service/apps/app-protection-policy-settings-android
