...
You can exclude groups of devices or users using the "exclude group" option or by excluding devices using [filters](/intune/intune-service/fundamentals/filters).
