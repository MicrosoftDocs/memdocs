...
> [!TIP]
> For details about bring your own device (BYOD) or enrollment with co-management, see [Enrollment guide: Enroll Windows client devices in Microsoft Intune](../../../fundamentals/deployment-guide-enrollment-windows).
...
- [Bulk enrollment for Windows devices](../../../enrollment/windows-bulk-enroll)  
...
> [!TIP]
> For a more in depth guide about enrollment and choosing the right option, see [Enrollment guide: Enroll iOS and iPadOS devices in Microsoft Intune](../../../fundamentals/deployment-guide-enrollment-ios-ipados)
