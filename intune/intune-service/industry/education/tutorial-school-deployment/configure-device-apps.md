...
Enterprise App Management enables you to easily discover and deploy applications and keep them up to date from the Enterprise App Catalog. The Enterprise App Catalog is a collection of prepared Microsoft and non-Microsoft applications. These apps are Win32 apps that are [prepared as Win32 apps](/intune/app-management/deployment/win32-packaging) and hosted by Microsoft.

> [!IMPORTANT]
> Enterprise App Management is an Intune add-on as part of the Intune suite that is available for trial and purchase. For more information, see [Use Intune Suite add-on capabilities](/intune/intune-service/fundamentals/intune-add-ons).

For more information, see [Enterprise Application Management](/intune/app-management/deployment/enterprise-app-catalog).
...
For more information, see [Add Microsoft Store apps](/intune/app-management/deployment/add-microsoft-store).
...
For more information, see [Add web apps](/intune/app-management/deployment/add-web).
...
For more information, see [Configure VPP tokens](/intune/app-management/deployment/manage-vpp-apple).
...
Intune also supports deploying **[iOS/iPadOS LOB apps](/intune/app-management/deployment/add-lob-ios)** from the Intune admin center. A line-of-business (LOB) app is an app that you add to Intune from an IPA app installation file.
...
[MEM-1]: /intune/app-management/deployment/add-win32
