...
>
> For more information, see [Give admin permissions in Microsoft Intune admin center](/intune/intune-service/fundamentals/users-add#give-admin-permissions-in-microsoft-intune-admin-center).
