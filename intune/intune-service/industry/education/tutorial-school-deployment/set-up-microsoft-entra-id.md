...
>
> For more information, see [Give admin permissions in Microsoft Intune admin center](../../../fundamentals/users-add.md#give-admin-permissions-in-microsoft-intune-admin-center).
