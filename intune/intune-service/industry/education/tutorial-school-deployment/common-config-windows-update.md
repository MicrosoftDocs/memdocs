...
- [Update rings for Windows 10 and later policy in Intune](../../../protect/windows-10-update-rings.md)
...
To learn more, see [Use the settings catalog to configure settings on Windows, iOS/iPadOS, and macOS devices](../../../configuration/settings-catalog.md).
...
A [Feature update policy](../../../protect/windows-10-feature-updates.md) can be configured to set devices to a particular version of Windows. Devices running older versions of Windows will update to the specified version. Devices with newer versions of Windows won't perform any feature updates.
