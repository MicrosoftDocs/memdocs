...
- [Update rings for Windows 10 and later policy in Intune](../../../protect/windows-10-update-rings)
...
A [Feature update policy](../../../protect/windows-10-feature-updates) can be configured to set devices to a particular version of Windows. Devices running older versions of Windows will update to the specified version. Devices with newer versions of Windows won't perform any feature updates.
