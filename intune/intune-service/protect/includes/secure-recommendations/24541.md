...
- [Use the Microsoft Graph API for Intune to view the properties and group assignments of your Windows compliance policies](/graph/api/resources/intune-deviceconfig-devicecompliancepolicy)
