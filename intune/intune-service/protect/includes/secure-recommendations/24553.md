...
- [Windows quality updates policy](/intune/device-updates/windows/quality-updates-policy) - *to install the regular monthly updates for Windows.*
- [Expedite updates policy](/intune/device-updates/windows/expedite-updates) - *to quickly install critical security patches.*
- [Feature updates policy](/intune/device-updates/windows/feature-updates)
- [Update rings policy](/intune/device-updates/windows/update-rings) - *to manage how and when devices install feature and quality updates.*
- [Windows driver updates](/intune/device-updates/windows/driver-updates-overview) - *to update hardware components.*
