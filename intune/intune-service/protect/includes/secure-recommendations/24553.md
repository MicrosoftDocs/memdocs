...
- [Windows quality updates policy](/intune/device-updates/windows/quality-updates) - *to install the regular monthly updates for Windows.*
...
- [Windows driver updates](/intune/device-updates/windows/driver-updates) - *to update hardware components.*
