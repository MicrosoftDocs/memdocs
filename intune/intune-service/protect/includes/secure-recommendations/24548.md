...
- [Learn about the iOS app protection settings you can manage with Intune](/intune/intune-service/apps/app-protection-policy-settings-ios?source=recommendations)