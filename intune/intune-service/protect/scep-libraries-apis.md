...
4. [Enroll devices](/mem/intune-service/fundamentals/deployment-guide-enrollment) to test the scenarios in the [scenario testing matrix](https://github.com/Microsoft/Intune-Resource-Access/blob/develop/src/CsrValidation/doc/TestMatrix.csv).
...
- [Device enrollment](/mem/intune-service/fundamentals/deployment-guide-enrollment)
