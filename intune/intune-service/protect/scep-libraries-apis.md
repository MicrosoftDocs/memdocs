...
4. [Enroll devices](/intune/intune-service/fundamentals/deployment-guide-enrollment) to test the scenarios in the [scenario testing matrix](https://github.com/Microsoft/Intune-Resource-Access/blob/develop/src/CsrValidation/doc/TestMatrix.csv).
...
- [Device enrollment](/intune/intune-service/fundamentals/deployment-guide-enrollment)
