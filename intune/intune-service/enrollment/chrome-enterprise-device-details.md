...
1. In the Microsoft Intune admin center, [create a group](/intune/intune-service/fundamentals/groups-add#add-a-new-group) with the following details:  
