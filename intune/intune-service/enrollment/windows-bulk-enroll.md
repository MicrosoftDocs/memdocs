...
> To check the capabilities alongside other Windows enrollment methods, see [Intune enrollment method capabilities for Windows devices](/mem/intune-service/fundamentals/deployment-guide-enrollment-windows).  
