...
For end user help and how-to guides, see [Microsoft Intune user help docs](/mem/user-help/enrollment/overview). Feel free to use the articles in that doc set as templates for your organization's onboarding resources.
