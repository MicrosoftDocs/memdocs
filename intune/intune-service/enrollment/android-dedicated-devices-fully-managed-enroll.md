...
| Enrollment method | Minimum Android OS version for dedicated |
| ----- | ----- |
...
> [!TIP]
> Corporate-owned work profile (COPE), Fully Managed device management (COBO) is available on Android version 10.0 and newer.
