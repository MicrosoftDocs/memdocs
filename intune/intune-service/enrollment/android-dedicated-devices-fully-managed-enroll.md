...
1. Select the URL and append the string `.EXTRA_ENROLLMENT_TOKEN%22:%22**{INSERT_TOKEN_HERE}**%22%7D%7D` to the end. Replace `INSERT_TOKEN_HERE` with the copied token string.  
