...
|-----------|---------|--------|----------------|
| Microsoft Edge\SmartScreen settings | Configure Microsoft Defender SmartScreen | Enabled | [/deployedge/microsoft-edge-browser-policies/smartscreenenabled](/deployedge/microsoft-edge-browser-policies/smartscreenenabled) |
| Microsoft Edge\Automatic HTTPS | Enable automatic HTTPS | Enabled | [/deployedge/microsoft-edge-browser-policies/httpsonlymode](/deployedge/microsoft-edge-browser-policies/httpsonlymode) |
| Microsoft Edge\Content settings | Block third party cookies | Enabled | [/deployedge/microsoft-edge-browser-policies/thirdpartycookiesblocked](/deployedge/microsoft-edge-browser-policies/thirdpartycookiesblocked) |
| Microsoft Edge\Content settings | Configure cookies | Disabled | [/deployedge/microsoft-edge-browser-policies/defaultcookiessetting](/deployedge/microsoft-edge-browser-policies/defaultcookiessetting) |
| Microsoft Edge\Content settings | Default pop-up window setting | Do not allow any site to show popups (2) | [/deployedge/microsoft-edge-browser-policies/defaultpopupssetting](/deployedge/microsoft-edge-browser-policies/defaultpopupssetting) |
| Microsoft Edge\Content settings | Default notification setting | Do not allow any site to show desktop notifications (2) | [/deployedge/microsoft-edge-browser-policies/defaultnotificationssetting](/deployedge/microsoft-edge-browser-policies/defaultnotificationssetting) |
| Microsoft Edge\Content settings | Default geolocation setting | Don’t allow any site to track users’ physical location (2) | [/deployedge/microsoft-edge-browser-policies/defaultgeolocationbehavior](/deployedge/microsoft-edge-browser-policies/defaultgeolocationbehavior) |
| Microsoft Edge\Content settings | Allow or block video capture | Enabled | [/deployedge/microsoft-edge-browser-policies/videocaptureallowed](/deployedge/microsoft-edge-browser-policies/videocaptureallowed) |
| Microsoft Edge\Content settings | Allow or block audio capture | Enabled | [/deployedge/microsoft-edge-browser-policies/audiocaptureallowed](/deployedge/microsoft-edge-browser-policies/audiocaptureallowed) |
| Microsoft Edge\Privacy & data protection | Block tracking of users' web-browsing activity | Strict (3) | [/deployedge/microsoft-edge-browser-policies/trackingprevention](/deployedge/microsoft-edge-browser-policies/trackingprevention) |
| Microsoft Edge\Privacy & data protection | Allow personalization of ads, search and news by sending browsing history to Microsoft | Disabled | [/deployedge/microsoft-edge-browser-policies/personalizationreportingenabled](/deployedge/microsoft-edge-browser-policies/personalizationreportingenabled) |
| Microsoft Edge\Privacy & data protection | Enable network prediction | Don’t predict network actions on any network connection (2) | [/deployedge/microsoft-edge-browser-policies/networkpredictionoptions](/deployedge/microsoft-edge-browser-policies/networkpredictionoptions) |
| Microsoft Edge\Privacy & data protection | Enable search suggestions | Disabled | [/deployedge/microsoft-edge-browser-policies/searchsuggestenabled](/deployedge/microsoft-edge-browser-policies/searchsuggestenabled) |
| Microsoft Edge\Privacy & data protection | Send required and optional diagnostic data about browser usage | Off (0) | [/deployedge/microsoft-edge-browser-policies/diagnosticdata](/deployedge/microsoft-edge-browser-policies/diagnosticdata) |
| Microsoft Edge\Privacy & data protection | Disable saving browser history | Enabled | [/deployedge/microsoft-edge-browser-policies/savingbrowserhistorydisabled](/deployedge/microsoft-edge-browser-policies/savingbrowserhistorydisabled) |
| Microsoft Edge\Privacy & data protection | Enable the Collections feature | Disabled | [/deployedge/microsoft-edge-browser-policies/browserdatacollectionenabled](/deployedge/microsoft-edge-browser-policies/browserdatacollectionenabled) |
| Microsoft Edge\Privacy Sandbox | Configure Do Not Track | Disabled | [/deployedge/microsoft-edge-browser-policies/configuredonottrack](/deployedge/microsoft-edge-browser-policies/configuredonottrack) |
| Microsoft Edge\Privacy Sandbox | Enforce Google SafeSearch | Enabled | [/deployedge/microsoft-edge-browser-policies/forcegooglesafesearch](/deployedge/microsoft-edge-browser-policies/forcegooglesafesearch) |
| Microsoft Edge\Privacy Sandbox | Enforce Bing SafeSearch | Enabled, Configure strict search restrictions in Bing | [/deployedge/microsoft-edge-browser-policies/forcebingsafesearch](/deployedge/microsoft-edge-browser-policies/forcebingsafesearch) |
| Microsoft Edge\Privacy Sandbox | Force minimum YouTube Restricted Mode | Enabled, 1 Enforce at least Moderate Restricted Mode on YouTube | [/deployedge/microsoft-edge-browser-policies/forceyoutuberestrict](/deployedge/microsoft-edge-browser-policies/forceyoutuberestrict) |
| Microsoft Edge\Privacy Sandbox | Continue running background apps after Microsoft Edge closes | Disabled | [/deployedge/microsoft-edge-browser-policies/backgroundmodeenabled](/deployedge/microsoft-edge-browser-policies/backgroundmodeenabled) |
| Microsoft Edge\Privacy Sandbox | Disable synchronization of data using Microsoft sync services | Disabled | [/deployedge/microsoft-edge-browser-policies/syncdisabled](/deployedge/microsoft-edge-browser-policies/syncdisabled) |
| Microsoft Edge\Password Manager and Protection | Enable saving passwords to the password manager | Disabled | [/deployedge/microsoft-edge-browser-policies/passwordmanagerenabled](/deployedge/microsoft-edge-browser-policies/passwordmanagerenabled) |
| Microsoft Edge\Password Manager and Protection | Enable AutoFill for addresses | Disabled | [/deployedge/microsoft-edge-browser-policies/autofilladdressenabled](/deployedge/microsoft-edge-browser-policies/autofilladdressenabled) |
| Microsoft Edge\Password Manager and Protection | Enable AutoFill for payment instruments | Disabled | [/deployedge/microsoft-edge-browser-policies/autofillcreditcardenabled](/deployedge/microsoft-edge-browser-policies/autofillcreditcardenabled) |
| Microsoft Edge\Authentication | Force synchronization of browser data and do not show the sync consent prompt | Disabled | [/deployedge/microsoft-edge-browser-policies/forcesync](/deployedge/microsoft-edge-browser-policies/forcesync) |
| Microsoft Edge\Authentication | Windows Hello For HTTP Auth Enabled | Enabled | [/deployedge/microsoft-edge-browser-policies/windowshelloforhttpauthenabled](/deployedge/microsoft-edge-browser-policies/windowshelloforhttpauthenabled) |
| Microsoft Edge\Import Controls | Allow importing of autofill form data | Disabled | [/deployedge/microsoft-edge-browser-policies/importautofillformdata](/deployedge/microsoft-edge-browser-policies/importautofillformdata) |
| Microsoft Edge\Import Controls | Allow importing of saved passwords | Disabled | [/deployedge/microsoft-edge-browser-policies/importsavedpasswords](/deployedge/microsoft-edge-browser-policies/importsavedpasswords) |
| Microsoft Edge\Import Controls | Allow importing of browsing history | Disabled | [/deployedge/microsoft-edge-browser-policies/importhistory](/deployedge/microsoft-edge-browser-policies/importhistory) |
| Microsoft Edge\Import Controls | Allow importing of Cookies | Disabled | [/deployedge/microsoft-edge-browser-policies/importcookies](/deployedge/microsoft-edge-browser-policies/importcookies) |
| Microsoft Edge\Import Controls | Allow importing of extensions | Disabled | [/deployedge/microsoft-edge-browser-policies/importextensions](/deployedge/microsoft-edge-browser-policies/importextensions) |
| Microsoft Edge\Import Controls | Allow importing of payment info | Disabled | [/deployedge/microsoft-edge-browser-policies/importpaymentinfo](/deployedge/microsoft-edge-browser-policies/importpaymentinfo) |
| Microsoft Edge\Import Controls | Allow importing of open tabs | Disabled | [/deployedge/microsoft-edge-browser-policies/importopentabs](/deployedge/microsoft-edge-browser-policies/importopentabs) |
| Microsoft Edge\Import Controls | Allow importing of home page settings | Disabled | [/deployedge/microsoft-edge-browser-policies/importhomepage](/deployedge/microsoft-edge-browser-policies/importhomepage) |
| Microsoft Edge\Import Controls | Allow importing of browser settings |  | [/deployedge/microsoft-edge-browser-policies/importbrowsersettings](/deployedge/microsoft-edge-browser-policies/importbrowsersettings) |
| Microsoft Edge\Startup, home page and new tab page | Configure the home page URL | https://copilot.microsoft.com/ | [/deployedge/microsoft-edge-browser-policies/homepagelocation](/deployedge/microsoft-edge-browser-policies/homepagelocation) |
| Microsoft Edge\Startup, home page and new tab page | Show Home button on toolbar | Enabled | [/deployedge/microsoft-edge-browser-policies/showhomebutton](/deployedge/microsoft-edge-browser-policies/showhomebutton) |
| Microsoft Edge\Startup, home page and new tab page | Configure the new tab page URL | https://copilot.microsoft.com/ | [/deployedge/microsoft-edge-browser-policies/newtabpageurl](/deployedge/microsoft-edge-browser-policies/newtabpageurl) |
| Microsoft Edge\Startup, home page and new tab page | Allow quick links on the new tab page | Enabled | [/deployedge/microsoft-edge-browser-policies/newtabpagequicklinksenabled](/deployedge/microsoft-edge-browser-policies/newtabpagequicklinksenabled) |
| Microsoft Edge\Startup, home page and new tab page | Hide the First-run experience and splash screen | Enabled | [/deployedge/microsoft-edge-browser-policies/hidefirstrunexperience](/deployedge/microsoft-edge-browser-policies/hidefirstrunexperience) |
| Microsoft Edge\Network settings | Control the mode of DNS-over-HTTPS | Enable > Enable DNS-over-HTTPS without insecure fallback | [/deployedge/microsoft-edge-browser-policies/dnsoverhttpsmode](/deployedge/microsoft-edge-browser-policies/dnsoverhttpsmode) |
| Microsoft Edge\Network settings | Specify URI template of desired DNS-over-HTTPS resolver | https://cloudflare-dns.com/dns-query | [/deployedge/microsoft-edge-browser-policies/dnsoverhttpstemplates](/deployedge/microsoft-edge-browser-policies/dnsoverhttpstemplates) |
| Microsoft Edge\Network settings | DNS interception checks enabled | Enabled | [/deployedge/microsoft-edge-browser-policies/dnsinterceptionchecksenabled](/deployedge/microsoft-edge-browser-policies/dnsinterceptionchecksenabled) |
| Microsoft Edge\Network settings | Allow QUIC protocol | Disabled | [/deployedge/microsoft-edge-browser-policies/quicallowed](/deployedge/microsoft-edge-browser-policies/quicallowed) |
| Microsoft Edge\Extensions | Control which extensions cannot be installed | ["external_component", "external_pref", "external_registry", "external_policy_download"] | [/deployedge/microsoft-edge-browser-policies/extensioninstallblocklist](/deployedge/microsoft-edge-browser-policies/extensioninstallblocklist) |
| Microsoft Edge\Extensions | Configure extension management settings | {"*": {"installation_mode": "blocked"}} | [/deployedge/microsoft-edge-browser-policies/extensionsettings](/deployedge/microsoft-edge-browser-policies/extensionsettings) |
| Microsoft Edge\Downloads and files | Allow download restrictions | Block dangerous downloads (1) | [/deployedge/microsoft-edge-browser-policies/downloadrestrictions](/deployedge/microsoft-edge-browser-policies/downloadrestrictions) |
| Microsoft Edge\Downloads and files | Set download directory | ${user_home}/Downloads/Edge | [/deployedge/microsoft-edge-browser-policies/downloaddirectory](/deployedge/microsoft-edge-browser-policies/downloaddirectory) |
| Microsoft Edge\Downloads and files | Ask where to save downloaded files | Enabled | [/deployedge/microsoft-edge-browser-policies/promptfordownloadlocation](/deployedge/microsoft-edge-browser-policies/promptfordownloadlocation) |
| Microsoft Edge\Feature controls | Show Hubs Sidebar | Disabled | [/deployedge/microsoft-edge-browser-policies/hubssidebarenabled](/deployedge/microsoft-edge-browser-policies/hubssidebarenabled) |
| Microsoft Edge\Feature controls | Show Microsoft Rewards experiences | Disabled | [/deployedge/microsoft-edge-browser-policies/showmicrosoftrewards](/deployedge/microsoft-edge-browser-policies/showmicrosoftrewards) |
| Microsoft Edge\Feature controls | Shopping in Microsoft Edge Enabled | Disabled | [/deployedge/microsoft-edge-browser-policies/edgeshoppingassistantenabled](/deployedge/microsoft-edge-browser-policies/edgeshoppingassistantenabled) |
| Microsoft Edge\Feature controls | Control whether Microsoft 365 Copilot Chat shows in the Microsoft Edge for Business toolbar | Disabled | [/deployedge/microsoft-edge-browser-policies/microsoft365copilotchaticonenabled](/deployedge/microsoft-edge-browser-policies/microsoft365copilotchaticonenabled) |
| Microsoft Edge\Feature controls | Enable Workspaces | Enabled | [/deployedge/microsoft-edge-browser-policies/edgeworkspacesenabled](/deployedge/microsoft-edge-browser-policies/edgeworkspacesenabled) |
| Microsoft Edge\Feature controls | Allow or deny screen capture | Disabled | [/deployedge/microsoft-edge-browser-policies/screencaptureallowed](/deployedge/microsoft-edge-browser-policies/screencaptureallowed) |
| Microsoft Edge\Feature controls | Default sensors setting | Block (2) | [/deployedge/microsoft-edge-browser-policies/defaultsensorssetting](/deployedge/microsoft-edge-browser-policies/defaultsensorssetting) |
| Microsoft Edge Update\Update policy override | Update policy override default | Always allow updates (1) | [/deployedge/microsoft-edge-update-policies#updatedefault](/deployedge/microsoft-edge-update-policies#updatedefault) |
| Microsoft Edge Update\Update policy override | Auto-update check period override | 1440 | [/deployedge/microsoft-edge-update-policies#autoupdatecheckperiodminutes](/deployedge/microsoft-edge-update-policies#autoupdatecheckperiodminutes) |
| Microsoft Edge Update\Preferences | Target Channel override | stable | [/deployedge/microsoft-edge-update-policies#targetchannel](/deployedge/microsoft-edge-update-policies#targetchannel) |
| Microsoft Edge Update\Preferences | Let users update all apps on metered connections | Updates disabled (1) | [/deployedge/microsoft-edge-update-policies#meteredupdatesdefault](/deployedge/microsoft-edge-update-policies#meteredupdatesdefault) |
| Microsoft Edge Update\Experimentation and Configuration Service | Control updater's communication with the Experimentation and Configuration Service | Disabled (0) | [/deployedge/microsoft-edge-update-policies#updaterexperimentationandconfigurationservicecontrol](/deployedge/microsoft-edge-update-policies#updaterexperimentationandconfigurationservicecontrol) |
...
| Microsoft Edge\SmartScreen settings | Configure Microsoft<br>Defender SmartScreen to<br>block potentially unwanted apps | Enabled | [Configure Microsoft<br>Defender SmartScreen to<br>block potentially unwanted apps](/deployedge/microsoft-edge-browser-policies/smartscreenpuaenabled) |
...
| Microsoft Edge\Additional | Block clipboard use<br>on specific sites | Enabled, * | [Block clipboard use<br>on specific sites](/deployedge/microsoft-edge-browser-policies/clipboardblockedforurls) |
