...
When testing changes to an app protection policy, be aware of the [delivery timing](app-protection-policy-delivery.md). The status of app protection policy delivery for a given user can be monitored. For more information, see [How to monitor app protection policies](app-protection-policies-monitor.md).
