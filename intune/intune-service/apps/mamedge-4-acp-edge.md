...
> [!IMPORTANT]
> Never deploy both App Configuration Policies and Settings Catalog policies to the same client. Choose the appropriate policy type based on device enrollment status to avoid policy conflicts.
