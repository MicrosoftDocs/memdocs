...
> - Software inventory collection for Discovered apps on Windows requires an AAD user logged on to the device. For devices without an AAD user logged on, Discovered apps data would not get updated.
