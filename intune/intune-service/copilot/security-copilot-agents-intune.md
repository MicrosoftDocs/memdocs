...
- [Microsoft Defender for Endpoint](../protect/advanced-threat-protection) - *Defender for Endpoint must be integrated with Intune.*
- [Microsoft Defender Vulnerability Management](../protect/advanced-threat-protection) *Available as part of Defender for Endpoint Plan 2, or as an add-on to Defender for Endpoint Plan 1.*
