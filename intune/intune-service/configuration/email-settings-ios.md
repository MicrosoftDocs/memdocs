...
- These settings:
  ...
  - Are available for all enrollment types. For more information on the enrollment types, go to [iOS/iPadOS enrollment](/mem/intune-service/fundamentals/deployment-guide-enrollment-ios-ipados).
