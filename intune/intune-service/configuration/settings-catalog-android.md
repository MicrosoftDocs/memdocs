...
params:
  siblings_only: true
ms.reviewer: CharlotteChristensen
ms.suite: ems
...
# Android Enterprise device settings list in the Intune settings catalog

This article lists and describes the Android Enterprise settings you can configure in a settings catalog policy in Microsoft Intune.
...
## Android Enterprise device settings
