...
8. Configure the following required settings:
    ...
    | **Platform SSO** > **FileVault Policy** </br>(macOS 15+) | **AttemptAuthentication** | This setting allows the device to check Microsoft Entra ID password at the FileVault unlock screen when a Mac is turned on. |
