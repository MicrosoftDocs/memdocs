...
This article describes the different features you can configure, and shows you how to create a device configuration profile. You can also see all the available settings for [iOS/iPadOS and macOS](device-features-apple.md) devices.
...
7. In **Configuration settings**, depending on the platform you chose, the settings you can configure are different. Choose your platform for detailed settings:
    ...
    - [iOS/iPadOS](device-features-apple.md)
    - [macOS](device-features-apple.md)
...
For a list of the settings you can configure in Intune, go to [AirPrint on iOS/iPadOS and macOS](device-features-apple.md#airprint).
...
For a list of the settings you can configure in Intune, go to [App notifications on iOS/iPadOS](device-features-apple.md#app-notifications).
...
For a list of the settings you can configure in Intune, go to [Associated domains](device-features-apple.md#associated-domains).
...
For a list of the settings you can configure in Intune, go to [Home screen layout on iOS/iPadOS](device-features-apple.md#home-screen-layout).
...
For a list of the settings you can configure in Intune, go to [Lock screen message settings on iOS/iPadOS](device-features-apple.md#lock-screen-message).
...
For a list of the settings you can configure in Intune, go to [Login items on macOS](device-features-apple.md#login-items).
...
For a list of the settings you can configure in Intune, go to [Login window on macOS](device-features-apple.md#login-window).
...
- **Single sign-on**
  ...
  For a list of the settings you can configure in Intune, go to [Single sign-on on iOS/iPadOS](device-features-apple.md#single-sign-on).
...
For a list of the settings you can configure in Intune, go to [Wallpaper on iOS/iPadOS](device-features-apple.md#wallpaper).
...
For a list of the settings you can configure in Intune, go to [Web content filter on iOS/iPadOS](device-features-apple.md#web-content-filter).
...
- View all the device feature settings for [iOS/iPadOS and macOS](device-features-apple.md) devices.
