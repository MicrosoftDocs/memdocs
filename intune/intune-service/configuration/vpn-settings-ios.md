...
> [!NOTE]
>
> - These settings are available for all enrollment types except user enrollment. User enrollment is limited to [per-app VPN](./vpn-setting-configure-per-app.md). For more information on the enrollment types, see [iOS/iPadOS enrollment](/mem/intune-service/fundamentals/deployment-guide-enrollment-ios-ipados).
>
