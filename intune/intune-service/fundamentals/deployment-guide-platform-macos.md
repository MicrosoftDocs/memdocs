...
| [Identify devices as corporate-owned](../../device-enrollment/add-corporate-identifiers.md)| You can assign corporate-owned status to devices to enable more management and identification capabilities in Intune. Corporate-owned status cannot be assigned to devices enrolled through Apple Business Manager. |
