...
- [Endpoint Privilege Management file elevation requests](../../epm/support-approved.md#manage-pending-elevation-requests) – Found in the admin center at *Endpoint security > Endpoint Privilege Management*.
...
- [Endpoint Privilege Management file elevation requests](../../epm/support-approved.md#rbac-permissions-for-elevation-requests)
