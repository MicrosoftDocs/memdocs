...
| Managed by         | Identifies how the device is managed. For more information, see [Available details by management type](../../device-configuration/endpoint-security-policies/manage-devices.md#available-details-by-management-type). |
