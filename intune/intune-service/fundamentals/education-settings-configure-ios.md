...
- Ensure that you have installed the [Apple Classroom](https://itunes.apple.com/us/app/classroom/id1085319084?mt=8) app on the teacher's device. You can either install the app manually, or use [Intune app management](../../app-management/overview.md).
...
Assign the profile to student devices in the classroom groups that were created when you synchronized your school data with Microsoft Entra ID (see [How to assign device profiles](../../device-configuration/assign-device-profile.md)).
