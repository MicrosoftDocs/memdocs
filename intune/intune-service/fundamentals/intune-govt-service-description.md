...
[text]()# Microsoft Intune for US Government GCC High and DoD service description
...
|Windows Device Health Attestation (DHA)|For more information on Device Health Attestation go to [Device Health Attestation](https://learn.microsoft.com/en-us/windows-server/security/device-health-attestation)
