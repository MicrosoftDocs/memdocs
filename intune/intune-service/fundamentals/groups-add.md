...
3. Select the checkbox for each group you want to delete, and then select **Delete** from the options at the top of the *All Groups* view. Alternately, you can select the name of a group to open a single group’s *Overview* page, and then select *Delete** from the top of that view.
