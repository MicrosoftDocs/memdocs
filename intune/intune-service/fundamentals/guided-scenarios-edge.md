...
- Enroll iOS/iPadOS or Android devices in Intune. For more information, see [Device enrollment](/intune/intune-service/fundamentals/deployment-guide-enrollment).
