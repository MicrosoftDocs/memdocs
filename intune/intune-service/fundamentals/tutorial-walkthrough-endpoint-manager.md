...
12. From the navigation pane, select **Tenant administration** to display details about your Intune tenant.
    ...
    For more information, see [Intune Tenant Status](../../operations/tenant-administration/tenant-status.md).
...
14. From the navigation pane, select **Troubleshooting + support** > **Help and support** to request help.
    ...
    For more information, see [How to get support in Microsoft Intune](../../support/get-support-admin-center.md).
