...
Deleting VMs from Azure leaves orphaned device records in Intune. They'll be automatically [cleaned up](../remote-actions/_device-cleanup-rules) according to the cleanup rules configured for the tenant.
