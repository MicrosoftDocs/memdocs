...
Deleting VMs from Azure leaves orphaned device records in Intune. They'll be automatically [cleaned up](../../operations/device-cleanup-rules.md) according to the cleanup rules configured for the tenant.
