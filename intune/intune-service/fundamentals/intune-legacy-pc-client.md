...
> 4. Determine the right modern enrollment method that's right for your organization. For details, see [Intune enrollment methods for Windows devices](/intune/intune-service/fundamentals/deployment-guide-enroll).
...
## Next steps
[Intune enrollment methods for Windows devices](/intune/intune-service/fundamentals/deployment-guide-enroll)