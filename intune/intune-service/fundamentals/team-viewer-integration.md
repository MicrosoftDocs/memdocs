...
> [!IMPORTANT]
> A new TeamViewer remote assistance experience is available in Intune. This article describes the new integration. You can find your old TeamViewer configurations in the Microsoft Intune admin center under **TeamViewer connector (old)**. You must set up the new connector, called **TeamViewer connector** to enable the experience described in this article. For information about the previous TeamViewer connector, see [Use TeamViewer to remotely administer Intune devices](teamviewer-support.md). If both connectors are enabled in Intune, helpdesk agents see two TeamViewer options when they start a remote assistance session: **TeamViewer (old)** for the existing experience and **TeamViewer** for the new experience.  
...
- All Android device enrollment options: 
...
- TeamViewer account and license: Visit the [TeamViewer Integration docs](https://www.teamviewer.com/en/integrations/microsoft-intune/)(opens TeamViewer website) or contact the TeamViewer sales team for more information about account setup and required licenses.  
...
>[!IMPORTANT]
> If your tenant still uses the old TeamViewer connector, found in the Microsoft Intune admin center under **TeamViewer connector (old)**, see the note at the top of this article for important information.  
...
1. Go to **Tenant administration** > **Connectors and tokens** > **TeamViewer connector**.  
   > [!NOTE]
   > The new TeamViewer connector appears as **TeamViewer connector** in the admin center. The older connector is called **TeamViewer connector (old)**.  
...
1. Intune opens a new browser tab and loads the TeamViewer URL with device identifiers.  
