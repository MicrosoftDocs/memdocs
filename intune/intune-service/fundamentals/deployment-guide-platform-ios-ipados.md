...
|[Set up Apple User Enrollment (in preview)](../enrollment/apple-user-enrollment-with-company-portal.md)|Create a user enrollment profile to deploy the Apple user enrollment experience to devices using a managed Apple ID. Support for this feature is currently in preview. |   
...
|[Troubleshoot enrollment problems](/troubleshoot/intune/intune-service/troubleshoot-ios-enrollment-errors)|Troubleshoot and find resolutions to problems that occur during enrollment. |
