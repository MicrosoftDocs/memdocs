...
|---|---|
|<img alt="Screenshot of Company Portal **Devices** screen with red exclamation point icon next to non-managed device." src="./media/app-ui-updates/company-portal-android-devices-icon-after-2206.png" width="300"> |<img alt="Screenshot of Company Portal **Devices** screen with no icon next to non-managed device" src="./media/app-ui-updates/company-portal-android-devices-icon-before-2206.png" width="300">|


|Updated Device Details screen|Previous Device Details screen|
|---|---|
|<img alt="Screenshot of Company Portal **Devices** screen with with info icon next to message." src="./media/app-ui-updates/company-portal-android-device-details-icon-after-2206.png" width="300"> |<img alt="Screenshot of Company Portal **Devices** screen with info icon next to message." src="./media/app-ui-updates/company-portal-android-device-details-icon-before-2206.png" width="300">|
...
We've added a new privacy consent screen to Company Portal to meet privacy requirements for certain app stores, such as those in China. People installing Company Portal for the first time from those stores will see the new screen during installation. The screen explains what information Microsoft collects and how it's used. A person must agree to the terms before they can use the app. Users who installed Company Portal prior to this release will not see the new screen.
 ...
 > ![Screenshot of new privacy screen that appears to some users in Company Portal.](./media/app-ui-updates/privacy-screen-company-portal-windows-2111.png)
...
We've updated messaging in Company Portal for Android to better introduce and explain how work profile works. After the work profile setup flow, users see a new informational screen explaining where to find work apps, with links to help documentation.
 ...
 > [!div class="mx-imgBorder"]
 > ![Screenshot of Company Portal **Your new work setup** screen.](./media/app-ui-updates/new-work-profile-company-portal-2011.png)
...
|Updated|Previous|
|---|---|
|<img alt="Screenshot of Company Portal **Find your work apps** screen." src="./media/app-ui-updates/find-work-apps-cp-2011.png" width="300"> |<img alt="Example image of previous Company Portal work profile screen before." src="./media/app-ui-updates/intune-company-portal-after-work-profile-2009.png" width="300">|

When they swipe right, they'll learn how to get more work apps from the Google Play Store.  `

 > [!div class="mx-imgBorder"]
 > ![Screenshot of Company Portal **Get more apps for work** screen.](./media/app-ui-updates/get-more-apps-cp-2011.png)
...
Finally, on the **Help** page > **Frequently Asked Questions** section, there's a new link to a Microsoft technical article about how to find work profile apps.
 ...
 > [!div class="mx-imgBorder"]
 > ![Screenshot of Company Portal Help screen highlighting the new FAQ doc link.](./media/app-ui-updates/company-portal-work-profile-link.png)

## Week of September 28, 2020

### Improved work profile messaging in Company Portal for Android
The Company Portal screen previously titled "You're Halfway There!" has been updated to better explain how work profile management works. Users will see this screen if they re-enable Company Portal in the personal profile after they've already gone through work profile enrollment. They may also see this screen during work profile enrollment on some Android OS versions, as shown in the help doc, [Enroll with Android work profile](../user-help/enrollment/enroll-work-profile-android.md).

|Updated|Previous|
|---|---|
|![Example image of updated Company Portal work profile screen.](./media/app-ui-updates/intune-company-portal-after-work-profile-2009.png)|![Example image of previous Company Portal work profile screen.](./media/app-ui-updates/intune-company-portal-before-work-profile-2009.png)|
...
[![Screenshot of Company Portal informational screen showing updated text.](./media/app-ui-updates/device-management-privacy-2005-02.png)](./media/app-ui-updates/device-management-privacy-2005-03.png#lightbox)
...
|---|---|
|![Image of Company Portal for iOS/iPadOS, highlighting updated icons in bottom menu.](./media/app-ui-updates/company-portal-ios-icons-after-2005.png)|![Image of Company Portal for iOS, highlighting the former icons.](./media/app-ui-updates/company-portal-ios-icons-before-2005.png)|

|Updated for macOS|
|---|
|![Image of Company Portal for macOS, Devices tab, highlighting updated icons.](./media/app-ui-updates/company-portal-macos-icons-after-2005.png)|

## Week of May 4, 2020
### Company Portal for Android guides users to get apps after work profile enrollment <!-- 6103999 -->
We've improved the in-app guidance in Company Portal to make it easier for users to find and install apps. After they enroll in work profile management, users will get a message explaining how to find suggested apps in the badged version of Google Play. The last step in [Enroll device with Android profile](../user-help/enrollment/enroll-work-profile-android.md) has been updated to show the new message.

![Example image of Company Portal, Devices tab prompt to open badged version of Google Play.](./media/app-ui-updates/updated-banner-android-2005.png)

Users will also see a new **Get Apps** link in the Company Portal drawer on the left.

![Example image Company Portal left-hand drawer, highlighting Get apps menu item.](./media/app-ui-updates/updated-drawer-android-2005.png)

To make way for these new and improved experiences, the **APPS** tab shown in the following image has been removed.

![Example image of the now removed Company Portal, Apps tab.](./media/app-ui-updates/apps-tab-android-removed-2005.png)

## Week of March 2, 2020
### Improved sign-in experience in Company Portal for Android
We've updated the layout of several sign-in screens in the Company Portal app for Android to make the experience more modern, simple, and clean for users. To see all Company Portal for Android enrollment instructions, go to [Enroll your Android device](../user-help/enrollment/enroll-company-portal-android.md) or [Enroll with Android work profile](../user-help/enrollment/enroll-work-profile-android.md).


|Updated|Previous|
|---|---|
|![Example image of new Company Portal sign in screen, sign in button.](./media/app-ui-updates/intune-company-portal-sign-in-2003.png)|![Example image of previous Company Portal sign in page, showing busier design.](./media/app-ui-updates/intune-company-portal-sign-in-2002.png)|
|![Example image of new sign-in progress screen, showing one progress bar.](./media/app-ui-updates/intune-company-portal-signing-in-2003.png)|![Example image of previous sign-in progress screen, showing a busier design.](./media/app-ui-updates/intune-company-portal-signing-in-2002.png)|
## Week of February 3, 2020

### Screen removed from Company Portal, Android work profile enrollment <!--6103987 -->
The **What's next?** screen has been removed from the Android work profile enrollment flow in Company Portal to streamline the user experience. Go to [Enroll with Android work profile](../user-help/enrollment/enroll-work-profile-android.md) to see the updated Android work profile enrollment flow.
...
![Example image of a web app launched from the Windows Company Portal app](./media/app-ui-updates/webapp-open-in-browser.png)
...
The setup checklist in the Company Portal app for Android has been updated with a lightweight design and new icons. The changes align with the recent updates made to the Company Portal app for iOS/iPadOS. For a look at the updated enrollment steps, see [Enroll with Android work profile](../user-help/enrollment/enroll-work-profile-android.md) and [Enroll your Android device](../user-help/enrollment/enroll-company-portal-android.md).

The following screens show the updated checklist for Android work profile enrollment:

|Updated|Previous|
|---|---|
|![Example image of work profile setup in Company Portal, showing simplified checklist and new icons.](./media/app-ui-updates/work-profile-checklist-1911.png)|![Example image of the previous work profile setup in Company Portal, showing a busier checklist.](./media/app-ui-updates/work-profile-checklist-1904.png)|

The following screens show the updated checklist for Android device administrator enrollment:

|Updated|Previous|
|---|---|
|![Example image of Android device admin setup in Company Portal, showing simplified checklist and new icons.](./media/app-ui-updates/android-checklist-1911.png)|![Example image of the previous Android device admin setup in Company Portal, showing a busier checklist.](./media/app-ui-updates/android-checklist-1904.png)|
...
- Added the display of custom push notifications, aligning the app with the support recently added in the Company Portal app for iOS and Android. For more information, see [Send custom notifications in Intune](../device-management/actions/send-custom-notification.md).

    User profile example:<br>
    <img src="./media/app-ui-updates/intune-app-android-device-profile.png" alt="Screenshot of Microsoft Intune app for Android - User Profile" width="300">

    Notifications and bottom navigation example:<br>
    <img src="./media/app-ui-updates/intune-app-android-device-notify.png" alt="Screenshot of Microsoft Intune app for Android - Notification" width="300">
...
![Screenshot of Company Portal website, Installed Apps page.](./media/app-ui-updates/intune-installed-apps-1907.png)
...
![Example screenshot of the Company Portal app for Windows, Installed apps page.](./media/app-ui-updates/installed-apps-cp-1906.png)
...
![Screenshot of Microsoft Intune app, showing device details for Jane's Android.](./media/app-ui-updates/1904-intune-app-device-details.png)

Example screenshot the **Setup access** screen:

![Screenshot of Microsoft Intune app, showing Setup access enrollment screen.](./media/app-ui-updates/1904-intune-app-setup-access.png)

Example screenshot of the app menu:

![Screenshot of Microsoft Intune app, showing the side menu.](./media/app-ui-updates/1904-intune-app-navigation-menu.png)

Example screenshot of the **Help** screen:

![Screenshot of Microsoft Intune app, Help screen.](./media/app-ui-updates/1904-intune-app-help.png)
...
For updated enrollment steps and screens, see [Enroll iOS device in Intune](../user-help/enrollment/enroll-ios.md).
...
|Updated|Previous|
|---|---|
|![The updated device page shows the device cleanly aligned above device information, no longer popping up above the full list.](./media/app-ui-updates/iwp-device-after-1803.png)|![The previous version of the device page.](./media/app-ui-updates/iwp-device-before-1803.png)|
|![The updated app install page shows the app cleanly above a description and various install information, including publish date, version, and type of app.](./media/app-ui-updates/iwp-app-install-after-1803.png)|![The previous version of the app install page.](./media/app-ui-updates/iwp-app-install-before-1803.png)|
...
![Screenshot of the Windows task bar on a device's desktop. Company Portal app program icon has been clicked to show a menu with options "Pin to taskbar," "Close window," and "Sync this device" action.](./media/app-ui-updates/sync-device-from-start-menu-1807.png)
...
![Screenshot of the Intune Company Portal app for Windows showing the installed apps in tile view.](./media/app-ui-updates/tiles-installed-view-cpapp-1807.png)

Example screenshot showing the Details view:

![Screenshot of the Intune Company Portal app for Windows showing the installed apps in details view.](./media/app-ui-updates/details-installed-view-cpapp-1807.png)
...
![Screenshot of the Company Portal app dashboard showing the Fluent Design navigation view](./media/app-ui-updates/1804_WindowsCP_Fluent_01.png)
...
|Before|After|
|---|---|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Apps and My Devices.](./media/app-ui-updates/cp_iosRedesign_before_1803_01.png)|![Screenshot shows Company Portal app for i O S / i Pad O S after update, Apps.](./media/app-ui-updates/cp_iosRedesign_after_1803_01.png)|
|*Combined with previous step*|![Screenshot shows Company Portal app for i O S / i Pad O S after update, My Devices.](./media/app-ui-updates/cp_iosRedesign_after_1803_02.png)|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Device Details.](./media/app-ui-updates/cp_iosRedesign_before_1803_02.png)|![Screenshot shows Company Portal app for i O S / i Pad O S after update, Devices.](./media/app-ui-updates/cp_iosRedesign_after_1803_03.png)|
...
|Before|After|
|---|---|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, previous wording.](./media/app-ui-updates/windows_enroll_before_1803.png)|![Screenshot shows Company Portal app for i O S / i Pad O S after update, new wording.](./media/app-ui-updates/windows_enroll_after_1803.png)|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, previous wording for policy issues.](./media/app-ui-updates/windows_view_policy_issues_before_1803.png)|![Screenshot shows Company Portal app for i O S / i Pad O S after update new wording for policy issues.](./media/app-ui-updates/windows_view_policy_issues_after_1803.png)
...
|Before|After|
|---|---|
|![Screenshot shows Company Portal app for Android, About screen.](./media/app-ui-updates/android_about_before_1803.png)|![Screenshot shows Company Portal app for Android, About screen, updated.](./media/app-ui-updates/androidCP_about_after_1803.png)|
|![Screenshot shows Company Portal app for Android, CONTACT I D screen.](./media/app-ui-updates/android_contact_it_before_1803.png)|![Screenshot shows Company Portal app for Android, CONTACT I D screen, updated.](./media/app-ui-updates/android_contact_it_after_1803.png)|
|![Screenshot shows Company Portal app for Android, DEVICES screen.](./media/app-ui-updates/android_devices_before_1803.png)|![Screenshot shows Company Portal app for Android, DEVICES screen, updated.](./media/app-ui-updates/androidCP_devicelist_after_1803.png)|
|![Screenshot shows Company Portal app for Android, Device Details screen.](./media/app-ui-updates/android_device_details_before_1803.png)|![Screenshot shows Company Portal app for Android, Device Details screen, updated.](./media/app-ui-updates/androidCP_devicedetails_1_after1803.png)|
|![Screenshot shows Company Portal app for Android, Device Details with update option.](./media/app-ui-updates/android_device_details_update_settings_before_1803.png)|![Screenshot shows Company Portal app for Android, Device Details with update option, updated.](./media/app-ui-updates/androidCP_devicedetails_red_box_2_after1803.png)|
|![Screenshot shows Company Portal app for Android, My Profile screen.](./media/app-ui-updates/android_profile_before_1803.png)|![Screenshot shows Company Portal app for Android, My Profile screen, updated.](./media/app-ui-updates/android_profile_after_1803.png)|
|![Screenshot shows Company Portal app for Android, Access Setup screen.](./media/app-ui-updates/androidCP_Setup01_before_1803.png)|![Screenshot shows Company Portal app for Android, Access Setup screen, updated.](./media/app-ui-updates/androidCP_Setup01_after_1803.png)|
...
![Device group mapping category](./media/app-ui-updates/w10_cp_category_device_setup_after_1711.png)
...
|Before|After|
|---|---|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Company Access Setup screen.](./media/app-ui-updates/ios_cp_enroll_01_before_1711.png)|![Screenshot shows Company Portal app for i O S / i Pad O S after update, Set up access screen.](./media/app-ui-updates/ios_cp_enroll_01_after_1711.png)|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Why enroll your device screen.](./media/app-ui-updates/ios_cp_enroll_02_before_1711.png)|*Combined with previous step*|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, privacy information.](./media/app-ui-updates/ios_cp_enroll_03_before_1711.png)|![Screenshot shows Company Portal app for i O S / i Pad O S after update, privacy information.](./media/app-ui-updates/ios_cp_enroll_03_after_1711.png)|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, What comes next screen.](./media/app-ui-updates/ios_cp_enroll_04_before_1711.png)|![Screenshot shows Company Portal app for i O S / i Pad O S after update, What's next screen.](./media/app-ui-updates/ios_cp_enroll_04_after_1711.png)|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Checking compliance message.](./media/app-ui-updates/ios_cp_enroll_05_before_1711.png)|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Confirming device settings.](./media/app-ui-updates/ios_cp_enroll_05_after_1711.png)|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Resolve Compliance Issues screen.](./media/app-ui-updates/ios_cp_enroll_06_before_1711.png)|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Update device settins screen.](./media/app-ui-updates/ios_cp_enroll_06_after_1711.png)|
|![Screenshot shows Company Portal app for i O S / i Pad O S before update, Company Access Setup screen, completed.](./media/app-ui-updates/ios_cp_enroll_07_before_1711.png)|![Screenshot shows Company Portal app for i O S / i Pad O S before update, You're all set screen.](./media/app-ui-updates/ios_cp_enroll_07_after_1711.png)|
...
|Before|After|
|---|---|
|![Screenshot shows Settings page in the Company Portal app for Windows before update.](./media/app-ui-updates/w10-share-logs.png)|![Screenshot shows Settings page in the Company Portal app for Windows after update.](./media/app-ui-updates/w10-share-logs-after-1711.png)|
...
|Before|After|
|---|---|
|![Screenshot shows Company Portal app for Android before update, Company Access Setup screen.](./media/app-ui-updates/android_cp_enroll_01_post_1709.png)|![01](./media/app-ui-updates/android_cp_enroll_01_1709_new.png)|
|![01a](./media/app-ui-updates/android_cp_enroll_01_before_1710.png)| *Combined with previous step* |
|![Screenshot shows Company Portal app for Android before update, privacy information.](./media/app-ui-updates/android_cp_enroll_02_before_1710.png)|![02](./media/app-ui-updates/android_cp_enroll_02_after_1710.png)|
|![Screenshot shows Company Portal app for Android before update, What comes next screen.](./media/app-ui-updates/android_cp_enroll_03_before_1710.png)|![03](./media/app-ui-updates/android_cp_enroll_03_after_1710.png)|

Additional steps have been improved on Android work profile devices.

|Before|After|
|---|---|
|![Screenshot shows Company Portal app for Android work profile devices before update, Company Access Setup screen.](./media/app-ui-updates/android_work_cp_enroll_01_before_1710.png)|![Screenshot shows Company Portal app for Android work profile devices after update, Access Setup screen.](./media/app-ui-updates/android_work_cp_enroll_01_after_1710.png)|
|![05](./media/app-ui-updates/android_work_cp_enroll_02_before_1710.png)| *Combined with previous step* |
|![Screenshot shows Company Portal app for Android work profile devices before update, What comes next screen.](./media/app-ui-updates/android_work_cp_enroll_03_before_1710.png)|![Screenshot shows Company Portal app for Android work profile devices after update, What's next screen.](./media/app-ui-updates/android_work_cp_enroll_03_after_1710.png)|
|![Screenshot shows Company Portal app for Android work profile devices before update, Company Access Setup completed screen.](./media/app-ui-updates/android_work_cp_enroll_04_before_1710.png)|![Screenshot shows Company Portal app for Android work profile devices after update, You're all set screen.](./media/app-ui-updates/android_work_cp_enroll_04_after_1710.png)|
|![08](./media/app-ui-updates/android_work_cp_enroll_05_before_1710.png)| *Combined with previous step* |
...
|Before|After|
|---|---|
|![Screenshot shows Company Portal app for Android before update, Conditional Access email activation screen.](./media/app-ui-updates/android_conditional_access_email_before_1710.png)|![Screenshot shows Company Portal app for Android after update, Conditional Access email activation screen.](./media/app-ui-updates/android_conditional_access_email_after_1710.png)
...
|Before|After|
|---|---|
|![Screenshot shows Company Portal app for Android text before update, Company Access Setup screen.](./media/app-ui-updates/android_cp_enroll_01_before_1709.png)|![Screenshot shows Company Portal app for Android text after update, Company Access Setup screen.](./media/app-ui-updates/android_cp_enroll_01_post_1709.png)|
|![Screenshot shows Company Portal app for Android text before update, Why enroll your device screen.](./media/app-ui-updates/android_cp_enroll_02_before_1709.png)|![Screenshot shows Company Portal app for Android text after update, Benefits of device management screen.](./media/app-ui-updates/android_cp_enroll_02_post_1709.png)|
|![Screenshot shows Company Portal app for Android text before update, Resolve Compliance Issues screen.](./media/app-ui-updates/android_cp_enroll_03_before_1709.png)|![Screenshot shows Company Portal app for Android text after update, Update device settings screen.](./media/app-ui-updates/android_cp_enroll_03_post_1709.png)|
|![Screenshot shows Company Portal app for Android text before update, Device Details screen.](./media/app-ui-updates/android_cp_enroll_04_before_1709.png)|![Screenshot shows Company Portal app for Android text after update, Device Details screen.](./media/app-ui-updates/android_cp_enroll_04_post_1709.png)|
|![Screenshot shows Company Portal app for Android text before update, Company Access Setup screen with Work Profile Setup.](./media/app-ui-updates/android_cp_enroll_05_before_1709.png)|![Screenshot shows Company Portal app for Android text after update, Company Access Setup screen with Work Profile Setup.](./media/app-ui-updates/android_cp_enroll_05_post_1709.png)|
...
![Selecting account type in native mail app.](./media/app-ui-updates/ios-11-ca-email-after-1708-01.png)

![After selecting Exchange, iOS device prompt asks for email address and account name.](./media/app-ui-updates/ios-11-ca-email-after-1708-02.png)

![Provide email address and name for account.](./media/app-ui-updates/ios-11-ca-email-after-1708-03.png)

![Sent to external Microsoft login page.](./media/app-ui-updates/ios-11-ca-email-after-1708-04.png)

![Providing password on Microsoft page.](./media/app-ui-updates/ios-11-ca-email-after-1708-05.png)

![Microsoft prompts user to enroll device into management.](./media/app-ui-updates/ios-11-ca-email-after-1708-06.png)

![User is prompted to enroll from Company Portal website.](./media/app-ui-updates/ios-11-ca-email-after-1708-07.png)
...
![old interface](./media/app-ui-updates/NewUI_Old_AttachFileHandler.jpg)

**Modern experience**

![modern interface](./media/app-ui-updates/NewUI_Modern_AttachFileHandler.jpg)
...
![The Company Portal app for Windows' "Device Details" screen, which now shows the "Categories" field as a property rather than directly below the title of that screen.](./media/app-ui-updates/cp_win10_category_tag_move_after_1708.png)
...
![The new app details page](./media/app-ui-updates/cp_android_appdetails_after_1708.png)
...
![The Company Portal sign-in page, with an icon of a person in front of a graphical representation of a website. The "Sign in" button is Underneath. A link at the bottom leads to Microsoft Privacy and Cookies information.](./media/app-ui-updates/cp_ios_aad_signin_before_1704_001.png)

![After tapping Sign in, the user enters their credentials on this page, which asks for a user's email and password, along with offering ways to resolve password failures.](./media/app-ui-updates/cp_ios_aad_signin_before_1704_002.png)

![After providing their password, the Company Portal app signs in, noting this with a loading bar.](./media/app-ui-updates/cp_ios_aad_signin_before_1704_003.png)

__New sign in experience__

![The Company Portal sign in page, with an icon of a person in front of a graphical representation of a website. Underneath is the "Sign in" button. A link at the bottom leads to Microsoft Privacy and Cookies information.](./media/app-ui-updates/cp_ios_aad_signin_after_1704_001.png)

![The user is prompted to provide just their email address rather than their email and password on the same screen.](./media/app-ui-updates/cp_ios_aad_signin_after_1704_002.png)

![The user is prompted for their password after their email address has been accepted.](./media/app-ui-updates/cp_ios_aad_signin_after_1704_003.png)

![After going through the authentication process, the Company Portal app signs in, noting this with a loading bar.](./media/app-ui-updates/cp_ios_aad_signin_from_another_device_after_1704_007.png)

__New sign in experience when signing in from another device__

![The Company Portal sign-in page, with an icon of a person in front of a graphical representation of a website. Underneath is the "Sign in" button. A link at the bottom leads to Microsoft Privacy and Cookies information.](./media/app-ui-updates/cp_ios_aad_signin_from_another_device_after_1704_001.png)

Tap the __Sign-in from another device__ link.

![Instructions are provided to go to the aka.ms/devicelogin page with a unique passcode from your work computer, then to use the code to sign in.](./media/app-ui-updates/cp_ios_aad_signin_from_another_device_after_1704_003.png)

Launch a browser and go to [https://aka.ms/devicelogin](https://aka.ms/devicelogin).

![An image of the user's browser on their work computer rather than their Company Portal app. The "Device login" page displayed prompts the user for the code they received in the Company Portal app.](./media/app-ui-updates/cp_ios_aad_signin_from_another_device_after_1704_004.png)
...
![The user has input their unique code into the field, and the "Device login" site has asked for confirmation that the Intune Company Portal was the correct app to receive authorization to sign in.](./media/app-ui-updates/cp_ios_aad_signin_from_another_device_after_1704_005.png)

![A confirmation page that states that the user has now signed into the Company Portal app on their device, and that this page can be closed.](./media/app-ui-updates/cp_ios_aad_signin_from_another_device_after_1704_006.png)
...
![An image of the Android Company Portal app, which shows in large text "Access Company Content" in the middle rather than offering immediate enrollment options as is the standard case](./media/app-ui-updates/and_access_company_content_after_1706.png)
...
![An image of the Company Portal website, confirming the sign-in.](./media/app-ui-updates/and_iwp_sign_in_auth_page_after_1706.png)

The device can still be enrolled into full management by tapping on the **action** menu.

![An image of the Company Portal app for Android, showing the menu from the top right corner of the screen with an option to still enroll the device.](./media/app-ui-updates/and_sign_in_menu_after_app_protection_policy_enrolled_after_1706.png)
...
![An image of the Windows Company Portal app, where the download of Microsoft Word is in a pending state from the Company Portal's app store.](./media/app-ui-updates/w10_download_pending_after_1706.png)

![An image of the Windows Company Portal app, with the new automatic syncing state showing with a status message indicating that the device is syncing and attempting to download the app.](./media/app-ui-updates/w10_download_pending_syncing_after_1706.png)
...
![An image of the Windows Company Portal app landing page, with a status message in the middle in the "devices" list which is telling a user that the device they're on hasn't been set up for corporate use yet, and that the user should select the message to begin setup.](./media/app-ui-updates/win10_guided_enroll_select_setup_after_1706.png)

![An image of the Windows Company Portal app setup page, which is warning the user that they need to add a corporate account to this device, then they can enroll it into management.](./media/app-ui-updates/win10_guided_enroll_we_help_setup_after_1706.png)

![An image of the Windows Company Portal app adds corporate account to this device page, which is telling the user that they will need to go to the Settings app and select "Connect" to complete enrollment. After they do this, the screen tells them that they will need to return to the Company Portal app to complete enrolling.](./media/app-ui-updates/win10_guided_enroll_leaving_for_iwp_after_1706.png)

![An image of the Windows Company Portal app enroll into management screen, which shows a completed status message saying that the user's device is now enrolled and that they should tap the 'next' button to continue.](./media/app-ui-updates/win10_guided_enroll_youre_now_enrolled_after_1706.png)

![An image of the Windows Company Portal app completion screen, letting the user know that they're all set, and that the device is enrolled with a corporate account properly added to it.](./media/app-ui-updates/win10_guided_enroll_youre_all_set_after_1706.png)
...
![An image of the Company Portal app for iOS from before the update, which showed preset filler images for "All apps", "Featured apps," and "categories."](./media/app-ui-updates/cp_ios_homepage_before_1705.png)

**After**

![An image of the Company Portal app for iOS after the update, which now reflects the ability to select whatever colors are relevant for your organization.](./media/app-ui-updates/cp_ios_homepage_after_1705.png)
...
![An image of the account selector, which shows a test user "Robin Swanson" choosing between one of their two email addresses. There is a button underneath the two addresses that allows the user to sign in with a different account.](./media/app-ui-updates/cp_ios_multi-account-selector-after-1705.png)
...
__Before__
  ![An image of the previous version of the loading screen, where the status simply said 'installing.'](./media/app-ui-updates/cp_win10_install_status_before_1704.png)

__After__
  ![An image of the updated version of the loading screen, which now shows an install progress bar.](./media/app-ui-updates/cp_win10_install_status_after_1704.png)
...
![On the left, an image of the Company Portal app for Android before the update. On the right, an image of the Company Portal app for Android after the update. Both images show the Devices tab as the selected tab from the three available tabs of Apps, Devices, and Contact IT.](./media/app-ui-updates/CP_Android_DevicesTab_BeforeAfter.png)
...
![On the left, an image of the Company Portal app for Android before the update. On the right, an image of the Company Portal app for Android after the update. Both images show the Apps tab as the selected tab from the three available tabs of Apps, Devices, and Contact IT.](./media/app-ui-updates/CP_Android_AppsTab_BeforeAfter.png)
