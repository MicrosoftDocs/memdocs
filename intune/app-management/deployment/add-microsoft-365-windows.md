...
When you choose **Configuration designer**, the **Add app** pane changes to offer three extra settings areas:
...
Under the *Microsoft Office* directory, a new folder stores the installation files:

![New created folder under Microsoft Office directory](media/add-microsoft-365-windows/created-folder.png)

Under the *Microsoft Office 15* directory, the Office Click-to-Run installation launcher files are stored. The installation starts automatically if the assignment type is required:

![Click to Run installation launcher files](media/add-microsoft-365-windows/clicktorun-files.png)

The installation runs in silent mode if the assignment of Microsoft 365 is configured as required. The downloaded installation files are deleted once the installation succeeds. If the assignment is configured as **Available**, the Office applications appear in the Company Portal application so that end users can trigger the installation manually.
