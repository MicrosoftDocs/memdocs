...
Use the information in this article to help you add an unmanaged macOS PKG app to Microsoft Intune. To deploy a managed PKG app, see [How to add macOS line-of-business (LOB) apps to Microsoft Intune.](./add-lob-macos.md)
...
- The [Microsoft Intune management agent for macOS](./management-agent-macos.md) version 2308.006 or greater is installed.
...
> - For more details on configuring pre-install and post-install scripts, refer to [Prerequisites of shell scripts](../../device-management/tools/run-shell-scripts-macos.md#prerequisites).
...
The app you have created appears in the apps list where you can assign it to the groups you choose. For help, see [How to assign apps to groups](./assign-groups.md).
