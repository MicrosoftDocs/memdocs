...
>
> For Android Enterprise devices, see [Managed Google Play web links](./add-managed-google-play.md#managed-google-play-web-links).
>
...
1. On the **App information** page, add the following information:
   ...
   - **Require a managed browser to open this link**: Select this option to assign to your users a link to a website or web app that they can open in Microsoft Edge. Microsoft Edge must be installed on their device.
      ...
      > [!NOTE]
      > iOS/iPadOS web clips that require a managed browser will not work with [home screen layout policies.](../../device-configuration/templates/ref-device-features-apple.md)
