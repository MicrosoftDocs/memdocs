...
To see the specific suggestions for each configuration level and the minimum apps that must be protected, review [Data protection framework using app protection policies](../protection/data-protection-framework.md).
...
- The Microsoft Edge for iOS and Android app must have an [Intune app protection policy](../protection/overview.md) assigned.
