...
>- If you use a Mobile Threat Defense partner with Intune, [App Sync data](../intune-service/protect/mtd-connector-enable.md) is sent to the partner based on the device check-in interval. Don't confuse this interval with the refresh interval for the Discovered Apps report.
