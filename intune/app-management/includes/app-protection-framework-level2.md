...
| Functionality |       Org data   notifications  |          Block Org   Data  |          iOS/iPadOS,   Android  |          For a list   of apps that support this setting, see [iOS app protection policy settings](../protection/ref-settings-ios.md) and [Android app protection policy settings](../protection/ref-settings-android.md).       |
