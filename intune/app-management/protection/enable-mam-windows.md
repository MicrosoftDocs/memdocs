...
> [!NOTE]
> This MAM service uses the same Conditional Access compliance workflow that is used to [manage Microsoft Edge on iOS and Android devices](../configuration/configure-edge-ios-android.md).
...
For more information on the available settings, see [Windows app protection policy settings](./ref-settings-windows.md).

## Next steps

- [What are app protection policies?](./overview.md)
- [App configuration policies for Microsoft Intune](../configuration/overview.md)
