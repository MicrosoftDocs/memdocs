...
Intune MAM manages many productivity apps, such as the Microsoft 365 (Office) apps. See the official list of [Microsoft Intune protected apps](../ref-protected-apps.md) available for public use.
...
Intune offers a range of capabilities to help you get the apps you need on the devices you want to run them on. For more information, see [App management capabilities by platform](../overview.md#app-management-capabilities-by-platform).
...
![Conceptual image for data movement between apps with no policies in place](media/overview/apps-without-protection-policies.png)
...
![Conceptual image that shows company data being protected by policies](media/overview/apps-with-protection-policies.png)
...
![Image that shows how App protection policies work on BYOD devices](media/overview/app-protection-policies-with-mdm.png)
...
Any app that integrates with the [Intune SDK](../../developer/app-sdk/index.md) or wraps by the [Intune App Wrapping Tool](../../developer/app-sdk/integration-methods.md) can be managed using Intune app protection policies. See the official list of [Microsoft Intune protected apps](../ref-protected-apps.md) that use these tools and are available for public use.
...
>
> ![Screenshot of how to register device with Intune.](media/overview/register-device.png)
>
