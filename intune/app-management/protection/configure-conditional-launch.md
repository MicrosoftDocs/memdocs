...
7. Select the **Action** you want to take if users don't meet your requirements. In some cases, multiple actions can be configured for a single setting. For more information, see [How to create and assign app protection policies](./create-policy.md).
...
![Screenshot of app protection access actions - Min OS version](media/configure-conditional-launch/apps-selective-wipe-access-actions05.png)
