...
- [Create and deploy app protection policies](./create-policy.md)
- [iOS/iPadOS app protection policy settings - Data transfer exemptions](./ref-settings-ios.md#data-transfer-exemptions)
- [Android app protection policy settings - Data transfer exemptions](./ref-settings-android.md#data-transfer-exemptions)
