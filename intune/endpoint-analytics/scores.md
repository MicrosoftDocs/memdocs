...
:::image type="content" source="media/scores/startup-score.png" alt-text="Screenshot of the endpoint analytics startup score page." lightbox="media/scores/startup-score.png" border="false":::
...
:::image type="content" source="media/scores/baseline.png" alt-text="Screenshot of endpoint analytics score chart. A red square outline is around the baseline number and baseline triangle marker" lightbox="media/scores/baseline.png":::

> [!IMPORTANT]
> We anonymize and aggregate the scores from all enrolled organizations to keep the **All organizations (median)** baseline up-to-date. You can [stop gathering data](ref-data-collection.md#stop-gathering-data) at any time.
...
:::image type="content" source="media/scores/per-device-scores-chart.png" alt-text="Screenshot of endpoint analytics device scores chart from the overview page." lightbox="media/scores/per-device-scores-chart.png":::
...
:::image type="content" source="media/scores/per-device-scores.png" alt-text="Screenshot of a device's endpoint analytics score with the startup performance and application reliability subscores." lightbox="media/scores/per-device-scores.png":::
...
:::image type="content" source="media/scores/user-experience-overview.png" alt-text="Screenshot of a device's user experience page displaying the startup performance tab." lightbox="media/scores/user-experience-overview.png":::
...
:::image type="content" source="media/scores/per-device-startup-score.png" alt-text="Screenshot of endpoint analytics startup performance page for a single device." lightbox="media/scores/per-device-startup-score.png":::
...
:::image type="content" source="media/scores/score-filter.png" alt-text="Screenshot of a table filter in endpoint analytics." lightbox="media/scores/score-filter.png":::
