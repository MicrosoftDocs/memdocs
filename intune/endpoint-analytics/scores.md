...
:::image type="content" source="images/scores/baseline.png" alt-text="Screenshot of endpoint analytics score chart. A red square outline is around the baseline number and baseline triangle marker" lightbox="images/scores/baseline.png":::
...
:::image type="content" source="images/scores/per-device-scores-chart.png" alt-text="Screenshot of endpoint analytics device scores chart from the overview page." lightbox="images/scores/per-device-scores-chart.png":::
...
:::image type="content" source="images/scores/per-device-scores.png" alt-text="Screenshot of a device's endpoint analytics score with the startup performance and application reliability subscores." lightbox="images/scores/per-device-scores.png":::
...
:::image type="content" source="images/scores/per-device-startup-score.png" alt-text="Screenshot of endpoint analytics startup performance page for a single device." lightbox="images/scores/per-device-startup-score.png":::
...
:::image type="content" source="images/scores/filter.png" alt-text="Screenshot of a table filter in endpoint analytics." lightbox="images/scores/filter.png":::
