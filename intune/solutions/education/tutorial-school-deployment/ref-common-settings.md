...
- [Device restrictions](ref-device-restrictions-settings-windows.md)
- [Windows Update](ref-update-settings-windows.md)
- [Microsoft Edge](ref-edge-settings-windows.md)
- [Delivery Optimization](ref-delivery-optimization-settings-windows.md)

### Optional

- [Windows privacy](ref-privacy-settings-windows.md)
- [Start menu customization](ref-start-menu-settings-windows.md)
- [OneDrive Known Folder Move](ref-onedrive-knownfoldermove-settings-windows.md)

## Intune policies for iPads in Education

- [Device restrictions](ref-device-restrictions-settings-ipados.md)
- [Apple Intelligence](ref-ai-restrictions-settings-ipados.md)
- [iPads with no user affinity](ref-shared-device-settings-ipados.md)
- [Optional restrictions](ref-optional-restrictions-settings-ipados.md)
