...
1. Wait for updates. If any updates are available, they are installed at this time.
  :::image type="content" source="./media/enroll-entra-join/win11-oobe-updates.png" alt-text="Windows 11 OOBE - updates page" border="true":::
1. When prompted, select **Set up for work or school** and authenticate using your school's Microsoft Entra account.
  :::image type="content" source="./media/enroll-entra-join/win11-oobe-auth.png" alt-text="Windows 11 OOBE - authentication page" border="true":::
