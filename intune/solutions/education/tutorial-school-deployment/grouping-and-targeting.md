...
> [!NOTE]
>
> - For more information on grouping and targeting options, see [Performance recommendations for Grouping, Targeting, and Filtering in large Microsoft Intune environments](../../../intune-service/fundamentals/filters-performance-recommendations.md).
> - For tips on avoiding policy conflicts, see [Avoid policy conflicts](policy-conflicts.md).
...
- [Create Filters](../../../intune-service/fundamentals/filters.md)
