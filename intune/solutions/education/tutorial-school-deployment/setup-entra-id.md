...
:::image type="content" source="./media/setup-entra-id/m365-admin-center.png" alt-text="*All admin centers* page in *Microsoft 365 admin center*" lightbox="./media/setup-entra-id/m365-admin-center.png" border="true":::
...
1. Add the groups to which the licenses should be assigned.
    :::image type="content" source="./media/setup-entra-id/entra-assign-licenses.png" alt-text="Assign licenses from Microsoft Entra admin center." lightbox="./media/setup-entra-id/entra-assign-licenses.png":::
...
1. You can specify brand settings like background image, logo, username hint and a sign-in page text.
    :::image type="content" source="./media/setup-entra-id/entra-branding.png" alt-text="Configure Microsoft Entra ID branding from Microsoft Entra admin center." lightbox="./media/setup-entra-id/entra-branding.png":::
...
1. In the **Name** field, enter the school district or organization's name > **Save**.
    :::image type="content" alt-text="Configure Microsoft Entra tenant name from Microsoft Entra admin center." source="./media/setup-entra-id/entra-tenant-name.png" lightbox="./media/setup-entra-id/entra-tenant-name.png":::
...
1. Select Save
    :::image type="content" source="./media/setup-entra-id/entra-device-settings.png" alt-text="Configure device settings from Microsoft Entra admin center." lightbox="./media/setup-entra-id/entra-device-settings.png":::
...
> [Next: Set up Microsoft Intune >](setup-intune.md)
