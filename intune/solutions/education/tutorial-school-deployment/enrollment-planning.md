...
:::image type="content" source="./media/shared/enroll.png" alt-text="The device lifecycle for Intune-managed devices - enrollment" border="false":::
...
|Set up a device for a single user.|✔️ <br/><br/> A [primary user](../../../intune-service/fundamentals/find-primary-user.md) isn't assigned.|✔️ <br/><br/> Supported with [Windows Autopilot user-driven mode](/autopilot/user-driven). To set up shared devices, use [Windows Autopilot self-deploying mode](/autopilot/self-deploying).|
