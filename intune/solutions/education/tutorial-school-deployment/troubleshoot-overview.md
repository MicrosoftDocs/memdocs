...
- [**Collect diagnostics**][MEM-10] is a remote action that lets you collect and download Windows device logs without interrupting the user
  :::image type="content" source="./media/troubleshoot-overview/intune-diagnostics.png" alt-text="Intune for Education dashboard" lightbox="./media/troubleshoot-overview/intune-diagnostics.png" border="true":::
...
> [Next: Common Education configuration overview >](ref-common-settings.md)
