...
> [!NOTE]
> Some features may require additional licenses. For more information, go to [ntune Suite add-on capabilities](../../intune-service/fundamentals/intune-add-ons.md) or [Microsoft Intune licensing](../../intune-service/fundamentals/licenses.md).
