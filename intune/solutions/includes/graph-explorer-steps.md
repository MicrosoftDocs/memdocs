...
1. Once Graph Explorer is open, select the :::image type="icon" source="../../media/icons/16/person.svg"::: user icon in the top right to sign-in and sign in with your Intune administrator organizational account.
