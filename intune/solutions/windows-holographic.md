...
To use Windows Holographic devices with Intune, create an [Edition Upgrade](../device-configuration/templates/configure-edition-upgrade-windows.md) profile. This upgrade profile upgrades the devices from Windows Holographic to Windows Holographic for Business. For the Microsoft HoloLens, you can buy the Commercial Suite to get the required license for the upgrade. For more information, go to [Upgrade devices running Windows Holographic to Windows Holographic for Business](../device-configuration/templates/ref-holographic-upgrade-settings.md).
...
**[Configure the Company Portal app](../app-management/configuration/configure-company-portal.md)**.
...
- [Remove a device from Intune](../user-help/unenrollment/unenroll-windows.md) using the Settings app or the Company Portal app
...
**[Add apps to Intune](../app-management/deployment/index.md)**.
...
- [Add Microsoft Store apps](../app-management/deployment/add-microsoft-store-legacy.md)
- [Add line-of-business (LOB) you create](../app-management/deployment/add-lob-windows.md)
- [Assign apps to groups](../app-management/deployment/assign-groups.md)
...
**[Categorize devices into groups](../device-management/create-device-categories.md)**.
...
**[Get started with configuration profiles](../device-configuration/overview.md) and [profile overview](../device-configuration/create-device-profile.md)**.
...
### [Custom device settings](../device-configuration/templates/ref-custom-settings-windows-holographic.md)
...
### [Device restrictions](../device-configuration/templates/ref-device-restrictions-windows-holographic.md)
...
### [Configure VPN](../device-configuration/templates/configure-vpn.md)
...
For more information, go to [Shared devices](../device-configuration/templates/ref-shared-device-settings-windows-holographic.md).

## Software updates

**[Manage software updates](../device-updates/windows/index.md)**.
...
**[Set your company's terms and conditions for user access](../device-enrollment/create-terms-and-conditions.md)**.
