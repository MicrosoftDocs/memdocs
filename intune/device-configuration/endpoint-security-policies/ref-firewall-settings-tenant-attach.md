...
View the Microsoft Windows Firewall settings you can manage with the **Windows Firewall (ConfigMgr)** profile from Intune. The profile is available when you configure Intune [Firewall policy](./firewall-policy.md), and the policy deploys to devices you manage with Configuration Manager when you've configured the [tenant attach](../../fundamentals/tenant-attach.md) scenario.
...
- **Opportunistically Match Auth Set Per KM (Device)**  
  CSP: [OpportunisticallyMatchAuthSetPerKM](../../intune-service/protect/windows/client-management/mdm/firewall-csp#opportunisticallymatchauthsetperkm)
...
- **Enable Domain Network Firewall (Device)**  
  ...
  - **Allow Local Policy Merge (Device)**  
    CSP: [AllowLocalPolicyMerge](../../intune-service/protect/windows/client-management/mdm/firewall-csp#allowlocalpolicymerge)
