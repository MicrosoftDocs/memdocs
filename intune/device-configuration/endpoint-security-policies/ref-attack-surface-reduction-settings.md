...
View the settings you can configure in profiles for *Attack surface reduction* policy in the endpoint security node of Intune as part of an [Endpoint security policy](./manage-policies.md).
...
- **Windows**: Use this platform for policy you deploy to devices managed through [Security Management for Microsoft Defender for Endpoint](../../device-security/microsoft-defender/security-settings-management.md).
...
- **Turn on Application Guard**  
  CSP: [AllowWindowsDefenderApplicationGuard](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#allowwindowsdefenderapplicationguard)
  ...
  - **Clipboard behavior**  
    CSP: [ClipboardSettings](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#clipboardsettings)
  ...
  - **Block external content from non-enterprise approved sites**  
    CSP: [BlockNonEnterpriseContent](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#blocknonenterprisecontent)
  ...
  - **Collect logs for events that occur within an Application Guard browsing session**  
    CSP: [AuditApplicationGuard](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#auditapplicationguard)
  ...
  - **Allow user-generated browser data to be saved**  
    CSP: [AllowPersistence](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#allowpersistence)
  ...
  - **Enable hardware graphics acceleration**  
    CSP: [AllowVirtualGPU](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#allowvirtualgpu)
  ...
  - **Allow users to download files onto the host**  
    CSP: [SaveFilesToHost](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#savefilestohost)
  ...
  - **Application Guard allow camera and microphone access**  
    CSP: [AllowCameraMicrophoneRedirection](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#allowcameramicrophoneredirection)
...
- **Application Guard allow use of Root Certificate Authorities from the user's device**  
  CSP: [CertificateThumbprints](../../intune-service/protect/windows/client-management/mdm/windowsdefenderapplicationguard-csp#certificatethumbprints)
...
- **App locker application control**  
  CSP: [AppLocker](../../intune-service/protect/windows/client-management/mdm/applocker-csp)
...
- **Block users from ignoring SmartScreen warnings**  
  CSP: [SmartScreen/PreventOverrideForFilesInShell](../../intune-service/protect/windows/client-management/mdm/policy-csp-smartscreen#smartscreen-preventoverrideforfilesinshell)
...
- **Turn on Windows SmartScreen**  
  CSP: [SmartScreen/EnableSmartScreenInShell](../../intune-service/protect/windows/client-management/mdm/policy-csp-smartscreen#smartscreen-enablesmartscreeninshell)
...
To learn more about Attack surface reduction rules, see [Attack surface reduction rules reference](../../intune-service/protect/microsoft-365/security/defender-endpoint/attack-surface-reduction-rules-reference) in the Microsoft 365 documentation.
...
- **Block persistence through WMI event subscription**  
  [Reduce attack surfaces with attack surface reduction rules](../../intune-service/protect/windows/security/threat-protection/microsoft-defender-atp/attack-surface-reduction)
  ...
  To learn more about this setting, see [Block persistence through WMI event subscription](../../intune-service/protect/windows/security/threat-protection/microsoft-defender-atp/attack-surface-reduction?WT.mc_id=Portal-fx#block-persistence-through-wmi-event-subscription).

- **Block credential stealing from the Windows local security authority subsystem (lsass.exe)**  
  [Protect devices from exploits](../../intune-service/protect/windows/security/threat-protection/microsoft-defender-atp/attack-surface-reduction)
...
- **Enable folder protection**  
  CSP: [EnableControlledFolderAccess](../../intune-service/protect/windows/client-management/mdm/policy-csp-defender#defender-enablecontrolledfolderaccess)
...
- **List of additional folders that need to be protected**  
  CSP: [ControlledFolderAccessProtectedFolders](../../intune-service/protect/windows/client-management/mdm/policy-csp-defender#defender-controlledfolderaccessprotectedfolders)
...
- **List of apps that have access to protected folders**  
  CSP: [ControlledFolderAccessAllowedApplications](../../intune-service/protect/windows/client-management/mdm/policy-csp-defender#defender-controlledfolderaccessallowedapplications)
...
- **Exclude files and paths from attack surface reduction rules**  
  CSP: [AttackSurfaceReductionOnlyExclusions](../../intune-service/protect/windows/client-management/mdm/policy-csp-defender#defender-attacksurfacereductiononlyexclusions)
...
- **Block hardware device installation by device identifiers**  
  CSP: [AllowInstallationOfMatchingDeviceIDs](../../intune-service/protect/windows/client-management/mdm/policy-csp-deviceinstallation#deviceinstallation-allowinstallationofmatchingdeviceids)
...
- **Block hardware device installation by setup classes**  
  CSP: [AllowInstallationOfMatchingDeviceSetupClasses](../../intune-service/protect/windows/client-management/mdm/policy-csp-deviceinstallation)
...
- **Block write access to removable storage**  
  CSP: [RemovableDiskDenyWriteAccess](../../intune-service/protect/windows/client-management/mdm/policy-csp-storage#storage-removablediskdenywriteaccess)
...
- **Scan removable drives during full scan**  
  CSP: [Defender/AllowFullScanRemovableDriveScanning](../../intune-service/protect/windows/client-management/mdm/policy-csp-defender#defender-allowfullscanremovabledrivescanning)
...
- **Block direct memory access**  
  CSP: [DataProtection/AllowDirectMemoryAccess](../../intune-service/protect/windows/client-management/mdm/policy-csp-dataprotection#dataprotection-allowdirectmemoryaccess)
...
- **Enumeration of external devices incompatible with Kernel DMA Protection**  
  CSP: [DmaGuard/DeviceEnumerationPolicy](../../intune-service/protect/windows/client-management/mdm/policy-csp-dmaguard#dmaguard-deviceenumerationpolicy)
...
- **Block bluetooth connections**  
  CSP: [Bluetooth/AllowDiscoverableMode](../../intune-service/protect/windows/client-management/mdm/policy-csp-bluetooth#bluetooth-allowdiscoverablemode)
...
- **Block bluetooth pre-pairing**  
  CSP: [Bluetooth/AllowPrepairing](../../intune-service/protect/windows/client-management/mdm/policy-csp-bluetooth#bluetooth-allowprepairing)

  - **Not configured** (*default*)
  - **Yes** - Prevents specific Bluetooth devices from automatically pairing with the host device.

- **Block bluetooth advertising**  
  CSP: [Bluetooth/AllowAdvertising](../../intune-service/protect/windows/client-management/mdm/policy-csp-bluetooth#bluetooth-allowadvertising)

  - **Not configured** (*default*)
  - **Yes** - Prevents the device from sending out Bluetooth advertisements.

- **Block bluetooth proximal connections**  
  CSP: [Bluetooth/AllowPromptedProximalConnections](../../intune-service/protect/windows/client-management/mdm/policy-csp-bluetooth#bluetooth-allowpromptedproximalconnections)
  ...
  [Bluetooth/AllowPromptedProximalConnections CSP](../../intune-service/protect/windows/client-management/mdm/policy-csp-bluetooth#bluetooth-allowpromptedproximalconnections)

- **Bluetooth allowed services**  
  CSP: [Bluetooth/ServicesAllowedList](../../intune-service/protect/windows/client-management/mdm/policy-csp-bluetooth#bluetooth-servicesallowedlist).
  For more information on the service list, see [ServicesAllowedList usage guide](../../intune-service/protect/windows/client-management/mdm/policy-csp-bluetooth#servicesallowedlist-usage-guide)
...
- **Removable storage**  
  CSP: [Storage/RemovableDiskDenyWriteAccess](../../intune-service/protect/windows/client-management/mdm/policy-csp-storage#storage-removablediskdenywriteaccess)
...
- **USB connections (HoloLens only)**  
  CSP: [Connectivity/AllowUSBConnection](../../intune-service/protect/windows/client-management/mdm/policy-csp-connectivity#connectivity-allowusbconnection)
...
- **Upload XML**  
  CSP: [ExploitProtectionSettings](../../intune-service/protect/windows/client-management/mdm/policy-csp-exploitguard#exploitguard-exploitprotectionsettings)
...
- **Block users from editing the Exploit Guard protection interface**  
  CSP: [DisallowExploitProtectionOverride](../../intune-service/protect/windows/client-management/mdm/policy-csp-windowsdefendersecuritycenter#windowsdefendersecuritycenter-disallowexploitprotectionoverride)
...
- **Enable network protection**  
  CSP: [EnableNetworkProtection](../../intune-service/protect/windows/client-management/mdm/policy-csp-defender#defender-enablenetworkprotection)
...
- **Require SmartScreen for Microsoft Edge**  
  CSP: [Browser/AllowSmartScreen](../../intune-service/protect/windows/client-management/mdm/policy-csp-browser#browser-allowsmartscreen)

  - **Yes** - Use SmartScreen to protect users from potential phishing scams and malicious software.
  - **Not configured** (*default*)

- **Block malicious site access**  
  CSP: [Browser/PreventSmartScreenPromptOverride](../../intune-service/protect/windows/client-management/mdm/policy-csp-browser#browser-preventsmartscreenpromptoverride)
...
- **Block unverified file download**  
  CSP: [Browser/PreventSmartScreenPromptOverrideForFiles](../../intune-service/protect/windows/client-management/mdm/policy-csp-browser#browser-preventsmartscreenpromptoverrideforfiles)
