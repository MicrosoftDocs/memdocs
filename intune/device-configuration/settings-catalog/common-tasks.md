...
Be sure macOS is listed as a supported platform. If some settings aren't available in the settings catalog, then it's recommended to continue using the [preference file](../../intune-service/configuration/preference-file-settings-macos.md).
