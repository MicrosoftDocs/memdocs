...
- For macOS devices, the Enterprise SSO plug-in includes **[Platform SSO and the SSO app extension](../../device-configuration/settings-catalog/configure-platform-sso-macos.md)**.
