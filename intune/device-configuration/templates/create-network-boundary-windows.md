...
For more information on using Microsoft Defender Application Guard in Intune, go to [Windows client settings to protect devices using Intune](../endpoint-security-policies/ref-endpoint-protection-settings-windows.md#microsoft-defender-application-guard).
