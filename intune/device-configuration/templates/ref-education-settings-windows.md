...
[Take a Test app in Intune](./configure-education-settings.md) provides more information on this feature.

## Before you begin

Create a [Windows secure assessment education device configuration profile](./configure-education-settings.md#create-a-device-profile).
...
Learn more about the [Take a Test app](./configure-education-settings.md).
