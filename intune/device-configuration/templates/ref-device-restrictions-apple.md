...
> [!NOTE]
> "In-App Purchase Disabled" is expected on VPP apps as In-app purchases and subscriptions aren’t compatible with volume purchasing program (VPP), Managed Apps, or Managed Apple Accounts. Developers may offer a separate full-featured version of their apps (sometimes as a Custom App) for education or enterprise customers that need to deploy apps at scale. see [Apple's doc](https://support.apple.com/guide/business/intro-to-apps-and-books-licenses-axme19b23f7f/web).
