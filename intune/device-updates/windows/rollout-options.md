...
You configure rollout options when creating [Feature Updates policy](../protect/feature-updates.md) by selecting one of the following options:
...
Configure [Feature Updates policy](../protect/feature-updates.md)
