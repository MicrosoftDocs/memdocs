...
- **Manage EPM** - After you deploy EPM, you can monitor [support approved requests](./manage-support-approvals.md) and [elevations](./monitor-reports.md). You can [maintain and update your rules](./create-elevation-rules.md) and [review user privileges](../device-configuration/endpoint-security/account-protection.md).
