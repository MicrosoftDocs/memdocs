...
> [!NOTE]
> For information about the Intune management extension for Windows, see [Intune management extension for Windows](./management-extension-windows.md).
...
- Intune management extension installs automatically when a PowerShell script app is assigned to the user or device. For more information, see [Intune management extension for Windows](./management-extension-windows.md).
...
2. Select **Devices** > **Scripts and remediations** > **Platform scripts** > **Add** > **Windows 10 and later**.
    ...
    ![Screenshot that shows creating a new script for a Windows device.](media/management-extension-windows/create-script-windows.png)
...
6. Select **Assignments** > **Select groups to include**. An existing list of Microsoft Entra groups is shown.
    ...
    - Select **Next**.
        ...
        ![Assign or deploy PowerShell script to device groups in Microsoft Intune](media/management-extension-windows/mgmt-extension-assignments.png)
...
- Review the logs for any errors. See [Intune management extension logs](./management-extension-windows.md#intune-management-extension-logs) (in this article).
