...
- Used to define the devices that admins can view and manage in the Intune admin center, like [scope groups](../role-based-access-control/overview.md#about-intune-role-assignments) in role-based access control (RBAC)
