...
For more information about exclusions, including scope, limits, and security considerations, see [Create an access policy](multi-admin-approval.md#create-an-access-policy).
