...
- Be familiar with [role-based access control (RBAC) in Intune](role-based-access-control/overview.md)
...
- [Step 3 - Create a group](tenant-administration/quickstart-create-group.md)
...
- [Step 10 - Create and assign custom roles](role-based-access-control/quickstart-custom-role.md)
