...
For an overview of how Intune supports Zero Trust principles (verify explicitly, use least privilege access, and assume breach), see [Zero Trust with Microsoft Intune](zero-trust.md).
