...
Each instance of the certificate connector has the same network requirements as devices that are managed by Intune. For more information, see [Network endpoints for Microsoft Intune](../../../fundamentals/endpoints.md).
...
2. To install the new version, use the procedure to install a new version of the connector. Be sure to check the [requirements](prerequisites.md) when installing a newer version of a connector.
...
Version **6.2510.3.3007** - Changes in this release:  
