...
All authenticated users can access Support Assistant in the Microsoft Intune admin center to find solutions and troubleshooting guidance. Creating and managing support tickets requires a Microsoft Entra role that includes the *microsoft.office365.supportTickets* action. Guest users can’t file support tickets, even if the action is assigned. For more information about required roles and permissions, see [Administrator roles in Microsoft Entra ID](/entra/identity/role-based-access-control/permissions-reference).  
...
- Go to **Troubleshooting + support** or another node in the admin center and select **Help and support** to open a full screen experience of Help and support.
  ...
  :::image type="content" source="./media/get-support-admin-center/troubleshooting-support-help-support.png" alt-text="Screenshot that shows how to get to help and support from Troubleshooting and support in the Microsoft Intune admin center." lightbox="./media/get-support-admin-center/troubleshooting-support-help-support.png":::
...
- From any node in the admin center, or your current area of focus, select the question mark (`?`) near your profile pic to open the Help and Support pane.
  ...
  :::image type="content" source="./media/get-support-admin-center/all-services-question-mark.png" alt-text="Screenshot that shows how to get to help and support using home, dashboard, or any other option in the Microsoft Intune admin center." lightbox="./media/get-support-admin-center/all-services-question-mark.png":::
...
:::image type="content" source="./media/get-support-admin-center/help-and-support-pinned.png" alt-text="Screenshot that shows the available help and support services in your subscription in the Microsoft Intune admin center.":::
...
>
> This problem occurs when you haven't authenticated and accessed the *How can we help?* page from your new tenant account through either the **Microsoft 365 Admin Center** at [https://admin.microsoft.com](https://admin.microsoft.com), or the **Office 365 portal** at [https://portal.office.com](https://portal.office.com). To resolve this problem, select the link for *Microsoft 365 Admin Center* in the message, or visit [https://portal.office.com](https://portal.office.com), and sign in. Following authentication at either site, go to the Admin area and select the Need Help icon in the lower right. After completing these steps, the *Help and Support* page for Intune becomes accessible.
...
:::image type="content" source="./media/get-support-admin-center/confirm-management-selection.png" alt-text="Screenshot that shows the How can we help window in the Intune admin center.":::
...
>
> :::image type="content" source="./media/get-support-admin-center/premier-banner.png" alt-text="Screenshot that shows the premier support option in the Intune admin center.":::

### Search for solutions

:::image type="content" source="./media/get-support-admin-center/find-solutions.png" alt-text="Screenshot that shows how to search for solutions in the Intune admin center.":::
...
:::image type="content" source="./media/get-support-admin-center/troubleshooting-insights.png" alt-text="Screenshot that shows the need help pane to run diagnostics, view insights, and read recommended articles in the Intune admin center." lightbox="./media/get-support-admin-center/troubleshooting-insights.png":::
...
:::image type="content" source="./media/get-support-admin-center/diagnostic-results.png" alt-text="Screenshot that shows the diagnostic results in the Intune admin center." lightbox="./media/get-support-admin-center/diagnostic-results.png":::
...
:::image type="content" source="./media/get-support-admin-center/scenarios-example.png" alt-text="Screenshot that shows scenario options in the Intune admin center.":::

When you select a scenario, new options are offered to help narrow down the issue.

:::image type="content" source="./media/get-support-admin-center/drill-in-scenarios.png" alt-text="Screenshot that shows filtered scenario options in the Intune admin center.":::
...
:::image type="content" source="./media/get-support-admin-center/contact-support.png" alt-text="Screenshot that shows how to select the contact support icon in the Intune admin center.":::
...
:::image type="content" source="./media/get-support-admin-center/contact-support-form.png" alt-text="Screenshot that shows the contact support form in the Intune admin center.":::
...
:::image type="content" source="./media/get-support-admin-center/service-requests.png" alt-text="Screenshot that shows your service request list in the Intune admin center.":::
