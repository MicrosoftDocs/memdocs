...
- [Deploy Intune app protection policies](/intune/app-management/protection/create-policy#create-an-iosipados-or-android-app-protection-policy)
- [Review the Android app protection settings reference](/intune/app-management/protection/ref-settings-android)

For more information, see:  
- [Learn about using app protection policies](/intune/app-management/protection/overview)