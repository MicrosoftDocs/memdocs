...
- [Set up app-based Conditional Access policies with Intune](/intune/device-security/conditional-access-integration/create-app-based-policy)

For more information, see:  
- [What is Conditional Access?](/entra/identity/conditional-access/overview)
- [Learn about app-based Conditional Access policies with Intune](/intune/device-security/conditional-access-integration/app-based-policies)
