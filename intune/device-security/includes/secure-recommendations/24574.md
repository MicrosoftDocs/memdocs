...
- [Configure Intune profiles for Attack Surface Reduction Rules](/intune/device-configuration/endpoint-security/attack-surface-reduction#devices-managed-by-intune)
