...
- [Configure Wi-Fi settings for macOS devices in Intune](/intune/device-configuration/templates/configure-wifi#create-the-profile)

For more information, see:

- [Review the available Wi-Fi settings for macOS devices in Microsoft Intune](/intune/device-configuration/templates/ref-wifi-settings-apple)