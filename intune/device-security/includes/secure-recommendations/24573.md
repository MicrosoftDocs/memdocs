...
- [Deploy security baselines to help secure Windows devices](/intune/device-security/security-baselines/configure-baselines#create-a-profile-for-a-security-baseline)
- [Monitor security baseline compliance](/intune/device-security/security-baselines/monitor-baselines)