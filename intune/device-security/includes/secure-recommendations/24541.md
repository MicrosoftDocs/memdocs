...
- [Create and assign Intune compliance policies](/intune/device-security/compliance/create-policy#create-the-policy)
- [Review the Windows compliance settings you can manage with Intune](/intune/device-security/compliance/ref-windows-settings)