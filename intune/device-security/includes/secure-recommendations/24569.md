...
- [Create a FileVault disk encryption policy for macOS in Intune](/intune/device-configuration/endpoint-security-policies/encrypt-filevault-macos#create-endpoint-security-policy-for-filevault)
- [Assign policies in Intune](/intune/device-configuration/assign-device-profile#assign-a-policy-to-users-or-groups)
- [Monitor device encryption with Intune](/intune/device-configuration/endpoint-security-policies/monitor-encryption)