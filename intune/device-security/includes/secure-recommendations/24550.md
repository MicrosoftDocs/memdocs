...
- [Create a BitLocker policy for Windows devices in Intune](/intune/device-configuration/endpoint-security-policies/encrypt-bitlocker-windows#create-and-deploy-policy)
