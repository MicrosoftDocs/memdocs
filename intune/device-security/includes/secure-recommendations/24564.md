...
- Create an [Account protection policy for endpoint security in Intune](/intune/device-configuration/endpoint-security-policies/account-protection-policy#account-protection-profiles)
