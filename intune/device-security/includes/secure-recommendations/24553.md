...
Start with [Manage Windows software updates in Intune](/intune/device-updates/windows/configure) to understand the available Windows Update policy types and how to configure them.

Intune includes the following Windows update policy type: 
- [Windows quality updates policy](/intune/device-updates/windows/manage-quality-updates) - *to install the regular monthly updates for Windows.*
- [Expedite updates policy](/intune/device-updates/windows/expedite-updates) - *to quickly install critical security patches.*
- [Feature updates policy](/intune/device-updates/windows/manage-feature-updates)
- [Update rings policy](/intune/device-updates/windows/manage-update-rings) - *to manage how and when devices install feature and quality updates.*
- [Windows driver updates](/intune/device-updates/windows/manage-driver-updates) - *to update hardware components.*
