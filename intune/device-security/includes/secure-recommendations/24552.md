...
- [Configure the built-in firewall on macOS devices](/intune/device-configuration/endpoint-security/firewall)
- [Assign policies in Intune](/intune/device-configuration/assign-device-profile#assign-a-policy-to-users-or-groups)

For more information, see:  
-  [Available macOS firewall settings](/intune/device-configuration/endpoint-security/ref-firewall-settings#macos-firewall-profile)