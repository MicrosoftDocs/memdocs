...
- [Enable Windows automatic enrollment](/intune/device-enrollment/windows/enable-automatic-mdm#enable-windows-automatic-enrollment)

For more information, see:  
- [Deployment guide - Enrollment for Windows](/intune/device-enrollment/enroll-devices?tabs=work-profile%2Ccorporate-owned-apple%2Cautomatic-enrollment#enrollment-for-windows)
