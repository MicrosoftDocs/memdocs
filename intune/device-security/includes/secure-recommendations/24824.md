...
- [Create a device compliance-based Conditional Access policy](/entra/identity/conditional-access/policy-all-users-device-compliance)

For more information, see:
- [What is Conditional Access?](/entra/identity/conditional-access/overview)
- [Integrate device compliance results with Conditional Access](/intune/device-security/compliance/overview#integrate-with-conditional-access)