...
- [Create a compliance policy in Microsoft Intune](/intune/device-security/compliance/create-policy#create-the-policy)
- [Review the Android Enterprise compliance settings you can manage with Intune](/intune/device-security/compliance/ref-android-enterprise-settings)
