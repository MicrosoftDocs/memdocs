...
- [Deploy Windows LAPS policy with Microsoft Intune](/intune/device-security/laps/deploy-policy#create-a-laps-policy)

For more information, see:  
- [Windows LAPS policy settings reference](/windows-server/identity/laps/laps-management-policy-settings)
- [Learn about Intune support for Windows LAPS](/intune/device-security/laps/overview)