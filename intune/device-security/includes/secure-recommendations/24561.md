...
- [Configure macOS LAPS in Microsoft Intune](/intune/device-enrollment/apple/setup-laps-macos)
- [Rotate local admin password (macOS)](/intune/device-management/actions/rotate-local-admin-password?pivots=macos)

For more information, see:  
- [macOS ADE setup guide](/intune/device-enrollment/apple/setup-automated-macos)