...
- [Deploy Wi-Fi profiles to devices in Microsoft Intune](/intune/device-configuration/templates/configure-wifi#create-the-profile)

For more information, see:  
- [Review the available Wi-Fi settings for Android devices in Microsoft Intune](/intune/device-configuration/templates/ref-wifi-settings-android-enterprise)
