...
[Endpoint Privilege Management (EPM)](../epm/overview.md) enforces **least privilege access** for Windows users by running them as standard users while allowing temporary elevation for approved applications. This approach reduces attack surface by preventing blanket administrative access.
