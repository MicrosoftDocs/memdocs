...
View the list of [Mobile Threat Defense partners that Intune supports](./overview.md#mobile-threat-defense-partners) in the *Mobile Threat Defense integration with Intune* article.
...
6. On the **Actions for noncompliance** tab, specify a sequence of actions to apply automatically to devices that don't meet this compliance policy.
   ...
   For information about the actions you can configure, see [Add actions for noncompliant devices](../compliance/configure-noncompliance-actions.md), including how to create notification emails to send to your users.
