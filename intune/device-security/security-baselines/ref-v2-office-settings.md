...
## Microsoft 365 Apps for Enterprise security baseline version 2512

This baseline version was first made available in June 2026, and replaces the *Version 2306*.

For more information about the following settings that are included in this baseline, download the [Security Compliance Toolkit and Baselines](https://www.microsoft.com/download/details.aspx?id=55319) from the Microsoft Download Center, and then review the *Microsoft 365 Apps for Enterprise 2512.zip* file.
...
- **Block Flash activation in Office documents**\
  ...
  - **Block Flash player in Office (Device)**\
    Baseline default: *Block embedding/linking, allow other activation*
...
- **Block OLE Graph (User)**\
  Baseline default: *Enabled*

- **Block OrgChart (User)**\
  Baseline default: *Enabled*

- **Restrict Apps from FPRPC Fallback (User)**\
  Baseline default: *Enabled*
...
- **OLE Active Content (User)**\
  Baseline default: *Enabled*
  - Baseline default: *disable (don't allow activating OLE Active Content)*
