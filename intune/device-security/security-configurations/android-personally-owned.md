...
- [Android Enterprise settings to mark devices as compliant or not compliant using Intune](../compliance/ref-android-enterprise-settings.md#personally-owned-work-profile)
- [Android Enterprise device settings to allow or restrict features using Intune](../../device-configuration/templates/ref-device-restrictions-android-enterprise.md) > Personally owned
...
> [!Note]
> When a personally-owned work profile is enabled, "One Lock" is configured by default to combine device and work profile passcodes. One Lock can be disabled to separate work profile and device passcodes if necessary, under work profile settings. For more information, review the setting *One lock for device and work profile* in the [Work Profile Password](../../device-configuration/templates/ref-device-restrictions-android-enterprise.md) section of in *Android Enterprise personally owned devices*.
...
[Configure security settings for fully managed devices](./android-fully-managed.md)
