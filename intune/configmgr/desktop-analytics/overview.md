...
>
> The capabilities of Windows Analytics are combined in the Desktop Analytics service. Desktop Analytics is also more tightly integrated with Configuration Manager. For more information, see the [FAQ for Windows Analytics customers](/intune/configmgr/desktop-analytics/faq#existing-windows-analytics-customers).
...
- [Set up Intune](../../intune-service/fundamentals/deployment-plan-setup.md) for your organization.
