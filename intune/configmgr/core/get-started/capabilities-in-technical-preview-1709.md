...
- [Factory reset](../../../intune-service/remote-actions/devices-wipe.md#wipe)
- [Selective wipe](../../../intune-service/apps/apps-selective-wipe.md)
- [Delete devices](../../../intune-service/remote-actions/devices-wipe.md#delete-devices-from-the-azure-active-directory-portal)
- [Restart device](../../../intune-service/remote-actions/device-restart.md)
- [Fresh start](../../../intune-service/remote-actions/device-fresh-start.md)
...
<!-- - [Device compliance policies](../../../intune-service/protect/compliance-policy-create-windows.md)  -->
- [Windows Update for Business policies](../../../intune-service/protect/windows-update-for-business-configure.md)  
- [Device configuration profiles](../../../intune-service/configuration/device-profile-create.md)  
...
2. Configure automatic enrollment in Microsoft Entra ID for your devices to be automatically enrolled into Intune. For details, see [Enroll Windows devices for Microsoft Intune](../../../intune-service/enrollment/windows-enroll.md).
...
1. Configure automatic enrollment in Microsoft Entra ID for your devices to be automatically enrolled into Intune. For details, see [Enroll Windows devices for Microsoft Intune](../../../intune-service/enrollment/windows-enroll.md).  
