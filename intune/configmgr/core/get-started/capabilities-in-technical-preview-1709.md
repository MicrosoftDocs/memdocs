...
- [Factory reset](/intune-service/devices-wipe#wipe)
- [Selective wipe](/intune-service/apps-selective-wipe)
- [Delete devices](/intune-service/devices-wipe#delete-devices-from-the-azure-active-directory-portal)
- [Restart device](/intune-service/device-restart)
- [Fresh start](/intune-service/device-fresh-start)
...
<!-- - [Device compliance policies](/intune-service/compliance-policy-create-windows)  -->
- [Windows Update for Business policies](/intune-service/windows-update-for-business-configure)  
- [Device configuration profiles](/intune-service/device-profile-create)  
...
2. Configure automatic enrollment in Microsoft Entra ID for your devices to be automatically enrolled into Intune. For details, see [Enroll Windows devices for Microsoft Intune](/intune-service/windows-enroll).
...
1. Configure automatic enrollment in Microsoft Entra ID for your devices to be automatically enrolled into Intune. For details, see [Enroll Windows devices for Microsoft Intune](/intune-service/windows-enroll).  
