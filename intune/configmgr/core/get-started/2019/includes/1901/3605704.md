...
- [Azure Resource Manager for the cloud distribution point](/previous-versions/troubleshoot/configmgr/use-a-cloud-based-distribution-point#azure-resource-manager)
