...
- From Intune's Windows 10 compliance policy, make sure that **Require** is set for [**Configuration Manager Compliance**](/intune/device-security/compliance/ref-windows-settings#configuration-manager-compliance).
