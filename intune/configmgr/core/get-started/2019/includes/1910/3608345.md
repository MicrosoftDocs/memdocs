...
- From Intune's Windows 10 compliance policy, make sure that **Require** is set for [**Configuration Manager Compliance**](/intune-service/protect/compliance-policy-create-windows#configuration-manager-compliance).
