...
- This feature only supports the Intune Win32 app type.
  ...
  - Create and assign (deploy) a new app in Intune for this purpose. (Apps created before Intune version 1811 don't work.) For more information, see [Intune Win32 app management](../../../../../../intune-service/apps/apps-win32-app-management.md).
