...
- Distribute the packages for the task sequence to the content-enabled CMG or a [cloud distribution point](/previous-versions/troubleshoot/configmgr/use-a-cloud-based-distribution-point).
