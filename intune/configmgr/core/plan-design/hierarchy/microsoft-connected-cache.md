...
To use Intune to configure this policy, use the **DO Cache Host** setting in Intune Delivery Optimization profiles created after April 24, 2025. If your Intune profile was created before April 24, 2025, use the setting named **Cache server host names**. For more information, see [Delivery Optimization settings for Windows devices in Intune](../../../../intune-service/configuration/delivery-optimization-settings.md#local-server-caching).
