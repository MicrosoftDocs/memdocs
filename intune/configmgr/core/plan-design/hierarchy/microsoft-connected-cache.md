...
- For apps managed in Intune, this feature only supports the Intune Win32 app type.
  ...
  - Create and assign (deploy) a new app in Intune for this purpose. (Apps created before Intune version 1811 don't work.) For more information, see [Win32 app management in Microsoft Intune](../../../../app-management/deployment/win32-overview.md).
