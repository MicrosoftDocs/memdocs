...
> [!IMPORTANT]
> When there are multiple SMS providers and one or more providers are offline or unavailable, connections may fail. This includes connections to the Admin console and scenarios using Site Server High Availability.
