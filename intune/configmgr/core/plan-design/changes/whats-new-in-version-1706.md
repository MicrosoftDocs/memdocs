...
For details, see [Integration with Windows Update client policies in Windows 10](../../../sum/deploy-use/integrate-windows-update-client-policies.md#configure-windows-update-for-business-deferral-policies).
