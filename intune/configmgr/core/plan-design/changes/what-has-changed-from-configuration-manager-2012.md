...
> [!NOTE]
> Since October 2019, Configuration Manager is part of Microsoft Intune family of products. For more information, see [Microsoft Configuration Manager FAQ](../../understand/microsoft-endpoint-manager.yml).
