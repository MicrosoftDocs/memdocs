...
For more information, see [Configure Endpoint analytics data collection in Configuration Manager](../../../../endpoint-analytics/configure.md?pivots=cm#bkmk_cm_upload).
