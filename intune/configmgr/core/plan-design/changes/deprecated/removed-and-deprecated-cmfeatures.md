...
|-------|---------------------------|----------------------|
| The **MDT Integration with CM and Standalone**  is no longer supported with Configuration Manager. Customers should remove MDT TS steps, followed by removing MDT integration, to avoid TS corruption and modification failures. More information on the MDT retirement [here](/support/mem/configmgr/mdt/mdt-retirement.md). | Dec 2024 | The first release after Oct 10, 2025 |
