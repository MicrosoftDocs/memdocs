...
For more information, see [Enable data sharing](../../../../intune-service/protect/windows-update-compatibility-reports.md).<!--Link updated to redirection target.-->
...
For more information, see [Desktop Analytics prerequisites](../../../../intune-service/protect/windows-update-compatibility-reports.md).<!--Link updated to redirection target.-->
