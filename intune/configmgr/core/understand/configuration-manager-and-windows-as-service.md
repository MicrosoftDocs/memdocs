...
| [Integrate Windows Update client policies (optional)](../../sum/deploy-use/integrate-windows-update-client-policies.md) | Explains how to define and deploy Windows Update client policies using Configuration Manager. |
