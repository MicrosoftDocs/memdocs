...
- [Settings for firewall policy for tenant attached devices](../../device-configuration/endpoint-security-policies/ref-firewall-settings-tenant-attach.md?toc=/mem/configmgr/tenant-attach/toc.json&bc=/mem/configmgr/tenant-attach/breadcrumb/toc.json)
