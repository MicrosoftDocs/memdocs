...
- [Microsoft Intune and Microsoft Defender for Endpoint integration enabled](../../intune-service/protect/microsoft-defender-integrate.md#connect-microsoft-defender-for-endpoint-to-intune)
