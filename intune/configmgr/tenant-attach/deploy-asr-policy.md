...
- [Attack surface reduction policy settings for tenant attached devices](../../device-configuration/endpoint-security-policies/ref-attack-surface-reduction-settings.md?toc=/mem/configmgr/tenant-attach/toc.json&bc=/mem/configmgr/tenant-attach/breadcrumb/toc.json#attack-surface-reduction-configmgr).
