...
[Mismatch certificate subject name error when running client action for Configuration Manager device](/troubleshoot/intune/configmgr/tenant-attach-component-not-connect-to-gateway)
