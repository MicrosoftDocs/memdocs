...
- **Cloud Management Gateway VMSS image updated to remove end-of-life .NET 6**
   ...
   The Cloud Management Gateway (CMG) Virtual Machine Scale Set (VMSS) image is updated to use a new SKU that doesn't include .NET 6, which has reached end of life. For more information, see [KB 37784287](../2603/37784287.md).
...
- Cloud Management Gateway VMSS image updated to remove end-of-life .NET 6. For more information, see [KB 37784287](../2603/37784287.md).
...
- [KB 37784287](../2603/37784287.md): CMG update for VMSS image deprecation
