...
This article describes issues that are fixed in the update rollup for Microsoft Configuration Manager current branch, version 2509. This update applies both to customers who opted in through a PowerShell script to the early update ring deployment, and customers who installed the globally available release.
...
<!-- 30809803 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/30809803 -->
...
<!-- 33922858 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/33922858 -->
...
<!-- 34826316 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/34826316 -->
- **Software Center compliance check fails in co-managed environments**

   In co-managed environments where the Compliance workload is set to Intune, the Software Center compliance check fails with error `GET_TOKEN_FROM_STS_ERROR : FFFFFFFF80004003`. Devices are unable to perform compliance evaluation from Software Center. For more information, see [KB 37172183](../2503/37172183.md).

<!-- 36429425 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/36429425 -->
...
<!-- 35987882 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/35987882 -->
- **Co-managed clients with 3rd party update catalogs receive updates from incorrect source**

   In ConfigMgr 2509, co-managed clients with 3rd party update catalogs stop receiving updates from the expected source. The Windows Update Agent is locked to WSUS for Quality, Feature, and Driver updates even though the co-management slider is set to Intune. In non-co-managed scenarios, machines previously locked to WSUS may unexpectedly start reaching Windows Update, potentially causing unplanned updates or OS upgrades. The following `SetPolicyDrivenUpdateSource` registry values under `HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate` are incorrectly modified. This issue was originally addressed in [KB 36495448](../2509/36495448.md).

<!-- 37049155 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/37049155 -->
...
<!-- 37473392 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/37473392 -->
...
<!-- 37267646 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/37267646 -->
...
<!-- 37348867 - https://msazure.visualstudio.com/Configmgr/_workitems/edit/37348867 -->
...
| Component | Version |
|---|---|
| Configuration Manager console | 5.2509.xxxx.xxxx |
| Client | 5.0.9140.xxxx |

## File information

File information for the release is available in the downloadable [KB36949461_FileList.txt](https://aka.ms/KB36949461_FileList) text file.
