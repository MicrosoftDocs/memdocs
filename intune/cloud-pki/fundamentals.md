...
> ![Diagram of the chain validation process using the name match method.](./images/fundamentals/chain-validation.png)
...
> [!div class="mx-imgBorder"]
> ![Diagram of the chain of validation process.](./images/fundamentals/chain-of-trust.png)
...
> [!div class="mx-imgBorder"]
> ![Diagram of a handshake between a client and relying party service.](./images/fundamentals/certificate-handshake.png)
