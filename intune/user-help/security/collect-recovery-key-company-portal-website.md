...
If you're an IT support person and want to configure and manage FileVault encryption, see [Use FileVault disk encryption for macOS with Intune](../../device-configuration/endpoint-security-policies/encrypt-filevault-macos.md#monitor-and-manage-filevault).
