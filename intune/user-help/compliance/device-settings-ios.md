...
For more information about mobile threat defense apps like Microsoft Defender for Endpoint, see [Set up mobile threat defense](../security/setup-mobile-threat-defense.md).
