...
Company Portal is also available from the [Baidu App Store](https://go.microsoft.com/fwlink/?linkid=2133565). To find it:
   ...
   3. Select the Company Portal ![Company Portal icon](./media/install-android-china/company-portal-logo-small-2101.png) listing.
...
## Next steps
After you install the app on your device, follow your organization's instructions to set up your device for school or work. For enrollment help, see [Enroll Android device with Intune Company Portal](../enrollment/enroll-company-portal-android.md).
