...
In addition to everything under [What happens on all devices after enrollment](overview-windows.md#what-happens-on-all-devices-after-enrollment), after you enroll a Windows device in Intune:
