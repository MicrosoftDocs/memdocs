...
1. Optionally, on the **Account Settings** page, you can configure the local administrator and user accounts on targeted Macs.
   ...
   For information about configuring and then managing this capability, [Configure support for macOS ADE local account configuration with LAPS in Microsoft Intune](./device-security/laps/setup-macos.md).
