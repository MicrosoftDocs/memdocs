...
* **Toggle All** (optional): Hide
 ...
 For more information about how-to create an enrollment policy, see [Create an Apple enrollment policy](setup-automated-ios.md#create-an-apple-enrollment-policy).
