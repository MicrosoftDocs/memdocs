...
description: Sync devices, assign enrollment profiles, and distribute Mac computers for Apple automated device enrollment in Microsoft Intune.
ms.date: 04/15/2026
ms.topic: how-to
ms.reviewer: beflamm
...
Use this article to sync macOS devices with Apple Business Manager, manage your enrollment tokens, and distribute devices to users.
