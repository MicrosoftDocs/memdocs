...
[Microsoft Teams certified Android devices](/microsoftteams/devices/teams-ip-phones) should continue being managed with device administrator management until [AOSP user-associated](setup-aosp-corporate-user-associated.md) management becomes available for these devices.
