...
| Prevent copy and paste |  **Restrict copy and paste (Knox only)**  <br> <br> Setting available in [Configuration policy > General](../../intune-service/configuration/device-restrictions-android.md#general).   | **Restrict cut, copy, and paste between other apps** <br> <br>  Setting available in [App protection policy > Data protection](../../app-management/protection/ref-settings-android.md#data-protection). | |
