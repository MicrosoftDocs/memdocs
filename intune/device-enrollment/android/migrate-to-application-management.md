...
| Enforce password | Password settings vary depending on policy type used.  <br> <br> Settings available in [Configuration policy > Password](../../device-configuration/templates/ref-device-restrictions-android.md#password) and [Compliance policy > Device security](../../intune-service/protect/compliance-policy-create-android.md#device-security).  | **PIN for app access** <br> <br>  Setting available in [App protection policy > Access requirements](../../app-management/protection/ref-settings-android.md#access-requirements). |  |
...
| Block rooted devices| **Rooted devices** <br> <br> Setting available in [Compliance policy > Device health](../../intune-service/protect/compliance-policy-create-android.md#device-health).| **Jailbroken/rooted devices** <br> <br> Setting available in [App protection policy > Conditional launch](../../app-management/protection/ref-settings-android.md#conditional-launch). |
...
| VPN |Create a [VPN profile](../../device-configuration/templates/configure-vpn.md) in a configuration policy.  |Set up [Microsoft Tunnel for Mobile App Management](../../intune-service/protect/microsoft-tunnel-mam-android.md). |  |
