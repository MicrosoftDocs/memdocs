...
- Samsung devices only: The device must have Knox, list of Knox compatible devices here [Device Compatibility Knox Solutions | Samsung Knox](https://www.samsungknox.com/en/knox-platform/supported-devices).
