...
## Certificates  
>[!NOTE]
> The [ACME certificate](../fundamentals/whats-new.md#acme-protocol-support-for-iosipados-and-macos-enrollment] phased rollout for new eligible enrollments has been paused. New enrollments are using the SCEP certificate like before with no changes to the end user experience.
