items: 
  ...
  - name: 3. Deploy devices
    items: 
      ...
      - name: iOS
        items:
          - name: Enroll with Company Portal
            href: enroll-ios-company-portal.md
          - name: Enroll devices with Automated Device Enrollment
            href: enroll-ios-ade.md
          - name: Bulk enrollment with Apple Configurator
            href: enroll-ios-apple-configurator.md
  ...
  - name: 6. Simplified configuration
    items: 
      - name: Overview
