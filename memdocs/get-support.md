...
:::image type="content" source="./media/get-support/scenarios-example.png" alt-text="Screenshot that shows scenario options in the Endpoint Manager admin center and Microsoft Intune.":::
