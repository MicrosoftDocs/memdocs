...
To create custom device scopes, a user must have the **Roles/Read** [role permission](../memdocs/intune/fundamentals/create-custom-role.md#custom-role-permissions) and this permission is in the following built-in roles:
