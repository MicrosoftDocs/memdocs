...
|The input application you specified is not in ![image](https://user-images.githubusercontent.com/49541449/129267767-8b123b55-89e6-408e-b529-d1e5295763cd.png)
![image](https://user-images.githubusercontent.com/49541449/129267782-1f6887b8-e197-4516-aba7-dc34b39d9bd0.png)
a Position Independent Executable (PIE) format. Specify a valid application in PIE format.|Position Independent Executable (PIE) apps can be loaded at a random memory address when run. This can have security benefits. For more about security benefits, see your Apple Developer documentation.|
