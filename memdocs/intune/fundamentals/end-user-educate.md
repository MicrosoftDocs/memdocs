...
* **Android**
  * [Using an Android device with Intune](https://docs.microsoft.com/user-help/using-your-android-device-with-intune)
  * [How your Android users get their apps](end-user-apps-android.md)

* **iOS**
  * [Using an iOS/iPadOS device with Intune](https://docs.microsoft.com/user-help/using-your-ios-device-with-intune)
  * [How your iOS/iPadOS users get their apps](end-user-apps-ios.md)

* **Windows**
  * [Using a Windows device with Intune](https://docs.microsoft.com/user-help/using-your-windows-device-with-intune)
