...
7. On the **OPtional settings** page, you have the option to:
    - Assign the new user additional roles (by default the new user is igven the User role).
...
3. Choose whether you want to create the password for the new user or have it auto-generated.  
