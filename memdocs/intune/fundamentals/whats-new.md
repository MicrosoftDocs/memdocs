...
We’ve released a [new version](../protect/microsoft-tunnel-upgrade#microsoft-tunnel-update-history) of the Microsoft Tunnel Gateway. It includes the following changes:
