...
For more information, see [Enable Microsoft Intune tenant attach - Configuration Manager](../../memdocs/configmgr/tenant-attach/device-sync-actions.md).
