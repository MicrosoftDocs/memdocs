...
ACME is supported for Apple Device Enrollment, Apple Configurator enrollment, and Automated device enrollment (ADE) methods. It's supported in Intune public tenants and GCC high tenants. Eligible OS versions include:
