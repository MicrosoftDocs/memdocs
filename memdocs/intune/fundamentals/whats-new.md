...
ACME is supported for Apple Device Enrollment, Apple Configurator enrollment, and Automated device enrollment (ADE) methods. It's also supported in Government Community Cloud (GCC) High environments. Eligible OS versions include:
