...
>
> For a list of upcoming Intune feature releases, see the Intune [In Development](../fundamentals/in-development.md) topic. For new information about Autopilot, see the Windows Autopilot [What's New](/mem/autopilot/windows-autopilot-whats-new) topic.
