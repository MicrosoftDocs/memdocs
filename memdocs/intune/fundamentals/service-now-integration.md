...
- You must have ServiceNow permissions to view incidents when using the **Test connection** action and a ServiceNow license needs to be assigned to admins who view  incidents. 
