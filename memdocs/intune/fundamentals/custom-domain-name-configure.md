...
5. [You may need to create additional DNS records for Intune enrollments](../intune/enrollment/windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium).
...
You can learn more about how to [simplify Windows enrollment without Azure AD Premium](../intune/enrollment/windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium) by creating a DNS CNAME that redirects enrollment to Intune servers.
