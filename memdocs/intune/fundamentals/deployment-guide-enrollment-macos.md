...
- In the [Intune admin center](https://go.microsoft.com/fwlink/?linkid=2109431),Navigate to **Apple Configurator** to create an enrollment profile. Choose to **Enroll with user affinity** (associate a user to the device), or **Enroll without user affinity** (user-less devices or shared devices).
