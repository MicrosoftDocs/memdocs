...
| Android Enterprise/Read | View the Android Enterprise configuration used to sync applications with the Play for Work store or view the Android Enterprise enrollment prerequisites and enrollment profiles. |
...
| Android Enterprise/Update onboarding | Manage or change the Android Enterprise configuration used to enroll Android Enterprise devices or manage the Android Enterprise enrollment profiles. |
...
| Remote tasks/Reset passcode | Initiates a forced removal of the passcode, and requires the device user to set a new passcode. Supported on iOS devices, and certain later versions of Android and Android Enterprise. Not supported on older Android versions, macOS, or Windows. | 
