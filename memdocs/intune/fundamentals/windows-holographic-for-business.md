...
To use Windows Holographic devices with Intune, create an Edition Upgrade profile. This upgrade profile upgrades the devices from Windows Holographic to Windows Holographic for Business. For the Microsoft HoloLens, you can buy the Commercial Suite to get the required license for the upgrade. For more information, see [Upgrade devices running Windows Holographic to Windows Holographic for Business](../intune/configuration/holographic-upgrade.md).
...
**[Create a device compliance policy](../intune/protect/compliance-policy-create-windows.md)**
...
See also **[Get started with compliance policies](../intune/protect/device-compliance-get-started.md)**.

## Deploy and manage apps

**[Add apps to Intune](../intune/apps/apps-add.md)**
...
- [Add Microsoft Store apps](../intune/apps/store-apps-windows.md)
- [Add apps you create](../intune/apps/lob-apps-windows.md)
- [Assign apps to groups](../intune/apps/apps-deploy.md)
...
- To deploy Line-of-Business (LOB) apps using the Intune Azure portal, see [How to add Windows line-of-business apps to Microsoft Intune](../intune/apps/lob-apps-windows.md).

    > [!NOTE]
    > Intune allows a maximum package size to 8 GB. This package size is only available for the LOB apps uploaded to Intune.

- To deploy apps using the Microsoft Store for Business, see [How to manage apps you purchased from the Microsoft Store for Business with Microsoft Intune](../intune/apps/windows-store-for-business.md). 
- To learn about app management with Microsoft Intune, see [What is app management in Microsoft Intune](../intune/apps/app-management.md).
...
- **[Wipe](../intune/remote-actions/devices-wipe.md#wipe)**: The **Wipe** action removes the device from Intune, and restores the device back to its factory default settings. Use this action before giving the device to a new user, or when the device is lost or stolen.

- **[Retire](../intune/remote-actions/devices-wipe.md#retire)**: The **Retire** action removes the device from Intune. It also removes managed app data, settings, and email profiles assigned by Intune. The user's personal data stays on the device.

- **[Sync devices to get the latest policies and actions](../intune/remote-actions/device-sync.md)**: The **Sync** action forces the device to immediately check in with Intune. When a device checks in, the device immediately receives any pending actions or policies that are assigned. This feature helps you validate and troubleshoot policies you’ve assigned, without waiting for the next scheduled check-in.

**[What is Microsoft Intune device management?](../intune/remote-actions/device-management.md)** is a good resource to learn about managing devices using the Azure portal. 

## Device categories and groups

**[Categorize devices into groups](../intune/enrollment/device-group-mapping.md)**
...
**[Get started with configuration profiles](../intune/configuration/device-profiles.md), and [create your own profile](../intune/configuration/device-profile-create.md)**
...
### [Custom device settings](../intune/configuration/custom-settings-windows-holographic.md)
...
### [Configure kiosk mode](../intune/configuration/kiosk-settings-holographic.md)
...
### [Device restrictions](../intune/configuration/device-restrictions-windows-holographic.md)

Device restrictions let you control different settings and features on your devices, including requiring a password, installing apps from [Microsoft Store](https://www.microsoft.com/store/intune/apps/windows?icid=CNavAppsWindowsApps), enabling Bluetooth, and more. These restrictions are created in an Intune profile. This profile can be applied to multiple devices running Windows Holographic for Business.

### [Configure VPN](../intune/configuration/vpn-settings-configure.md)
...
### [Configure Wi-Fi](../intune/configuration/wi-fi-settings-configure.md)
...
[Shared devices](../intune/configuration/shared-user-device-settings-windows-holographic.md)
...
**[Manage software updates](../intune/protect/windows-update-for-business-configure.md)**
...
**[Set your company's terms and conditions for user access](../intune/enrollment/terms-and-conditions-create.md)**
...
**[Use Windows Hello for Business](../intune/protect/windows-hello.md)**
