...
- In case of no scope tags and some scope tags assigned from different assignments, user will only be able to see devices with that are part of some scope tags and will not be able to see all devices. 
