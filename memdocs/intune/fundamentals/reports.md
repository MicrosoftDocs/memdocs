...
For related information, see [Enforce compliance for Microsoft Defender ATP with Conditional Access in Intune](~/intune/protect/advanced-threat-protection.md).
