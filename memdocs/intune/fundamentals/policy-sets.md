...
3. On the **Basics** page, add the following values:
   ...
   <p>
   <img alt="Create policy set - Basics" src="~/intune/fundamentals/media/policy-sets/policy-sets-01.png">

4. Click **Next: Application management**.<br>
   On the **Application management** page you can optionally [add apps](~/intune/apps/apps-add.md), [app configuration policies](~/intune/apps/app-configuration-policies-overview.md), and [app protection policies](~/intune/apps/app-protection-policy.md) to your policy set. For information about app management, see [What is Microsoft Intune app management?](~/intune/apps/app-management.md). 
5. Click **Next: Device management**.<br>
   The **Device management** page allows you to add device management objects to your policy set, such as [device configuration profiles](~/intune/configuration/device-profiles.md) and [device compliance policies](~/intune/protect/device-compliance-get-started.md). Be sure to include all associated objects, such as other policies, certificates, and security baseline profiles.
6. Click **Next: Device enrollment**.<br>
   The **Device enrollment** page allows you to add device enrollment objects to your policy set, such as [device type restrictions](~/intune/enrollment/enrollment-restrictions-set.md), [Windows Autopilot deployment profiles](~/intune/enrollment/enrollment-autopilot.md), and [enrollment status page profiles](~/intune/enrollment/windows-enrollment-status.md).
...
- [Enroll devices in Microsoft Intune](~/intune/enrollment/index.yml).