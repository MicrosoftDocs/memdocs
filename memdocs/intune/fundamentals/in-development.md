...
### Use MAM policies with COSU and AOSP devices<!-- 13819227 -->
Intune-managed Android Enterprise corporate owned dedicated devices (COSU) in Azure Active Directory (Azure AD) shared mode and AOSP devices will be able to receive MAM policies and be targeted separately from other Android enterprise devices. For more information about COSU and AOSP, see [Android Enterprise dedicated devices](../fundamentals/deployment-guide-enrollment-android.md#android-enterprise-dedicated-devices).
