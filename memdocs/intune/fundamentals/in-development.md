...
You'll soon be able to use [Endpoint Privilege Management](/mem/intune/protect/epm-overview) (EPM) file elevations on devices that run on Arm64 architecture.
