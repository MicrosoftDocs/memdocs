...
|[Windows Autopilot scenarios](../../autopilot/tutorial/autopilot-scenarios.md)| Simplify the user-driven or self-deploying OOBE for you and your users by setting up Microsoft Intune device enrollment to occur automatically during Windows Autopilot. | 
|[Enroll hybrid Azure AD-joined devices with Windows Autopilot ](../../autopilot/tutorial/autopilot-scenarios.md)| The Intune connector for Active Directory enables devices in Active Directory domain services to join to Azure AD, and then automatically enroll in Intune. We recommend this enrollment option for on-premises environments that use Active Directory domain services and can't currently move their identities to Azure AD. | 
