...
|[Add Intune Company Portal app for Autopilot ](../apps/store-apps-company-portal-autopilot.md)|Assign the offline version of the Company Portal app on devices during Windows Autopilot setup.| 
