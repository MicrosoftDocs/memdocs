...
> - If you use the `operatingSystemVersion` filter for available apps on all Android, AOSP, and iOS platforms the evaluation result is inconclusive. This behavior is a known issue and will be fixed in a future release. No ETA.
