...
We’ve released a [new version](../protect/microsoft-tunnel-update.md#microsoft-tunnel-update-history) of the Microsoft Tunnel Gateway, which includes the following changes:
...
We’ve released a [new version](../protect/microsoft-tunnel-update.md#microsoft-tunnel-update-history) of the Microsoft Tunnel Gateway. The following changes are included in the new version:
