...
## Device protection, authentication, and authorization for Zero Trust
...
|---------|---------|
| Verify explicitly | Intune allows you to configure policies for apps, security setting, device configuration, compliance, Azure Active Directory (AD) Conditional Access, and more. These policies become part of the authentication and authorization process of accessing resources.  |
