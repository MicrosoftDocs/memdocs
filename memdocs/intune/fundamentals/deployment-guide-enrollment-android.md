...
| Devices are personal or BYOD. | ❌ <br/><br/>BYOD or personal devices should be enrolled using [Android Enterprise personally owned work profile](#byod-android-enterprise-personally-owned-work-profile) (in this article).|
...
- Enroll new devices using [Android Enterprise personally-owned work profiles](#byod-android-enterprise-personally-owned-work-profile) (in this article). Don't enroll new devices using Android device administrator.
