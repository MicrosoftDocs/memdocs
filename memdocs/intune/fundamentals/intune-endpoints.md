...
**Proxy configuration**
- [Prerequisites for Microsoft Store for Business and Education] (https://learn.microsoft.com/en-us/microsoft-store/prerequisites-microsoft-store-for-business)
