...
|devicelistenerprod.microsoft.com| WUfB-DS |
|devicelistenerprod.eudb.microsoft.com| WUfB-DS |
|login.windows.net| WUfB-DS |
|payloadprod*.blob.core.windows.net| WUfB-DS |
