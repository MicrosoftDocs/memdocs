...
Click *Try it* to open Graph Explorer. Once Graph Explorer is open, select the 👤 person icon in the top right to sign-in. Click **Run query** to create a policy in your tenant with the name **MS Learn - macOS Remote Help Privacy Preferences Policy Control**. After it's created, you can edit the policy as required and assign to your devices.
