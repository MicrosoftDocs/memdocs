...
1. Click *Try it* to open Graph Explorer. 
    ...
    ```
1. Once Graph Explorer is open, select the :::image type="icon" source="../media/icons/graph.svg"::: user icon in the top right to sign-in and sign in with your Intune administrator oragnizational account.
