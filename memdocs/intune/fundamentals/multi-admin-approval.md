...
- An admin who has submitted a change can view the status of their requests in the [Microsoft Intune admin center](https://endpoint.microsoft.com/) by going to **Tenant administration** > **Multi Admin Approval** and viewing the **My request** page.
...
1. To create an access policy, in the [Microsoft Intune admin center](https://endpoint.microsoft.com/), go to **Tenant administration** > **Multi Admin Administration** > **Access policies** and select **Create**.
...
To monitor the status of your requests, in the [Microsoft Intune admin center](https://endpoint.microsoft.com/) go to **Tenant administration** > **Multi Admin Approval** > **My requests**.
...
1. To find requests to approve, in the [Microsoft Intune admin center](https://endpoint.microsoft.com/) go to **Tenant administration** > **Multi Admin Administration** > **Received requests**.
