...
:::image type="content" source="./media/manage-identities/identities-different-user-types.png" alt-text="Image that shows addings users to the Endpoint Manager admin center and assigning policies to different user types in Microsoft Intune.":::
