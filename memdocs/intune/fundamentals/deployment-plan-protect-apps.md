...
| Apps included with your Intune license | The license you use with Microsoft Intune may include the app licenses you require. For more information, see [App licenses included with Intune](../apps/apps-license-overview?#app-licenses-included-with-intune).  |
