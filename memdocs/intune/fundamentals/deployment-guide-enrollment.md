...
- Sign in as a member of the **Policy and Profile Manager** Microsoft Entra role. For information on this role, go to [Microsoft Entra built-in roles - Intune Administrator](/entra/identity/role-based-access-control/permissions-reference#intune-administrator).
  ...
  It's possible some enrollment platforms might require a more privileged role, like the **Intune Service Administrator** built-in Intune role. For more information, go to:
