...
## Next steps
- To learn about Intune-based deployment for Microsoft Defender for Endpoint on macOS, see [Intune-based deployment for MDE on macOS](/microsoft-365/security/defender-endpoint/mac-install-with-intune)
