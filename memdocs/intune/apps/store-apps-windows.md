...
5. To configure the **App information** for Microsoft store apps, navigate to the [Microsoft store](https://www.microsoft.com/store/apps), Click on **Open Store Apps** and search for the app you want to deploy. Display the app page and make a note of the app details. 
