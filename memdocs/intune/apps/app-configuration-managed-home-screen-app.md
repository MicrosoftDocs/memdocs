...
| Device's serial number | enum | *serialnumber* | Set this setting to easily view the device's serial number from the Managed Home Screen app on all Android OS versions 8 and later. This property is auto-populated by Intune with the correct value. | ❌ |
