...
> [!NOTE]
> It is currently possible, and advisable, to set allow-listed applications and pinned web links through **Apps** and **Device configuration**. For the full list of settings available in **Device configuration** that impact Managed Home Screen,  see [Dedicated device settings](../configuration/device-restrictions-android-for-work.md#dedicated-devices).  
