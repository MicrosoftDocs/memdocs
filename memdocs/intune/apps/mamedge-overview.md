...
- Intune application configuration policies (ACP) with Microsoft Edge for Business, using ACP isn’t just about customizing the experience, but also leveraging Edge’s rich collection of settings to help enable a secure browsing experience.
