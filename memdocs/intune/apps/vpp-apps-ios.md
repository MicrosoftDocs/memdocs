...
- **Store apps:** Using Apple Business Manager, Content Managers can aquire both free and paid apps that are available in the App Store.
- **Custom Apps:** Using Apple Business Manager, Content Managers can also aquire Custom Apps made available privately to your organization. These apps are tailored to your organization's specific needs by developers with whom you work directly. Learn more about [how to distribute Custom Apps](https://developer.apple.com/business/custom-apps/).
