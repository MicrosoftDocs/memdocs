...
> [!IMPORTANT]
> When deploying Win32 apps using an installation file with the .msi extension, consider using [Intune Management Extension](../apps/intune-management-extension.md) (packaged in an .intunewin file using the Content Prep Tool). If you mix the installation of Win32 apps and line-of-business apps during AutoPilot enrollment, the app installation may fail.  
