...
1. Sign in to the [Microsoft Endpoint Manager admin center](https://devicemanagement.microsoft.com/#blade/Microsoft_Intune_DeviceSettings/DevicesMenu/overview
).
