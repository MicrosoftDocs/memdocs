...
When adding an app from the Enterprise App Catalog, Microsoft provides you with the following details:
...
Microsoft also provides you with the application specific rules used to detect the presence of the application. 
