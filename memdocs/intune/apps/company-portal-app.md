...
| Device enrollment | N/A | Specify if and how users should be prompted to enroll into   mobile device management. For more information, see [Device enrollment setting options](./apps/company-portal-app.md#device-enrollment-settings-options). |
...
| Azure AD Enterprise Applications | N/A | Select **Hide** or **Show** to display **Azure AD Enterprise applications** in the Company Portal for each end-user. For more information, see [App source setting options](./apps/company-portal-app.md#app-source-settings-options). |
| Office Online Applications | N/A | Select **Hide** or **Show** to display **Office Online applications** in the Company Portal for each end-user. For more information, see [App source setting options](./apps/company-portal-app.md#app-source-settings-options). |
