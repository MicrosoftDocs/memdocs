...
Note: these apps are not supported on Android Enterprise. Managed Google Play is the sole source of applications for [Android Enterprise in Intune](https://learn.microsoft.com/en-us/mem/intune/apps/apps-add-android-for-work). 
