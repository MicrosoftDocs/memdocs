...
5. Click **Next: Scope tags**.<br>
   On the **Scope tags** page you can optionally configure scope tags to determine who can see the app policy in Intune. For more information about scope tags, see [Use role-based access control and scope tags for distributed IT](~/intune/fundamentals/scope-tags.md).
...
- For more information about Win32 apps, see [Intune Win32 app management](~/intune/apps/apps-win32-app-management.md).
