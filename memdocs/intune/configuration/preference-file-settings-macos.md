...
3. Enter the following properties:
   ...
   - **Name**: Enter a descriptive name for the profile. Name your profiles so you can easily identify them later. For example, a good profile name is **macOS: Preference file that using plist file to configure Microsoft Defender ATP**.
   - **Description**: Enter a description for the profile. This setting is optional, but recommended.
   - **Platform**: Select **macOS**.
   - **Profile type**: Select **Preference file**.
...
5. When finished, select **OK** > **Create** to save your changes. The profile is created, and shown in the profiles list.
