...
- [Configure web protection in Microsoft Defender Advanced Threat Protection for Android](../protect/advanced-threat-protection.md#configure-web-protection-on-devices-that-run-android)
