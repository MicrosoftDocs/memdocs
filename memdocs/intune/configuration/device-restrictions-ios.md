...
- **Block modification of device name**: **Yes** prevents changing the device name locally and remotely via MDM. When set to **Not configured** (default), Intune doesn't change or update this setting. By default, the OS might allow users to change the name of devices.
