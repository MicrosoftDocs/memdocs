...
- **Detect potentially unwanted applications**: This feature identifies and blocks potentially unwanted applications (PUA) from downloading and installing in your network. These applications aren't considered viruses, malware, or other types of threats. But, they can run actions on endpoints that might affect their performance or use. Choose the level of protection when Windows detects PUAs. Your options:
  ...
  - **Off/Disabled**: PUA Protection off.
  ...
  For more information about potentially unwanted apps, see [Detect and block potentially unwanted applications](/windows/security/threat-protection/microsoft-defender-antivirus/detect-block-potentially-unwanted-apps-microsoft-defender-antivirus). This setting has a slight name variation between Device Restrictions in Devices (Detect potentially unwanted applications) and Antivirus in Endpoint Security (Action to take on potentially unwanted applications).
