...
title: Configure macOS Enterprise SSO plug-in with any MDM provider
...
This article explains how to deploy the Microsoft Enterprise SSO plug-in (preview) for macOS devices with any MDM solution.
