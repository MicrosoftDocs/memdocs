...
> [!TIP]
> For more information on StageNow, and what it does, go to [StageNow Android device staging](https://www.zebra.com/us/en/software/mobile-computer-software/stagenow.html) (opens Zebra's web site).
