...
- **Excluded URLs** (Zscaler only): When connected to the Zscaler VPN, the listed URLs are accessible outside the Zscaler cloud. Currently, Intune supports uploading up to 50 URLs to be excluded.
