...
- **Select xml, mobileconfig File**: Browse to the configuration profile you created using the Apple Configurator or Apple Profile Manager. The max file size is 1000000 bytes (just under 1 MB). The file you import is shown is shown in the **Configuration profile file** area. You can also **Remove** a file after it's been added.
