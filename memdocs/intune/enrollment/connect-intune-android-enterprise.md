...
## Connect accounts  
> [!TIP]
> Due to the interaction between Google and Microsoft domains, you may need to adjust your browser settings to complete this process. Ensure that portal.azure.com, play.google.com, and enterprise.google.com are in the same security zone in your browser. Please refer to the [Per-site configuration](https://learn.microsoft.com/en-us/deployedge/per-site-configuration-by-policy) for instructions on how to perform these configurations in your browser.
