...
Intune can use Azure Active Directory (AD) Conditional Access policieis to require multi-factor authentication (MFA) for device enrollment to help you secure your corporate resources.
