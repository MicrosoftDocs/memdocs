...
10. If you want devices using this profile to be supervised, select **Yes** in the **Supervised** list:
    ...
    Users are notified that their devices are supervised in the **Settings** app:
    
    - At the top left side under **Settings** it will show **This iPhone is supervised and managed by *Company name*.**
