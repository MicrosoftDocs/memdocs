...
For end-user enrollment instructions, see [Enroll your Windows device in Intune](../user-help/windows-enrollment-company-portal.md). You can also tell users to review [What can my IT admin see on my device](../user-help/what-info-can-your-company-see-when-you-enroll-your-device-in-intune).
