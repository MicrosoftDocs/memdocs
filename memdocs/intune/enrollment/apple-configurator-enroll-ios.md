...
Note - This article goes through the steps of direct enrollment with Apple Configurator for macOS devices without user affinity - https://docs.microsoft.com/en-us/mem/intune/enrollment/device-enrollment-direct-enroll-macos
