...
4. To enable a connection between Apple School Manager and Azure AD, choose **Set up Microsoft School Data Sync**. Learn more about [how to set up School Data Sync](https://docs.microsoft.com/en-us/schooldatasync/how-to-deploy-sds-using-sds-v2.1-csv-files).
5. Click **Save** > **OK**.
