...
For more information about Intune support for Android device administrator support, see the [Notices section](../intune/fundamentals/whats-new.md#decreasing-support-for-android-device-administrator).
...
1. To prepare to manage mobile devices, you must set the mobile device management (MDM) authority to **Microsoft Intune**. See [Set the MDM authority](../intune/fundamentals/mdm-authority-set.md) for instructions. You set this item only once, when you are first setting up Intune for mobile device management.
...
After a user has enrolled, you can begin managing their devices in Intune, including [assigning compliance policies](../intune/protect/compliance-policy-create-android.md), [managing apps](../intune/apps/app-management.md), and more.

For information about other user tasks, see these articles:
- [Resources about the end-user experience with Microsoft Intune](../intune/fundamentals/end-user-educate.md)
...
## Next steps
- [Assign compliance policies](../intune/protect/compliance-policy-create-android.md)
- [Managing apps](../intune/apps/app-management.md)
