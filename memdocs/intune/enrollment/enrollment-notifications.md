...
7. In **Notification settings**, configure the notification messages. 
    ...
    * **Show device details**:  Device details are turned off by default. Flip the switch **On** to make the following device details visible in the footer of the email:   
         * Device name  
         * Model  
         * OS  
         * OS version  
        ...
        Intune may not be able to populate all details. Emails with device details can take longer to deliver.    
