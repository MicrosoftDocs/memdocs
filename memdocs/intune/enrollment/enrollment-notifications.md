...
* iOS/iPadOS devices in BYOD scenarios, which includes device enrollment. This does not include user enrollment at this time. 
* macOS devices in BYOD scenarios, which includes device enrollment.    
