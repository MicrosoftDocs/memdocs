...
- Have access to the internet [following the documented Windows Autopilot network requirements](../../autopilot/windows-autopilot-requirements#networking-requirements).
