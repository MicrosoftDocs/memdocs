...
This method is supported on corporate-owned devices running Android 8.0 and later.

You can use this method in conjunction with the Microsoft Intune DPC identifier to set up fully managed devices.

> [!NOTE]
> This method isn't supported on corporate-owned, personally enabled (COPE) devices running Android 11 and later or for device enrollment manager accounts. 
