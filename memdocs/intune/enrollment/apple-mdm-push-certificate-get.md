...
:::image type="content" source="./media/apple-mdm-push-certificate-get/create-mdm-push-certificate.png" alt-text="The Configure MDM Push Certificate screen with MDM Push not set up.":::
