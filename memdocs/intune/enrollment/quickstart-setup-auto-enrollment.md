...
In this quickstart, you learned how to set up auto-enrollment for Windows 10/11 devices. For more information about device enrollment, see [What is device enrollment?](device-enrollment.md)
