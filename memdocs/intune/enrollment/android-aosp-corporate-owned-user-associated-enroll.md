...
6. Enter the basics for your profile:
    ...
    - **For Microsoft Teams devices (preview)**: Select 'Enabled' if this profile is applicable for Microsoft Teams Android devices. This setting is in preview and should only be used for [Microsoft Teams Android devices](/microsoftteams/devices/teams-ip-phones).
