...
Intune marks devices going through the following types of enrollments as corporate-owned, and blocks them from enrolling (unless enrolled with Autopilot) because these methods don't offer the Intune administrator per-device control:  
