...
> To check the capabilities alongside other Windows enrollment methods, see Intune enrollment method capabilities for Windows devices (https://github.com/MicrosoftDocs/memdocs/blob/main/memdocs/intune/enrollment/enrollment-method-capab.md).
