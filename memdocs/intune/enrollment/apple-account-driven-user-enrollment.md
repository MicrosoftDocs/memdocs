...
## Known issues  
This section describes all known issues that you or your device users could experience when using account driven Apple User Enrollment with Microsoft Intune.   
