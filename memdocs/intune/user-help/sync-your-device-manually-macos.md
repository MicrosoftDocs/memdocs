...
title: Manually sync your macOS device | Microsoft Docs
description:
keywords:
author: lenewsad
ms.author: lanewsad
...
2. Select **Devices**.  
3. If you only have one device, you'll go directly to the device details screen and can skip to step 3. If you have multiple devices, you'll see all devices inline at the top of the page. Select the device that you're currently using. 
...
3. Select **More [...]** and then choose **Check Status** to sync your device. 
