...
#### [Update device for Outlook](update-device-outlook-android.md)  
#### [Update device software](you-need-to-update-your-android-device.md)  
...
#### [Disable unknown source installations](you-need-to-turn-off-unknown-sources-android.md)  
#### [Turn off USB debugging](you-need-to-turn-off-usb-debugging-android.md)
#### [Turn on security threat scans](you-need-to-turn-on-scanning-for-security-threats-android.md)
#### [Install latest security patch](you-need-to-update-your-device-OS-security-patch-android.md)
#### [Common Samsung Knox messages](samsung-knox-errors-android.md)  
...
### Enrollment      
#### [Enroll your iOS device (standard)](enroll-your-device-in-intune-ios.md)
...
#### [Reset iOS device](effects-of-device-reset-company-portal-ios.md)
#### [Turn off Microsoft usage data collection](turn-off-microsoft-usage-data-collection-ios.md)  


### Get iOS apps  
#### [Get work or school apps (iOS)](use-managed-apps-on-your-device-ios.md)
...
#### [Update iOS version](you-need-to-update-your-ios-device.md)  
...
#### [Enroll your macOS device (standard)](enroll-your-device-in-intune-macos-cp.md)
...
#### [Help for JAMF-managed devices in Intune](device-little-different-jamf.md)  

### Get help  
#### [Report Company Portal problems](send-errors-macos.md)  

## Windows device management 
### Enrollment  
#### [What to expect after enrollment](what-happens-if-you-install-the-company-portal-app-and-enroll-your-device-in-intune-windows.md)  
#### [Identify Windows version for enrollment](using-your-windows-device-with-intune.md)  
...
#### [Check for software updates](you-need-to-update-your-windows-device.md)  
#### [Enable Windows encryption](you-need-to-enable-windows-encryption.md)
#### [Enable antimalware software](your-device-needs-antimalware-software.md)  
...
#### [Help and support page](help-support-windows-cpapp.md)  

### Get help  
#### [Report problems in Company Portal](send-logs-to-your-it-admin-cp-windows.md)
#### [Export Company Portal diagnostic logs](send-logs-to-your-it-admin-settings-windows.md)  
#### [Troubleshoot enrollment problems](troubleshoot-your-windows-10-device-windows.md) 
