...
You'll receive a message from Company Portal if your device password doesn't meet your organization's security requirements. Device password requirements are put in place to protect you and your org's data from unauthorized access. Until you create a more secure device password, you may be blocked from accessing your org's network.  

Company Portal sends one message per password requirement, so you may receive more than one message at a time. It is worth mentioning that a device password can also be known as a PIN or passcode, and this may vary based on the implementation utilized across various components of the supported devices. This article lists all of the password-related messages you could receive, by OS platform.     
