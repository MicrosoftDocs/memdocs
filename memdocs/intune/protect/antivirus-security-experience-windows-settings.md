...
View the Antivirus policy settings you can configure for the **Windows Security Experience** profile for Window 10 and Windows 11 devices as part of a Microsoft Intune [Endpoint security policy](../protect/endpoint-security-policy.md).
