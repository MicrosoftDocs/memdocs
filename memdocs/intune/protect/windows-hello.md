...
- [**Endpoint security Account protection policy**](../protect/endpoint-security-account-protection-policy.md): After devices enroll, use Intune Account protection profile, which is part of endpoint security Account protection policy, to manage Windows Hello on devices after they have enrolled with Intune.
