...
> [!TIP]
> *PKCS certificate* profiles are supported for [Windows 10 Enterprise multi-session remote desktops](../intune/fundamentals/windows-virtual-desktop-multi-session.md).
