...
| VPP | Managed AppleId UPN | AppleID that was specified by Admin when configuring the Apple Business Manager location token (VPP token) connection with Apple. |
