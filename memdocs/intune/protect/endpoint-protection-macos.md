...
- **Do not allow user to override Gatekeeper**
  ...
  Prevents users from overriding the Gatekeeper setting, and prevents users from Control-clicking to install an app. When enabled, users cannot Control-click any app, or install it.
