...
Before using these reports, you must attest to having the required licenses on the [Windows data page](../protect/data-enable-windows-data#windows-license-verification) of the Intune admin center.
...
Additionally, you must set the [Enable features that require Windows diagnostic data in processor configuration](../protect/data-enable-windows-data#windows-data) setting in **Tenant administration** > **Connectors and tokens** > **Windows data** to On.
