...
> [!NOTE]
> Windows 11, version 24H2 and above cannot apply *KB 4023057*, this is applicable only to Windows 11, version 23H2 and below. Upgrading to 24H2 will remove KB 4023057, so checkiong for KB installation is not reliable anymore.
