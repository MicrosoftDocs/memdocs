...
If you use Configuration Manager current branch version 2002, install an update that adds support for the endpoint security policies you deploy from the Microsoft Endpoint Manager admin center.
