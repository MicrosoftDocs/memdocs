...
> [NOTE]
> The following procedure only works and is supported for managed Windows 11 devices. For Windows 10 devices, we recommend moving the Windows Update workload to Intune or configuring the workload to Pilot and configuring a pilot collection containing the in scope Windows 10 managed devices.
