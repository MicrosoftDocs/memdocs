...
| Microsoft Edge browser support:| - *Strict Tunnel Mode*: When the VPN isn't connected, it blocks traffic to and from your apps. </br></br> - *Identity switch*: VPN connects when using a work or school account and disconnects when switching to a personal account or in-Private browsing </br></br> - Device-wide and Per-App VPN support  | - *Strict Tunnel Mode*: When the VPN isn't connected, it blocks traffic to and from your apps. </br></br> - *Identity switch*: VPN connects when using a work/school account and disconnects when switching to a personal account or in-Private browsing   |
