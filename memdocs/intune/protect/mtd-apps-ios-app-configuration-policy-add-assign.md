...
> [!NOTE]
> For initial testing, use a test group when assigning users and devices in the Assignments section of the configuration policy. A single iOS configuration policy may be used accross all devices that are to be provisioned with Wandera.  
...
3. In **Settings,** define **Configuration settings format > Enter XML data** and follow the below steps:
4. Paste the XML in the app configuration text box in Microsoft Endpoint Manager.
