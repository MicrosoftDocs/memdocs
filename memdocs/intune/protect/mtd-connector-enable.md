...
> [!NOTE]
> On devices marked as 'corporate', all apps will be shared with the Mobile Threat Defense vendor, while on devices marked as 'personal', only Intune managed apps will be shared.
