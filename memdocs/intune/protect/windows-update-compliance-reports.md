   ...
   - **Service-side data**:
     ...
     - **Canceled**:
       ...
       - **Service Cancelled** – The update was cancelled by Windows Update for one of the following reasons:  
           - The *end of service* for the content was reached and it’s no longer offered by Windows Update. For example, the device might have been added to a deployment after the content’s availability expired, or the content reached its end of service date before it could install on the device.
