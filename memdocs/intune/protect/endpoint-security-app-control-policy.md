...
1. Use Autopilot with Entra join instead. See our recommendation for [which Entra join option](/solutions/cloud-native-endpoints/azure-ad-joined-hybrid-azure-ad-joined#which-option-is-right-for-your-organization) to choose for more information.
