...
3. Set the following options:
   ...
   ![Select the FileVault profile](./media/encrypt-devices/select-windows-bitlocker-es.png)
...
3. Set the following options:
   ...
   ![Select the FileVault profile](./media/encrypt-devices/select-windows-bitlocker-dc.png)
