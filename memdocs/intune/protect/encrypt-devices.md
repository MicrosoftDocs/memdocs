...
- To support the display of recovery keys for tenant attached devices, your Configuration Manager sites must run version 2107 or later. For sites that run 2107, you must install an update rollup to support Azure AD joined devices:. See [KB11121541](https://docs.microsoft.com/mem/configmgr/hotfix/2107/11121541).
