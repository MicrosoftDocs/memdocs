...
Devices that run Android Enterprise Dedicated might require a PIN before SCEP can provision them with a certificate. For more information, see [PIN requirement on Android Enterprise Dedicated](../protect/certificates-scep-configure.md#pin-requirement-on-android-enterprise-dedicated),
