...
- [Remote help](../protect/remote-help.md) is in public preview for Microsoft Endpoint Manager. When installed on a users device, your organizations users can provide remote assistance to other users within the same tenant, including between devices that are and arne't enrolled with Intune. 
