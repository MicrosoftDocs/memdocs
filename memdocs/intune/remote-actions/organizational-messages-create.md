...
On the **Schedule** page, schedule the delivery of your message. If you schedule multiple messages to arrive within the same time period on the same device, the messages will arrive in random order.   
