...
5. Proceed to the Assignments page, and then select an applicable device group or device groups that should install the Remote Help app. Remote Help works when targeting group(s) of devices and is not applicable to User groups. 
