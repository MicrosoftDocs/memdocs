...
- [Microsoft Endpoint Manager tenant attach](https://docs.microsoft.com/en-us/mem/configmgr/tenant-attach/device-sync-actions) enabled with an Azure tenant location of North America (we will be expanding to other regions soon)
