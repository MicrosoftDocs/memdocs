...
- For [**Proactive remediation scripting**](#bkmk_uea_prs), devices must meet one of the following conditions:
   ...
   - A [co-managed](../../comanage/overview.md) device running Windows 10 Enterprise, version 1903 or later.
   - A [co-managed](../../comanage/overview.md) device running Windows 10 Enterprise, version 1809 or earlier with the [Client apps workload](../../comanage/workloads.md#client-apps) pointed to Intune.
