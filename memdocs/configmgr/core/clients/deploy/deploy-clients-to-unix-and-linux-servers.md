...
1.  On a Windows computer, [download the appropriate client file for the Linux or UNIX server](https://www.microsoft.com/download/details.aspx?id=47719) you want to manage.  
