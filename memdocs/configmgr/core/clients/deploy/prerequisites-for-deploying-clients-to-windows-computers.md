...
| Microsoft .NET Framework version 3.5 (`dotNetFx35setup.exe`) | _Version 2309 and later_:<!--26987390--> Required to support arm64 softwre update deployment. Install on the computer if it doesn't have this version installed. For more information, see [More details about Microsoft .NET](#more-details-about-microsoft-net). |
