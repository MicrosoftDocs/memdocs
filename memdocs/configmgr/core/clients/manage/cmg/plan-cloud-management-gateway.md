...
Starting in version 2006, intranet clients can access a CMG software update point when it's assigned to the boundary group. For more information, see [Configure boundary groups](../../../servers/deploy/configure/boundary-groups.md#bkmk_cmg-sup). <!--7102873-->
