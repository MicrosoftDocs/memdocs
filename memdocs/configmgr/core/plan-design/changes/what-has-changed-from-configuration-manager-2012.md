...
> [!NOTE]
> Since October 2019, Configuration Manager is part of Microsoft Endpoint Manager. For more information, see [Microsoft Configuration Manager FAQ](../../understand/microsoft-endpoint-manager-faq.yml).
