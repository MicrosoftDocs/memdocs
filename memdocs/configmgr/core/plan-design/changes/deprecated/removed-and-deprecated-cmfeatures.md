...
| The [collection evaluation viewer](../../../support/ceviewer.md)<!-- 8509484 -->, which was integrated in version 2010. The standalone tool is still available with the System Center 2012 R2 Configuration Manager Toolkit.| November 2020 | Version 2103 |
...
|Security Content Automation Protocol (SCAP) extensions. <!--3607889--><br>The previous certified version is still available on the Microsoft Download Center.|September 2018|Version 1810|
