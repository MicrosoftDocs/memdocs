...
| Site system roles that allow HTTP client connections.<!-- 9390933 --> Enable these roles for a more secure communication method with [HTTPS](../../../clients/deploy/plan/security-and-privacy-for-clients.md#BKMK_Security_Clients) or [Enhanced HTTP](../../hierarchy/enhanced-http.md). | March 2021 | The first release after November 1, 2022 |
...
|The previous version of Software Center.<br><br>For more information about the new Software Center, see [Plan for and configure application management](../../../../apps/plan-design/plan-for-software-center).|December 13, 2016|Version 1802|
