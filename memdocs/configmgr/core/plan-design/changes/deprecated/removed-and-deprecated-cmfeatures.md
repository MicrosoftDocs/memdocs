...
| Cloud management gateway (CMG) as a **cloud service (classic)**. All CMG deployments should use a [virtual machine scale set](../../../clients/manage/cmg/plan-cloud-management-gateway.md#virtual-machine-scale-sets). | [February 2024](https://learn.microsoft.com/en-us/mem/configmgr/core/get-started/2024/technical-preview-2401#bkmk_CMgclassic) | Version 2403 |
