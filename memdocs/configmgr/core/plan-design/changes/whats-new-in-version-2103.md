...
- The following compliance settings for **Company resource access**: <!-- 9315387 -->
  ...
  This deprecation includes the [co-management resource access workload](../../../comanage/workloads.md#resource-access-policies). Use Microsoft Intune to [deploy resource access profiles](../../../../memdocs/intune/configuration/device-profiles.md).
