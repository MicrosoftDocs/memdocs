...
1. On the Settings page, note the new _Deployment name_ with the suffix for the VM scale set.

1. Make other configuration changes as needed. Then select **Next** and complete the wizard.

<!-- what happens next? how to monitor? -->

<!-- what about currently documented VMSS limitations? -->
...
- For the _deployment name_,
  ...
  - VM scale set: `GraniteFalls.EastUS.CloudApp.Azure.Com`
