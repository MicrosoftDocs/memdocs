...
<!--3961933, 4396422-->
If you create an ADR with the **No deployment package** option, you are unable to go back and add one later. To help you resolve this, we have uploaded the following script into [Community hub](../../../../servers/manage/community-hub.md):

   > [!TIP]
   > [Open this script](https://communityhub.microsoft.com/item/8268) directly in Community hub. For more information, see [Direct links to Community hub items](../../../../servers/manage/community-hub.md).
