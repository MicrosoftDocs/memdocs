...
- In this release, to create the objects in Configuration Manager, you need to use the PowerShell script **SetupExternalServiceNotifications.ps1**. [Download the script from GitHub](https://aka.ms/cmextnotificationscript).
### Try it out!
