...
- In this release, to create the objects in Configuration Manager, you need to use the PowerShell script **SetupExternalServiceNotifications.ps1**. Download this script from the [Community hub](../../../../servers/manage/community-hub.md).

   > [!TIP]
   > [Open this script](https://aka.ms/cmextnotificationscript) directly in Community hub. For more information, see [Direct links to Community hub items](../../../../servers/manage/community-hub.md).
