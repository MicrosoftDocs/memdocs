...
<!--9957939-->
Pre and post-scripts for [Orchestration groups](../../../../../sum/deploy-use/orchestration-groups.md) now require approval to take effect. If you open, author, or modify a script, approval for the script is required from another admin. When selecting an approved script from the [**Scripts** library](../../../../../apps/deploy-use/create-deploy-scripts.md), no additional approval is needed. To assist you with script approval, the following two tabs were added to the details pane for **Orchestration Groups**:
