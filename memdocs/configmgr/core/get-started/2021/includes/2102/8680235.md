...
<!--8680235-->
Before previewing a [query for collection membership](../../../../clients/manage/collections/create-collections.md#bkmk-query), you now have the option to configure the number of rows to be returned and whether duplicates should be omitted. Additionally, statistics for the query preview such as number of rows returned and elapsed time are shown.

When using the [collection query preview](/2020/technical-preview-2008#collection-query-preview), you now have additional options. The following improvements have been made to previewing collection queries:
