...
<!--8680235-->
When using the [collection query preview](../../../2020/technical-preview-2008.md#collection-query-preview), you now have more options. The following improvements have been made to previewing collection queries:
