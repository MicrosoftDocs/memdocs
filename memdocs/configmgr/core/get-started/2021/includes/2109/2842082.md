...
## <a name="bkmk_isvproxy"></a> Copy thumbprint for ISV proxy certificate
...
To simplify the management of these ISV proxy certificates, you can now copy its thumbprint in the Configuration Manager console.
...
This action copies the certificate's thumbprint, for example: `FDE21EC692A0BD755E931EE4E9C10B80C65B493B`
