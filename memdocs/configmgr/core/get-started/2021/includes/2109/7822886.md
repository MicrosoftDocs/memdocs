...
:::image type="content" source="../../media/7822886-vpn-boundary-startswith.png" alt-text="Create Boundary window showing options for Connection Name and Starts With.":::
