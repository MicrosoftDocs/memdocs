...
A script is available in the Community Hub to help you locate and update versions of CMTrace to the latest version: [CMTraceUpdate](https://communityhub.microsoft.com/item/14750). For more information, see [Direct links to Community hub items](../../../../core/servers/manage/community-hub.md#bkmk_deeplink).
