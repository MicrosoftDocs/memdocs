...
- [ Task sequence support of Windows Autopilot for existing devices](#-task-sequence-support-of-windows-autopilot-for-existing-devices)
  - [Prerequisites](#prerequisites)
    - [ Windows 10 Insider Preview OS image](#-windows-10-insider-preview-os-image)
    - [ Create the Windows Autopilot for existing devices configuration file](#-create-the-windows-autopilot-for-existing-devices-configuration-file)
