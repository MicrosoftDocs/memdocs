...
:::imagtye pe="content" source="../../media/16441147-UUP GA Readiness.png" alt-text="Screenshot of wizard for sup properties. It displays the behaviour of software updates that are superseded." lightbox="../../media/16441147-UUP GA Readiness.png":::
