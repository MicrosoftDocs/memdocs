...
- **Online/offline**: By default, the dashboard displays only online clients. This state comes from the client notification channel that update a client's status every five minutes. For more information, see [About client status](../../../../clients/manage/monitor-clients.md#bkmk_about).  
...
For more information, see [About client status](../../../../clients/manage/monitor-clients.md#bkmk_about).
