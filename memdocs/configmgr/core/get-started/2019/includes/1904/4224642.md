...
<!--4224642-->
Task sequence pre-cache now includes additional content types. [Pre-cache content](../../../../../osd/deploy-use/create-a-task-sequence-to-upgrade-an-operating-system.md#configure-pre-cache-content) previously only applied to OS upgrade packages. Now you can use pre-caching to reduce bandwidth consumption of OS images and driver packages.
...
3. Create a task sequence with the following steps:  
    ...
    > [!Tip]  
    > For an example of conditional steps with the Upgrade OS step, see [Configure the pre-cache feature](../../../../../osd/deploy-use/create-a-task-sequence-to-upgrade-an-operating-system.md#configure-pre-cache-content).  
...
For more information on pre-caching behavior and functionality, see [Configure pre-cache content](../../../../../osd/deploy-use/create-a-task-sequence-to-upgrade-an-operating-system.md#configure-pre-cache-content).
