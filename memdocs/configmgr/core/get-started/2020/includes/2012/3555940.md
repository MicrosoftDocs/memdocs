...
When a build's revision number is three digits long, you may notice an extraneous dot before the build number in the **Quality Update Versions** chart. <!--8861592-->
