...
- It resolves a bug with boot image metadata on PXE-enabled distribution points that have multiple content library drives.<!--7068388--> This bug would cause the client to fail to download the boot image over TFTP.
