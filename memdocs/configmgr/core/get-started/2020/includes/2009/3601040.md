...
If you have an existing CMG deployment using Azure Resource Manager, you don't have to [redeploy the service](https://docs.microsoft.com/mem/configmgr/core/clients/manage/cmg/setup-cloud-management-gateway#redeploy-the-service). This deployment method is primarily for CSP customers to use CMG. If you do redeploy the service, since the service name changes, you may need a new CMG server authentication certificate.
