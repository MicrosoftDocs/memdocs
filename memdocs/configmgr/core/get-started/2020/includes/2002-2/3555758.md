...
1. In the **Configure upload** tab, select **Upload to Microsoft Intune admin center**. Click **Apply**.
...
1. Ensure the **Upload to Microsoft Intune admin center** option is selected on the **Tenant onboarding** page.
