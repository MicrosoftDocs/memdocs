...
We've added an additional event to the device timeline in the admin center. You can now see **Event ID 2027** for **VPN failure** from the **RAS client**. To collect this event, make sure you have the latest Configuration Manager client installed. For more information about the device timeline, see [Configuration Manager technical preview 2005](../../technical-preview-2005.md#bkmk_timeline).  
