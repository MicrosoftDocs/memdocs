...
1. Use the same account to sign in to the admin center preview portal. The same **user principal name** should display in the upper right banner of the web portal.
