...
1. Click on **Timeline**. By default, we show events from the the last 24 hours. Use the **Filter** button to change the **Time range**, **Event levels**, and **Provider name**.  
