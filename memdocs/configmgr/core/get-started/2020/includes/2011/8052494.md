...
Full Administrators can opt in the hierarchy for uncurated content via hierarchy settings. Lower hierarchy administrators can't opt in the hierarchy for uncurated hub items.
