...
1. Add any or all of the following columns prefixed by the type of evaluation:
   - **Evaluation (Full)**
      ...
      - **Member Changes**: The member changes in the last collection evaluation. Positive numbers mean members were added while negative numbers means members were removed.
...
#### Monitoring collection evaluation

1. From the **Monitoring** workspace, go to the **Collection Evaluation** node.
1. 