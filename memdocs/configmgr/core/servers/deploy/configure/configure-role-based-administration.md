...
- [Remove-CMSecurityScopeFromAdministrativeUser](/powershell/module/configurationmanager/remove-cmsecurityscopefromadministrativeuser?view=sccm-ps): Remove the association between a security scope and an administrative user.
