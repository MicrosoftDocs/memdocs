...
- You run the tool from the service connection point and a computer that can connect to the internet. Each of these computers needs to have a x64-bit OS, and have the following components:
  ...
  - Starting in version 2309, this tool rquires the installation of the x64 version of the ODBC driver for SQL Server. To download this component see, [Download ODBC Driver for SQL Server](sql/connect/odbc/download-odbc-driver-for-sql-server).
