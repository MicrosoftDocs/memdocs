...
> [!IMPORTANT]
> In a multi-site hierarchy, enable optional or pre-release features only from the CAS. This behavior ensures there are no conflicts across the hierarchy. <!--507197-->  
