...
> ```
>
> For more information, see [Modify the task sequence to account for Sysprep command line configuration](/tutorial/existing-devices/create-autopilot-task-sequence.md#modify-the-task-sequence-to-account-for-sysprep-command-line-configuration) and [Windows Autopilot for existing devices doesn't work](/autopilot/known-issues#windows-autopilot-for-existing-devices-doesnt-work).
