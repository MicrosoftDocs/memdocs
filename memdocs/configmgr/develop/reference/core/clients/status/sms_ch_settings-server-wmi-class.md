...
description: Learn how the SMS_CH_Settings Windows Management Instrumentation (WMI) class is an SMS Provider server class that represents client status settings.  
