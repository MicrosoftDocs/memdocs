...
description: The SMS_G_System_LastSoftwareScan WMI class is an SMS Provider server class, in Configuration Manager, that represents information about the most recent software inventory scan on the client computer.
ms.date: "09/20/2016"
