---
description: Article outlining the use of AddAttributeToSMSStatusMessage function in Configuration Manager to add a single optional status message attribute ID/value pair to a status message object.
