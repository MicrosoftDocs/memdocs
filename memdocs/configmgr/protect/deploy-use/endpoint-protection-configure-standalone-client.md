...
In your organization, you may have a few standalone computers that are not joined to a domain, or connected to your corporate network, and hence cannot be managed by an SCCM client. Typically, these computers are used for a very specific purpose, for example as a lab PC to test software. You still need to protect such computers from potential malware attacks. 
