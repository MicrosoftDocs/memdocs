...
2. You connect Configuration Manager and enroll devices  
    ...
    2. Within 15 minutes, and every hour after, Configuration Manager synchronizes the following data with Desktop Analytics using your tenant ID. All data is sent over an SSL (HTTPS) encrypted channel. 
