...
- Configuration Manager, version 1902 with update rollup (4500571) or later. For more information, see [Update Configuration Manager](connect-configmgr.md#bkmk_hotfix).  
    ...
    > - Configure both hierarchies to use the same Commercial ID to share the Azure AD tenant and Desktop Analytics instance. Use [different apps](mem/configmgr/desktop-analytics/connect-configmgr#bkmk_connect) for connecting each hierarchy. It may take up to 30 after you disconnect a hiearchy for the portal to reflect changes. 
