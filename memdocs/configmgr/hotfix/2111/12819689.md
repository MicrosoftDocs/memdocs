...
1. If installation was failing previously because of the issue noted in KB 5001600, confirm status message **9522** is generated for the `SMS_DISTRIBUTION_MANAGER` component. The 9522 message indicates that installation is no longer being retried.
