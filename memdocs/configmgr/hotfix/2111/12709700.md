...
- The following issue described in the 2111 release notes is resolved.
   ...
   [Unable to open console because extension installation loops](../../core/servers/deploy/install/release-notes#unable-to-open-console-because-extension-installation-loops)
