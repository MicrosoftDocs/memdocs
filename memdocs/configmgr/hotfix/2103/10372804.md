...
> [!IMPORTANT]
> This update prevents creation of excessive policies, allowing the use of `Invoke-MbamClientDeployment.ps1` or similar scripts again, but it does not remove any such policies that were previously created. If the above query returns a large amount of rows, contact Microsoft Support for assistance in removal of these policies.
