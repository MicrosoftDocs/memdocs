...
An update is available that contains fixes for an upcoming feature to enable Device-level reporting for Endpoint security policies deployed to Configuration Manager clients.
