...
Errors resembling the following are recorded in the pkgxfermgr.log file.
   ...
   ```
<!-- 26357341 -->
- The upgrade experience indicators on the Windows 11 Readiness dashboard incorrectly list Windows 10 versions as "22H2" when they're a different version.
...
This update is available in the Updates and Servicing node of the Configuration Manager console for environments that were installed by using early update ring or globally available builds of version 2309.
...
- **50F562FD-9B2D-4737-8D17-BCA41BE50F73**
- **4207A0C1-31E5-4CEF-8C79-3162DC9ADB87**
...
## Release history
- February 12, 2024: Initial hotfix release
