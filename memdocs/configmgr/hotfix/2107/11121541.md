...
<!-- 11892479 -->
- After upgrading to version 2107, one or more applications in a task sequence fail with an error resembling the following in `smsts.log`.
...
<!-- 10789925 -->
- The Cloud Management Gateway Azure Storage Account can now be configured to use TLS 1.2 through the Configuration Manager console. Refer to [Enforce TLS 1.2](../../core/clients/manage/cmg/security-and-privacy-for-cloud-management-gateway.md#enforce-tls-12) for more information.
