...
- 
- The **Log Analytics connector for Azure Monitor** feature was removed from Configuration Manager version 2107. However, the pages that allow an administrator to view and delete the **OMS Connector** are still present but do not function. See the [Deprecated features](../../core/plan-design/changes/deprecated/removed-and-deprecated-cmfeatures.md#unsupported-and-removed-features) documentation for more information.
