...
Customers that downloaded and installed the update rollup prior to August 1, 2023 will see it offered again in the *Updates and Servicing* node of the console. The revised update should be reinstalled, but will only affect site servers; there is no additional client change. 
