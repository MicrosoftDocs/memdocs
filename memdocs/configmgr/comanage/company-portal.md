...
- Windows 10 version 1803 or later:
  ...
  - Access to [internet endpoints for Intune](../../memdocs/intune/fundamentals/intune-endpoints.md)
...
- To require the app on co-managed devices, the deployment process depends upon the state of the [Client apps](workloads.md#client-apps) co-management workload:
  ...
  - If the client apps workload is with Intune, you can deploy it via Configuration Manager or [add the Company Portal app by using Microsoft Intune](../../memdocs/intune/apps/store-apps-company-portal-app.md).

For more information on branding the Company Portal for your organization, see [How to customize the Intune Company Portal app](../../memdocs/intune/apps/company-portal-app.md).
...
[How to customize the Intune Company Portal app](../../memdocs/intune/apps/company-portal-app.md)
