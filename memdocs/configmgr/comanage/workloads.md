...
For more information on the Intune feature, see [Use compliance policies to set rules for devices you manage with Intune](../../memdocs/intune/protect/device-compliance-get-started.md).
...
For more information on the Intune feature, see [Manage Windows software updates in Intune](../../memdocs/intune/protect/windows-update-for-business-configure.md).
...
For more information on the Intune feature, see [Deploy resource access profiles](../../memdocs/intune/configuration/device-profiles.md).
...
For more information on the Intune feature, see [Windows 10 (and later) settings to protect devices using Intune](../../memdocs/intune/protect/endpoint-protection-windows-10.md).
...
For more information on the Intune feature, see [Create a device profile in Microsoft Intune](../../memdocs/intune/configuration/device-profile-create.md).
...
- [Use Update Channel and Target Version settings to update Microsoft 365 with Microsoft Intune Administrative Templates](../../memdocs/intune/configuration/administrative-templates-update-office.md)
- [Manage Microsoft 365 Apps with Configuration Manager](../sum/deploy-use/manage-office-365-proplus-updates.md).

> [!NOTE]
> To use Windows Autopatch with these devices, this workload needs to be managed by Intune. For more information, see [Prerequisites for Windows Autopatch](/windows/deployment/windows-autopatch/prepare/windows-autopatch-prerequisites).

For more information on the Intune feature, see [Add Microsoft 365 apps to Windows devices with Microsoft Intune](../../memdocs/intune/apps/apps-add-office365.md).
...
For more information on the Intune feature, see [What is Microsoft Intune app management?](../../memdocs/intune/apps/app-management.md)
