...
- [Use compliance policies to set rules for devices you manage with Intune](../../memdocs/intune/protect/device-compliance-get-started.md)

- [App-based Conditional Access with Intune](../../memdocs/intune/protect/app-based-conditional-access-intune.md)
