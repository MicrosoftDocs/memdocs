...
- At least one Intune license for you as the administrator to access the Intune portal.
    ...
    >
    > You may not need to purchase and assign individual Intune or EMS licenses to your users. For more information, see the [Product and licensing FAQ](../core/understand/product-and-licensing-faq.yml#bkmk_mem).
