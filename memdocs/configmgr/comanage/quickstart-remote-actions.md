...
For more information on how to use these remote actions, see [Available device actions](../../memdocs/intune/remote-actions/device-management.md#available-device-actions).
...
For more information, see [Remove devices by using wipe, retire, or manually unenrolling the device](../../memdocs/intune/remote-actions/devices-wipe.md).
...
For more information, see [How to wipe only corporate data from Intune-managed apps](../../memdocs/intune/apps/apps-selective-wipe.md).
...
For more information, see [Sync devices to get the latest policies and actions with Intune](../../memdocs/intune/remote-actions/device-sync.md).
...
For more information, see [Remotely restart devices with Intune](../../memdocs/intune/remote-actions/device-restart.md).
...
For more information, see [Use Fresh Start to reset Windows devices with Intune](../../memdocs/intune/remote-actions/device-fresh-start.md).
...
For more information, see [Use TeamViewer to remotely administer Intune devices](../../memdocs/intune/remote-actions/teamviewer-support.md).
...
For more information on using TeamViewer for remote control, see [Use TeamViewer to remotely administer Intune devices](../../memdocs/intune/remote-actions/teamviewer-support.md).
