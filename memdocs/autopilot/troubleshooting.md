...
- Autopilot out-of-box experience (OOBE) behavior: Were the [expected OOBE](#troubleshooting-autopilot-oobe-issues) screens displayed? Is the Azure AD credentials page customized with organization-specific details as expected?
- Azure AD join issues: Was the device able to [join Azure Active Directory](#troubleshooting-azure-ad-join-issues)?
- MDM enrollment issues: Was the device able to [enroll in Microsoft Intune](#troubleshooting-intune-enrollment-issues) (or an equivalent MDM service)?
