---
title: Windows Autopilot for pre-provisioned deployment hybrid Azure AD join - Step 3 of 11 - Increase the computer account limit in the Organizational Unit (OU)
description: How to - Windows Autopilot for pre-provisioned deployment hybrid Azure AD join - Step 3 of 11 - Increase the computer account limit in the Organizational Unit (OU).
...
# Pre-provision hybrid Azure AD join: Increase the computer account limit in the Organizational Unit (OU)
...
1. Expand the desired domain and navigate to the organizational unit (OU) that computers are joining to during Autopilot.
    ...
    > [!NOTE]
    >
    > The OU that computers join during the Autopilot deployment are specified later during the [Configure and assign domain join profile](hybrid-azure-ad-join-domain-join-profile.md) step.
