---
title: Overview for Windows Autopilot user-driven hybrid Azure AD join with pre-provisioning in Intune
description: Overview for Windows Autopilot user-driven hybrid Azure AD join with pre-provisioning in Intune.
