...
3. Once the device boots up, one of two things occurs depending on the state of network connectivity:
   ...
   - If the device isn't connected to a wired network or if it doesn't have network connectivity, it will prompt to connect to a network since connectivity to the Internet is required during the user flow phase of an Azure AD join:
