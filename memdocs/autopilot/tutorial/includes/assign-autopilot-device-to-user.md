...
> [!TIP]
>
> For testing purposes, especially for hybrid Azure AD scenarios, it may be better to first test an Autopilot deployment before assigning the device to a user. This will limit the scope of applications, policies, and configurations processed during the Autopilot process.
