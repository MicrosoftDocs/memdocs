---
title: Windows Autopilot user-driven Azure AD join - Step 1 of 8 - Set up Windows automatic Intune enrollment
description: How to - Windows Autopilot user-driven Azure AD join - Step 1 of 8 - Set up Windows automatic Intune enrollment.
