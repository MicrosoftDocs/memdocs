---
title: Windows Autopilot user-driven hybrid Azure AD join - Step 3 of 9 - Increase the computer account limit in the Organizational Unit (OU)
description: How to - Windows Autopilot user-driven hybrid Azure AD join - Step 3 of 9 - Increase the computer account limit in the Organizational Unit (OU).
