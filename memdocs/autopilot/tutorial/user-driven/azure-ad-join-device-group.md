---
title: Windows Autopilot user-driven Azure AD join - Step 4 of 8 - Create a device group
description: How to - Windows Autopilot user-driven Azure AD join - Step 4 of 8 - Create a device group.
