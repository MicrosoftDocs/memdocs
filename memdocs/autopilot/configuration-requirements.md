...
- Device registration. Devices must be added to Windows Autopilot to support most Windows Autopilot scenarios. For more inofrmation, see [Adding devices to Windows Autopilot](add-devices.md).
