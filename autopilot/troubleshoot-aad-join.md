...
Errors can also happen if the user exceeds the [number of devices](../memdocs/intune/enrollment/device-limit-intune-azure.md) that they're allowed to join. This limit is configured in Azure AD.
