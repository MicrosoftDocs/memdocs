...
> [!NOTE]
>
> If you have already configured and assigned an ESP from another Autopilot scenario and want to keep the same settings for the ESP for the user-driven Microsoft Entra hybrid join scenario, you can skip this step and move on to [Step 7: Create and assign Microsoft Entra hybrid join Autopilot profile](hybrid-azure-ad-join-autopilot-profile.md).
...
<a name='next-step-create-and-assign-user-driven-hybrid-azure-ad-join-autopilot-profile'></a>
