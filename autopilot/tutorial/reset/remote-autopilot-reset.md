...
1. Make sure the Intune admin initiating the remote Windows Autopilot Reset is a member of the Intune Service Administrator role. For more information, see [Add users and grant administrative permission to Intune](../../../memdocs/intune/fundamentals/users-add.md).
...
- [Add users and grant administrative permission to Intune](../../../memdocs/intune/fundamentals/users-add.md)
- [Policy refresh intervals](../../../memdocs/intune/configuration/device-profile-troubleshoot.md#policy-refresh-intervals)
