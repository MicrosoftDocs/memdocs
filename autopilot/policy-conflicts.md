...
| Device restrictions / Cloud and Storage / [Microsoft Account sign-in assistant](../memdocs/intune/configuration/device-restrictions-windows-10.md#cloud-and-storage) | Setting this policy to "disabled" turns off the Microsoft Sign-in Assistant service (wlidsvc). Windows Autopilot requires this service to get the Windows Autopilot profile. |
