...
- [User-driven Microsoft Entra join: Register devices as Autopilot devices](/autopilot/tutorial/user-driven/azure-ad-join-register-device.md).
...
- [Pre-provision Microsoft Entra join: Register devices as Autopilot devices](/autopilot/tutorial/pre-provisioning/azure-ad-join-register-device.md).
- [Pre-provision Microsoft Entra hybrid join: Register devices as Autopilot devices](/autopilot/tutorial/pre-provisioning/hybrid-azure-ad-join-register-device.md).
