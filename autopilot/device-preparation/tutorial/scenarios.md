...
| **Windows Autopilot device preparation automatic mode** | Set up Windows 365 Frontline in shared mode, Windows 365 Enterprise, Windows 365 Frontline in dedicated mode, and Windows 365 Cloud Apps. | Device preparation policy is configured in the Cloud PC provisioning policy and deployment runs automatically after Cloud PCs are created. |
