...
# Windows Autopilot device preparation in automatic mode for Windows 365 Frontline in shared mode: Assign applications and PowerShell scripts to device group
