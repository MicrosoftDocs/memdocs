...
3. Select your preferred option for the following settings:
    - **Single sign-on**: Select this option to enable a single sign-on experience for users when accessing their Cloud PC. It's recommended to review the information to [configure single sign-on](configure-single-sign-on.md) before enabling this option.
