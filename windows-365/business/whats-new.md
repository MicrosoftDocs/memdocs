...
- **Device level actions**: Use the following actions on any Cloud PC in your organization: Change account type, Restart, Reset, Rename, and Troubleshoot. For more information, see [Remotely manage Windows 365 Business Cloud PCs](remotely-manage-business-clou-pcs.md)
- **Other management actions**: Create and delete users, reset passwords, and manage licenses for Windows 365 Cloud PCs and Microsoft 365 products. For more information, see [Add user and assign license](add-user-assign-licenses.md), [Assign or unassign licenses](assign-unassign-licens.md), and [Reset a user's password](reset-user-password.md). 
