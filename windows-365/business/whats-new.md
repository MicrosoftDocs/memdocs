...
Windows 365 Business Cloud PCs are now created with Windows 11 installed by default. For information about how to change the default operating system between Windows 10 and Windows 11, see [](). On [windows365.microsoft.com](https://windows365.microsoft.com), users can see the difference between their Windows 10 and 11 Cloud PCs.
