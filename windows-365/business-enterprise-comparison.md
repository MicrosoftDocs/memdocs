...
| Capability | Windows 365 Business | Windows 365 Enterprise |
| --- | --- | --- |
| Management | Users can [restart, reset, rename, and troubleshoot](get-users-started.md#user-actions) their Cloud PCs on the Windows 365 homepage. | Users can [restart, rename, and troubleshoot](./enterprise/end-user-access-cloud-pc.md) their Cloud PCs on the Windows 365 homepage. |
