...
Users can now turn on Location redirection so that their Cloud PCs use their correct geographic location. For more information, see [Location redirection](enterprise/end-user-access-cloud-pc.md#location-redirection).
