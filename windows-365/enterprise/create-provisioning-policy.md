...
1. Select **Next**.
1.	On the **Configuration** page, choose a desired language pack in the drop down. The selected language pack will be installed on Cloud PCs provisioned with this policy. Select **Next**.
