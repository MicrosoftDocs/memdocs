...
4. Select **Resize**.
    - When triggering a resize, the user will be inmediately disconnected from their current session. Make sure the user saves all their work to avoid any data lost. 
