...
> - Custom device images are uploaded to the Windows 365 [Azure Compute Gallery](https://learn.microsoft.com/en-us/azure/virtual-machines/azure-compute-gallery) which supports over 20 concurrent deployments
