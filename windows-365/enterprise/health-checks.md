...
- **Azure AD device sync (warning)**: Microsoft Entra ID sync is enabled on the Microsoft Entra tenant, and the computer object is being synced within 90 minutes.
