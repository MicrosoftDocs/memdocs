...
>>>>>>> 140c797fe5aaddc5d70134e82c8ef2b74aa0557f
keywords:
author: ErikjeMS  
ms.author: erikje
manager: dougeby
...
<<<<<<< HEAD
There are many ways to configure networking within Azure. Here, we use a single VNet with Azure Firewall managing outbound access and an ExpressRoute circuit back to the on-premises environment. The diagram shows the network connection flow between:

- the Contoso Corporate Network on-premises environment
...
<<<<<<< HEAD
2. All other traffic from the Windows 365 subnet is sent to the Azure firewall private IP  through a User Defined Route (UDR) route of 0.0.0.0/0.
=======
...
<<<<<<< HEAD
| UDP connectivity via TURN | IP | 20.202.0.0/16 | TCP | 443 | Not recommended | Required |
=======
