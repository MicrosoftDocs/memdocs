...
2. On the **Basics** page, select the following options:
    ...
    3. **Specify date and time**: Choose a date and time. This is the time that you’d like to restore the Cloud PCs to. The following options will help determine exactly which restore point that will be used.
