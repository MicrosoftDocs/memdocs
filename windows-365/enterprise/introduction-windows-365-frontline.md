...
- The concurrency buffer is used five or more times within a 24 hour period.

### Permanent blocks

If the tenant is temporarily blocked more than three times, the tenant is permanently blocked from using the concurrency buffer.
