...
In a future release, for most currently supported regions, Windows 365 8vCPU/32GB licenses will support nested virtualizations for different developer scenarios to use sy7stems like WSL/Hyper-V. Southeast Asia and West US 2 will follow at a later date.
