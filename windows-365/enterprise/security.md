...
- **vTPM**: Short for virtual Trusted Platform Module, a vTPM provides Cloud PCs their own dedicate TPM instance that acts as a secure vault for cryptographic keys and to confirm that the operating system and firmware on your device are what they're supposed to be, and haven't been tampered with. For more information, see [vTPM](/azure/virtual-machines/trusted-launch#vtpm).
