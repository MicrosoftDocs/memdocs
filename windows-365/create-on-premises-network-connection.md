...
6. On the **AD domain** page, provide the following information:
    ...
    - **Organizational unit**: This is optional. An organizational unit (OU) is a container within an Active Directory domain, which can hold users, groups, and computers. **Ensure the OU defined here is enabled to sync with Azure AD Connect. Provisioning will fail if this OU is not syncing.**
