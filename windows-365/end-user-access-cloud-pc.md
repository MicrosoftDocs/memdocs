...
2. Select **Subscribe**. (If using macOS, iOS, iPadOS, or Android/Chrome OS, select **Add Workspace** and then enter the URL `https://rdweb.wvd.azure.us/api/arm/feeddiscovery`).
