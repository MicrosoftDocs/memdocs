...
Conditional Access policies are not set for your y default. You can target CA policies to the Cloud PC first-party app by using either of the following:
