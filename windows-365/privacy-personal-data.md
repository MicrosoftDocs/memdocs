...
- [Microsoft Windows 10 Enterprise](https://docs.microsoft.com/en-us/windows/resources/) - for managing the device setup experience, managing connections to other services, and operational support for IT pros.
...
- [Microsoft Azure Active Directory (Azure AD)](https://docs.microsoft.com/en-us/azure/active-directory/) - for authentication and identification of all user accounts.
