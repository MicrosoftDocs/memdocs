...
If your organization utilizes ADFS, this registration process is optimized and may result in Cloud PC provisioning completing faster than an AAD Connect sync might.
