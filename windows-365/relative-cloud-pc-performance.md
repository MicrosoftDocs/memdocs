...
- The [Cloud PC size recommendations (Enterpise)](cloud-pc-size-recommendations.md) and [Windows 365 Business sizing options](../business/windows-365-business-sizing.md) articles suggest workloads for various sizes.
...
- For Windows 365 Enterprise, see [Cloud PC size recommendations](cloud-pc-size-recommendations.md).
