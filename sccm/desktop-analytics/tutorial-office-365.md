...
A tutorial on using Desktop Analytics and Configuration Manager to deploy Office 365 to a pilot group.
...
1. Onboard to service in Azure **get-started**
2. SCCM connection **new content**
3. Create deployment plan in Azure **deployment-plans**
4. Deploy in SCCM **new content**
Monitor?

If you don’t have a Desktop Analytics subscription, create a free trial account...
...
> [Next steps button](deployment-plans.md)
