...
## Top task
> Suggested:  
> An effective way to structure you overview article is to create an H2 for the top customer tasks and describe how the product/service helps customers with that task.  
...
- [Deploy Office 365 to a pilot](tutorial-office-365.md)
