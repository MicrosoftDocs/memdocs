...
| `https://nexusrules.officeapps.live.com` | For future functionality <!-- Used to request dynamic diagnostic data events from Office clients. This data is useful for drill-down and diagnostics purposes in the Desktop Analytics portal --> |
