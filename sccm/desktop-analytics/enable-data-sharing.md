...
| `https://fef.bmsub01.manage-beta.microsoft.com` | Used to synch device collection memberships, deployment plans and device readiness status with Desktop Analytics (on Configuration Manager Server role only). |
