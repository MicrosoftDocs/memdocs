...
You need a cloud management gateway connector point if you are setting up a [cloud management gateway](../../../../core/clients/manage/setup-cloud-management-gateway) to [manage clients on the Internet](../manage/manage-clients-internet).
