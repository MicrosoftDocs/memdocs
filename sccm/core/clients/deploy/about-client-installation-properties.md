...
For more information about the fallback status point, see [Determine if you need a fallback status point](./plan/determine-the-site-system-roles-for-clients.md#fallback-status-point).  
