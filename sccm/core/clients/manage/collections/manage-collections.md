---
title: "How to manage collections in System Center Configuration Manager"
ms.custom: na
ms.date: 2015-12-08
...
|**Clear Required PXE Deployments**|Clears any required PXE boot deployments from all members of the selected collection.|[Manage enterprise operating systems](assetId:///c6b0ff4c-235a-4e4c-99c0-d14d202de478)|  
...
|**Power Management**|Lets you configure power management plans that are assigned to computers in the selected collection. For more information, see [Power management technical reference for System Center Configuration Manager](../../../../core/clients/manage/power/power-management-technical-reference.md).|  
...
|**Collection Variables**|Lets you configure variables that apply to this collection and can be used by task sequences. For more information, see [Task sequence variables in System Center Configuration Manager](../Topic/Task%20sequence%20variables%20in%20System%20Center%20Configuration%20Manager.md).|  
