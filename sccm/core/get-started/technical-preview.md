...
##  <a name="bkmk_tpCaps"></a> Capabilities delivered in technical previews  
 ...
 |----------------|---------------------|--------------------|
 |Console display on high DPI devices  |[Tech Preview 1705](capabilities-in-technical-preview-1705.md#console-display-on-high-dpi-devices)|![Not added](media/Red_X.gif)|
 |Peer Cache improvements  |[Tech Preview 1705](capabilities-in-technical-preview-1705.md#peer-cache-improvements](media/Red_X.gif)|
