...
##  <a name="bkmk_tpCaps"></a> Capabilities delivered in technical previews  
 ...
 |----------------|---------------------|--------------------|
 |Feature 1 for 1705  |[Tech Preview 1705](capabilities-in-technical-preview-1705.md#configure-android-apps-with-app-configuration-policies)|![Not added](media/Red_X.gif)|
