...
1. Change **Enable Dynamic Update for feature updates** to either **Yes** or **No**. The  default value is **Not Configured**.
    - **Not Configured** - No changes are made to the setupconfig file.
    - **Yes** - Sets the enable value to **True** for Dynamic Update. 
    - **No** - Sets the enable value to **False** for Dynamic Update. 
