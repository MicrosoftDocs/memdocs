...
You can now set a distribution point in maintenance mode. This action temporarily disables communication with the site. While the distribution point is in maintenance mode, the site doesn't distribute any content to it. Also, management points don't return the location of this distribution point to clients. Enable maintenance mode when you're installing software updates, or making hardware changes to the server.
