...
- Your user account needs the **Approve** permission on the **Application** object. For example, the **Application Administrator** and **Application Author** built-in roles have this permission.
...
To see status, in the **Software Library** workspace, expand **Application Management**, and select the **Approval Requests** node.
