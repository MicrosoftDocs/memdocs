...
1. Specify the availability group listener name as the database name. This action causes setup to make sure each node is appropriately configured. It also starts a database recovery process.
