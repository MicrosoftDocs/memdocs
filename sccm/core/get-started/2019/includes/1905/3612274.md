...
When the task sequence runs on the device, either in the full OS or in Windows PE, the Task Sequence Debugger window opens similar to the following screenshot:
