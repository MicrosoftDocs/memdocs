...
1. Right-click on the client device settings to modify and select **Properties**, or create a new set of custom settings.
1. On the **Computer Restart** page, set the following values:
...
1. Observe the restart notification behavior on a client after software enforcement. 
