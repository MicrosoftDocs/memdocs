...
### Known issues
<!--5582516-->
The first time it evaluates, the compliance assessment may report non-compliance. This occurs if the baseline evaluation is still running when the compliance is evaluated. To workaround this issue, click **Check compliance** in the **Software Center**.
...
![Include configured baselines in compliance policy assessment condition](/sccm/core/get-started/2019/media/3608345-create-compliance-policy-rule.png)
...
![Configuration Baseline Properties dialog box](/sccm/core/get-started/2019/media/3608345-configuration-baseline-properties.png)
