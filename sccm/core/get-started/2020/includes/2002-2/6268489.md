...
- **Sites that don't have proper HTTPS configuration**: This rule lists sites in your hierarchy that's not properly configured for HTTPS. This configuration prevents the site from uploading assigned devices to Azure Active Directory (Azure AD). It may cause Azure AD sync to not upload all devices. Management of these clients may not function properly.
