...
##### Review CMGatewaySyncUploadWorker.log
...
1. Click on any of the following actions:
   ...
   [![All managed devices in Microsoft Endpoint Manager admin center](../../media/3555758-device-overview-actions.png)](../../media/3555758-device-overview-actions.png#lightbox)