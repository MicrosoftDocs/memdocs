...
- **State Code**: You can right-click on the Orchestration Group member and select **Reset Orchestration Group Member**. This allows you to rerun orchestration. States include: 
   - Idle
...
- **Sequence Number**: If the member performs the orchestration with the first group of devices or second. The sequence number is dependant on the **Rules Selection** for the group.  
