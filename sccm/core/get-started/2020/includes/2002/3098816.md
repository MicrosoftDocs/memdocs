...
- **Current Sequence Number**: Indicates for which group of members orchestration is active. This number corresponds with the **Sequence Number** for the member.  
...
- **Sequence Number**: If the member performs the orchestration with the first group of devices or second. The sequence number is dependent on the **Rules Selection** for the group.  
