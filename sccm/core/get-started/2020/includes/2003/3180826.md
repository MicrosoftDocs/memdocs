...
> [!NOTE]
> This new wizard is only in the Configuration Manager console. [Support Center](/configmgr/core/support/support-center) has a similar feedback experience, which doesn't change in this release.
...
- If you have multiple issues, send a frown more than once for each issue. Don't include multiple issues in a single report.
...
- Do you need immediate assistance? If so, contact Microsoft support for urgent issues. For more information, see [Support options and community resources](/configmgr/core/understand/find-help#BKMK_SupportOptions).

- Is this feedback a suggestion to improve the product? If so, share a new idea on UserVoice. For more information, see [Send a suggestion](/configmgr/core/understand/find-help#send-a-suggestion).

- Is the issue with the product documentation? You can file feedback directly on the documentation. For more information, see [Doc feedback](/configmgr/core/understand/use-docs#bkmk_docfeedback).
...
- Select the option to **Save a copy of feedback and attachments**. For more information on how to send it to Microsoft, see [Send feedback that you saved for later submission](/configmgr/core/understand/find-help#BKMK_NoInternet).
