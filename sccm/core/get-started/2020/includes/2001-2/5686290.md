...
## <a name="bkmk_cmg"></a> Internet-based workgroup clients over CMG

<!--5686290-->

Some customers have many internet-based clients that don't use VPN, and aren't joined to on-premises Active Directory or cloud-based Azure Active Directory (Azure AD). The cloud management gateway (CMG) [supports workgroup clients](/configmgr/core/clients/manage/cmg/certificates-for-cloud-management-gateway#for-internet-based-clients-communicating-with-the-cloud-management-gateway), but even with [Enhanced HTTP](/configmgr/core/plan-design/hierarchy/enhanced-http), a workgroup client requires a client authentication certificate. This certificate requirement can be challenging to provision on internet-based workgroup devices.
