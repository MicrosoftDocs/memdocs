...
On a computer that has the Configuration Manager console, install Power BI Desktop. Make sure the language is the same.
...
- **Run in Browser**: Opens the Power BI report in the web browser. Share this URL with others.
