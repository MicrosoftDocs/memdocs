...
The step also now sets read-only variables for whether the check succeeded (`0`) or failed (`1`). If you don't enable a check, the value of the corresponding read-only variable is blank.
