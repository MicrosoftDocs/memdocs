...
### SQL Server memory  
 Reserve memory for SQL Server by using SQL Server Management Studio and setting the **Minimum server memory** setting under **Server Memory Options**. For more information about how to configure this setting, see [How to: Set a Fixed Amount of Memory (SQL Server Management Studio)](http://go.microsoft.com/fwlink/p/?LinkId=233759).  
...
-   The **local system** account of the computer that runs SQL Server:  
    ...
    -   Using the local system account for the SQL Server service is not a SQL Server best practice.  
