...
> [!IMPORTANT]  
>  In a hierarchy where the central administration site uses a Standard edition of SQL Server, the hierarchy supports a maximum of 50,000 desktops and devices. This requirement applies only to a central administration site, and does not apply to a stand-alone primary site or a child primary site where the edition of SQL Server you use does not limit that site's capacity to support the stated number of clients.   
