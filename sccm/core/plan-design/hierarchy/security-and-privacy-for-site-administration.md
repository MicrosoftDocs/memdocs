...
This section contains security and privacy information for System Center Configuration Manager sites and the hierarchy:  
 ...
 **Configure static IP addresses for site systems.**  
 ...
 Static IP addresses also make the configuration of IPsec easier, which is a security best practice for securing communication between site systems in Configuration Manager.  
 ...
 **Secure Configuration Manager backups and secure the communication channel when you backup and restore.**  
