...
|**Proxy servers** for site system servers and for client communications. You can specify separate proxy servers for different site system servers and clients.|Because you specify these settings when you install a site system role or client, you need to know the proxy server settings when you set up site system roles and clients.<br /><br /> If you're not sure that your deployment will need to use proxy servers, review [Proxy server support in System Center Configuration Manager](../../../core/plan-design/network/proxy-server-support.md) to learn about  site system roles and client actions that can use a proxy server.|  
