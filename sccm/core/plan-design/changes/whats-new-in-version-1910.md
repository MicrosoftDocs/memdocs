...
For more information, see [Performance improvements for power plans](https://docs.microsoft.com/en-us/configmgr/osd/deploy-use/manage-task-sequences-to-automate-tasks#bkmk_perf).
