...
##  [Learn about the editions of Configuration Manager]((understand/learn-more-editions)
...
###  [Levels of diagnostic usage data that is collected for version 1511](plan-design/diagnostics/levels-of-diagnostic-usage-data-collection-1511.md)
###  [Levels of diagnostic usage data that is collected for version 1602](plan-design/diagnostics/levels-of-diagnostic-usage-data-collection-1602.md)
###  [Levels of diagnostic usage data that is collected for version 1606](plan-design/diagnostics/levels-of-diagnostic-usage-data-collection-1606.md)
...
###  [Planning for collections](clients/manage/collections/planning-for-collections.md)
...
###  [Operations and maintenance for collections](clients/manage/collections/operations-and-maintenance-for-collections.md)
...
##   [Remote control](clients/manage/remote-control/remote-control-technical-reference.md)
###  [Introduction to remote control](clients/manage/remote-control/introduction-to-remote-control.md)
###  [Planning for remote control](clients/manage/remote-control/planning-for-remote-control.md)
...
###  [Operations and maintenance for remote control](clients/manage/remote-control/operations-and-maintenance-for-remote-control.md)
...
###  [Operations and maintenance for power management](clients/manage/power/operations-and-maintenance-for-power-management.md)
