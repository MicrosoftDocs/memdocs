...
Because the LTSB is based on the Current Branch version 1606 (with some exceptions like Intune integration and cloud-related features), most tasks used for planning deployment, configuration, and management of the two branches are identical.
