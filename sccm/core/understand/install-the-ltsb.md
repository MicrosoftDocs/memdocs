...
Uninstall the site system roles that are not supported by the LTSB:
...
- When installing the new central administration site you must use Setup from the original source media you used to install the LTSB site. To run Setup from the CD.Latest folder for this scenario is not supported.
