...
> [!NOTE]
> If you query non-WMI entities on **This PC**, you'll see an **Invalid namespace** exception. For example, the following query would return the exception in the CMPivot:
>
> ```kusto
> CCMRecentlyUsedApplications
> | summarize dcount( device ) by ProductName
