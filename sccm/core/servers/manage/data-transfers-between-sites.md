...
To configure a database replication link, on the **Database Replication** node in the Configuration Manager console, edit the properties for the link. This node appears both in the **Monitoring** workspace, and in the **Administration** workspace, under the **Hierarchy Configuration** node. You can edit a replication link from either the parent site or the child site of the replication link.  
