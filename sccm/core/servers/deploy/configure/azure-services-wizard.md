...
On 1806 and later:
+ Created app:  Under **Cloud Services node** go to **Azure Active Directory Tenants**, on details pane, select the Tenant on which the application was created, and select **Renew Secret Key**. Enter azure credentials.
