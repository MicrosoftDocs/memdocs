---
title: "Install sites | Microsoft Docs"
...
Essential information that can help you install a site to a new or existing hierarchy. This includes when to choose non-default source files, limitations that apply to all sites, and optional actions you can take to help simplify your tasks when you install more than a single site.
...
[Install the Configuration Manager console](../../../../core/servers/deploy/install/install-consoles.md)     
...
[Upgrade an evaluation installation to a full installation](../../../../core/servers/deploy/install/upgrade-an-evaluation-install-to-a-full-install.md)   
