...
7.  To share distribution points between the source and destination hierarchies, select **Enable distribution point sharing for the source site server**. If you do not enable distribution point sharing at this time, you can do so by editing the credentials of the source site after data gathering has finished.  
