...
# [How to bulk-enroll devices with On-premises Mobile Device Management in System Center Configuration Manager](mdm/deploy-use/bulk-enroll-devices-with-on-premises-mobile-device-management.md)
...
# [Manage Office 365 ProPlus updates with Configuration Manager](sup/deploy-use/manage-office-365-proplus-updates.md)
# [Example scenario for using System Center Configuration Manager to deploy and monitor the security software updates released monthly by Microsoft](sup/deploy-use/example-scenario-deploy-monitor-monthly-security-updates.md)
# [Monitor software updates in System Center Configuration Manager](sup/deploy-use/monitor-software-updates.md)
...
# [Service a server group](sup/deploy-use/service-a-server-group.md)
# [Integration with Windows Update for Business in Windows 10](sup/deploy-use/integrate-windows-update-for-business-windows-10.md)
...
# [How to determine the port settings used by WSUS in System Center Configuration Manager](sup/plan-design/determine-wsus-port-settings.md)
# [Plan for software updates in System Center Configuration Manager](sup/plan-design/plan-for-software-updates.md)
# [How to enable CRL checking for software updates in System Center Configuration Manager](sup/plan-design/enable-crl-checking-for-software-updates.md)
