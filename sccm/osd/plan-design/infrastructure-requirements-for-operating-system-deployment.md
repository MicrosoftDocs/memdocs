...
For a list of the versions of the Windows 10 ADK that you can use with different versions of Configuration Manager, see [Support For Windows 10 as a client](..\..\core\plan-design\configs\support-for-windows-10.md).
