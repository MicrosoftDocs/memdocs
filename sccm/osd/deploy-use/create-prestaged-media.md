...
-   [Install a new version of Windows on a new computer (bare metal) with System Center Configuration Manager](install-new-windows-version-new-computer-bare-metal.md)  
...
10. On the **Images** page, specify the following information, and then click **Next**.  
    ...
    -   In the **Image package** box, specify the operating system image. For more information, see [Manage operating system images with System Center Configuration Manager](../get-started/manage-operating-system-images.md).  
