...
- [Windows 10 and Windows 8.1 devices](emm-create-configuration-items-for-windows-8.1-and-windows-10-devices-managed-without-the-client)
- [Windows Phone devices](emm-create-configuration-items-for-windows-phone-devices-managed-without-the-client)
- [iOS and Mac devices](emm-create-configuration-items-for-ios-and-mac-os-x-devices-managed-without-the-client)
- [Android and Samsung KNOX Standard devices](emm-create-configuration-items-for-android-and-samsung-knox-devices-managed-without-the-client)

**Applications** can be deployed to managed devices:
- [iOS applications](emm-creating-ios-applications)
- [Mac applications](../../apps/get-started/creating-mac-computer-applications)
- [Windows PC applications](../../apps/get-started/creating-windows-applications)
- [Windows Phone applications](emm-creating-windows-phone-applications)
- [Android applications](emm-creating-android-applications)

**Conditional access** lets you manage access to company resources including:  
- [Email access](emm-manage-email-access)
- [SharePoint access](emm-manage-sharepoint-online-access)
- [Skype for Business access](emm-manage-skype-for-business-online-access)
- [Dynamic CRM Online](emm-manage-dynamics-crm-online-access)
