...
7.  On the **Device Settings** page of the wizard, select the settings group that you want to configure. See **Android and Samsung KNOX configuration item settings reference** in this topic for details, and then click **Next**.  
...
|------------------|-------------|  
|**Allow data sharing between work and personal profiles**|Choose from:<br>- **Not Configured**<br>- **Prevent any sharing across boundaries**<br>- **Apps in Work profile can handle request from personal profile**<br>- **No restrictions on sharing**<br>|  
