...
> [!NOTE]  
>  Inventory on the apps installed on mobile devices is collected as part of the [hardware inventory](emm-mobile-device-hardware-inventory-hybrid.md) process.  
