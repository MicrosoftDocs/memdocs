---
title: "Create configuration items for iOS and Mac OS X devices managed with Intune | Microsoft Docs"
...
---
# Create configuration items for iOS and Mac OS X devices managed with Intune
