...
## [Set up on-premises MDM](get-started/preparation-steps-for-on-premises-mobile-device-management.md)
### [Set up Intune](get-started/set-up-a-microsoft-intune-subscription-for-on-premises-mobile-device-management.md)
### [Install on-premises roles](get-started/install-site-system-roles-for-on-premises-mobile-device-management.md)
### [Set up certificates](get-started/set-up-certificates-for-trusted-communications-for-on-premises-mobile-device-management.md)
### [Set up device enrollment](get-started/set-up-device-enrollment-for-on-premises-mobile-device-management.md)
## [Enroll devices for on-premises MDM](deploy-use/enroll-devices-for-on-premises-mobile-device-management.md)
