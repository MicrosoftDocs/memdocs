...
## [Manage resource access](deploy-use/emm-create-wifi-profiles.md)
...
## [Manage access based on risk](deploy-use/emm-manage-access-based-on-device-network-app-risk.md)
