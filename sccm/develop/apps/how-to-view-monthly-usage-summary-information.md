...
You view monthly usage summary information, in System Center Configuration Manager, by using the [SMS_MeteredFiles](assetId:///SMS_MeteredFiles?qualifyHint=False&autoUpgrade=True), [SMS_MonthlyUsageSummary](assetId:///SMS_MonthlyUsageSummary?qualifyHint=False&autoUpgrade=True), [SMS_MeteredUser](assetId:///SMS_MeteredUser?qualifyHint=False&autoUpgrade=True) and [SMS_R_System](assetId:///SMS_R_System?qualifyHint=False&autoUpgrade=True) classes.  
...
2.  Get all the metered files (assetId:///SMS_MeteredFiles?qualifyHint=False&autoUpgrade=True).  
  
3.  Get all the monthly file usage summary information (assetId:///SMS_MonthlyUsageSummary?qualifyHint=False&autoUpgrade=True).  
  
4.  Get all the metered users (assetId:///SMS_MeteredUser?qualifyHint=False&autoUpgrade=True).  
  
5.  Get all the computer names (assetId:///SMS_R_System?qualifyHint=False&autoUpgrade=True).  
  
6.  Loop through the collections, displaying information as required.  
  
## Example  
 The following example method displays file usages summary information by using the assetId:///SMS_MeteredFiles?qualifyHint=False&autoUpgrade=True and [SMS_FileUsageSummary](assetId:///SMS_FileUsageSummary?qualifyHint=False&autoUpgrade=True) classes.  
