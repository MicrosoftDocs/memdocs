---
title: "Enumerate the Available OS Deployment Task Sequences | Configuration Manager"
ms.custom: ""
ms.date: "2016-09-20"
...
You enumerate the available operating system deployment task sequences, in System Center Configuration Manager, by querying the available task sequence packages. System Center Configuration Manager does not maintain instances of the [SMS_TaskSequence](assetId:///SMS_TaskSequence?qualifyHint=False&autoUpgrade=True) class for task sequences, but there is one instance of the [SMS_TaskSequencePackage](assetId:///SMS_TaskSequencePackage?qualifyHint=False&autoUpgrade=True) class for each task sequence.  

> [!NOTE]
>  Several properties are lazy and you must get the object instance before you can access the properties.  

 You can also access individual task sequence packages by using the [PackageID](assetId:///PackageID?qualifyHint=False&autoUpgrade=True) key property. For an example, see [How to Read a Configuration Manager Object by Using Managed Code](../../develop/core/understand/how-to-read-a-configuration-manager-object-by-using-managed-code.md). After you have the task sequence package, you must create an assetId:///SMS_TaskSequence?qualifyHint=False&autoUpgrade=True object for the task sequence before you can change it. For more information, see [How to Read a Task Sequence From a Task Sequence Package](../../develop/osd/how-to-read-a-task-sequence-from-a-task-sequence-package.md).  

### To enumerate the available task sequence packages  

1.  Set up a connection to the SMS Provider. For more information, see [About the SMS Provider in Configuration Manager](../../develop/core/understand/about-the-sms-provider-in-configuration-manager.md).  

2.  Query the SMS Provider for the available instances of assetId:///SMS_TaskSequencePackage?qualifyHint=False&autoUpgrade=True.  

3.  Display the required properties for each task sequence package returned by the query.  

## Example  
 The following example method queries the SMS Provider for the available instance of (assetId:///SMS_TaskSequencePackage?qualifyHint=False&autoUpgrade=True). To retrieve the lazy properties, the example gets the entire object from the SMS Provider.  
