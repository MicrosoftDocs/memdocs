...
In System Center Configuration Manager, you add context qualifiers to a connection ([SWbemServices](assetId:///SWbemServices?qualifyHint=False&autoUpgrade=True)) or object ([SWbemObject](assetId:///SWbemObject?qualifyHint=False&autoUpgrade=True)) by creating a [SWbemNamedValueSet](assetId:///SWbemNamedValueSet?qualifyHint=False&autoUpgrade=True) value set to hold the context qualifiers. You then provide the assetId:///SWbemNamedValueSet?qualifyHint=False&autoUpgrade=True value set as a parameter to connection and object methods.  
...
2.  Create a [WbemScripting.SWbemNamedValueSet](assetId:///WbemScripting.SWbemNamedValueSet?qualifyHint=False&autoUpgrade=True) object and add the desired context qualifiers.  
  
3.  Use the [SWbemNamedValue](assetId:///SWbemNamedValue?qualifyHint=False&autoUpgrade=True) value set you created in step two to pass context qualifiers to connection and object manipulation calls.  
  
## Example  
 The following VBScript example creates a assetId:///SWbemNamedValueSet?qualifyHint=False&autoUpgrade=True value set and adds the supplied context qualifiers. The following code example demonstrates how to call the method for use in an [SMS_Package](assetId:///SMS_Package?qualifyHint=False&autoUpgrade=True) package object [Put](assetId:///Put?qualifyHint=False&autoUpgrade=True) method call. For more information about Configuration Manager objects, see [About Configuration Manager Objects](../../../develop/core/understand/about-configuration-manager-objects.md).  
