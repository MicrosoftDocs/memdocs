...
## Joining package and program deployment and vollection views
...
[Application nanagement views in Configuration Manager](application-management-views-configuration-manager.md)