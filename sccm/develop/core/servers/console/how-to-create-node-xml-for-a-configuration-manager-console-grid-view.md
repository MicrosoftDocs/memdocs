...
To create the node XML for the System Center Configuration Manager console default grid view you create an XML file describing a <xref:Microsoft.ConfigurationManagement.AdminConsole.Schema.RootNodeDescription> element.  
