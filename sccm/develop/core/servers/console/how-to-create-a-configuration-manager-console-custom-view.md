...
### Create the View Controller Class  
 The following procedure creates the <xref:Microsoft.ConfigurationManagement.AdminConsole.> OverviewControllerBase?qualifyHint=False&autoUpgrade=True derived class. The controller class’s Content property is set contain your custom control. In the example below, the Content property is assigned a simple label control.  
...
### Create the View Description Class  
 The following procedure creates the <xref:Microsoft.ConfigurationManagement.AdminConsole.IConsoleView2> derived class.  
