---
title: "How to Configure Software Inventory Settings"
ms.custom: ""
ms.date: "2016-09-20"
...
## Example  
 The following example sets the Software Inventory Client Agent settings by using the [SMS_SCI_ClientComp](assetId:///SMS_SCI_ClientComp?qualifyHint=False&autoUpgrade=True) class to connect to the site control file and change properties.  
