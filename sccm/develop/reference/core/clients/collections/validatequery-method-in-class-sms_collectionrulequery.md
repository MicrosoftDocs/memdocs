...
## Remarks  
 ...
 In addition to being syntactically correct, the query rule must specify resource class names in the FROM clause. For example, the FROM clause must specify [SMS_R_System Server WMI Class](../Topic/SMS_R_System%20Server%20WMI%20Class.md), [SMS_R_User Server WMI Class](../Topic/SMS_R_User%20Server%20WMI%20Class.md), [SMS_R_UserGroup Server WMI Class](../Topic/SMS_R_UserGroup%20Server%20WMI%20Class.md), or a user-defined resource class name.  
