...
### [Reporting Server WMI Classes](configuration-manager-reporting-server-wmi-classes.md)
#### [SMS_ReportViewSchema Server WMI Class](sms_reportviewschema-server-wmi-class.md)
##### [GetSampleValues Method in Class SMS_ReportViewSchema](getsamplevalues-method-in-class-sms_reportviewschema.md)

### [Resource Management Server WMI Classes](configuration-manager-resource-management-server-wmi-classes.md)
#### [Hardware Inventory Server WMI Classes](hardware-inventory-server-wmi-classes.md)
##### [SMS_G_System_SYSTEM Server WMI Class](sms_g_system_system-server-wmi-class.md)
##### [SMS_G_Sysetm_WORKSTATION_STATUS Server WMI Class](sms_g_system_workstation_status-server-wmi-class.md)
##### [SMS_InventoryClass Server WMI Class](sms_inventoryclass-server-wmi-class.md)
##### [SMS_InventoryClassProperty Server WMI Class](sms_inventoryclassproperty-server-wmi-class.md)
##### [SMS_InventoryReport Server WMI Class](sms_inventoryreport-server-wmi-class.md)
###### [ImportInventoryReport Method in Class SMS_InventoryReport](importinventoryreport-method-in-class-sms_inventoryreport.md)
##### [SMSInventoryReportClass Server WMI Class](sms_inventoryreportclass-server-wmi-class.md)
#### [SMS_G_System Server WMI Class](sms_g_system-server-wmi-class.md)
#### [SMS_G_System_AdvancedThreatProtectionHealthStatus Server WMI Class](sms_g_system_advancedthreatprotectionhealthstatus-server-wmi-class.md)
#### [SMS_G_System_CollectedFile Server WMI Class](sms_g_system_collectedfile-server-wmi-class.md)
#### [SMS_G_System_Current Server WMI Class](sms_g_system_current-server-wmi-class.md)
#### [SMS_G_System_ExHistory Server WMI Class](sms_g_system_exthistory-server-wmi-class.md)
#### [SMS_G_System_History Server WMI Class](sms_g_system_history-server-wmi-class.md)
#### [SMS_G_System_LastSoftwareScan Server WMI Class](sms_g_system_lastsoftwarescan-server-wmi-class.md)
#### [SMS_G_SYSTEM_ResourceClientSettingsAssignment Server WMI Class](sms_g_system_resourceclientsettingsassignment-server-wmi-class.md)
#### [SMS_G_System_SoftwareFile Server WMI Class](sms_g_system_softwarefile-server-wmi-class.md)
#### [SMS_G_System_SoftwareProduct Server WMI Class](sms_g_system_softwareproduct-server-wmi-class.md)
#### [SMS_G_System_UnknownFile Server WMI Class](sms_g_system_unknownfile-server-wmi-class.md)
#### [SMS_Group Server WMI Class](sms_group-server-wmi-class.md)
#### [SMS_PendingRegistrationRecord Server WMI Class](sms_pendingregistrationrecord-server-wmi-class.md)
##### [ResolvePendingRegistrationRecord Method in Class SMS_PendingRegistrationRecord](resolvependingregistrationrecord-method-in-class-sms_pendingregistrationrecord.md)
#### [SMS_Query Server WMI Class](sms_query-server-wmi-class.md)
##### [CreateCCRs Method in Class SMS_Query](createccrs-method-in-class-sms_query.md)
##### [FindResourceSite Method in Class SMS_Query](findresourcesite-method-in-class-sms_query.md)
#### [SMS_R_IPNetwork Server WMI Class](sms_r_ipnetwork-server-wmi-class.md)
#### [SMS_R_System Server WMI Class](sms_r_system-server-wmi-class.md)
#### [SMS_R_User Server WMI Class](sms_r_user-server-wmi-class.md)
#### [SMS_R_UserGroup Server WMI Class](sms_r_usergroup-server-wmi-class.md)
#### [SMS_ResIDValueLookup Server WMI Class](sms_residvaluelookup-server-wmi-class.md)
...
##### [GetClassesWithData Method in Class SMS_ResourceMap](getclasseswithdata-method-in-class-sms_resourcemap.md)
##### [Refresh Method in Class SMS_ResourceMap](refresh-method-in-class-sms_resourcemap.md)
#### [SMS_SoftwareConversionRules Server WMI Class](sms_softwareconversionrules-server-wmi-class.md)
#### [SMS_UserMachineRelationship Server WMI Class](sms_usermachinerelationship-server-wmi-class.md)
##### [AddSource Method in Class SMS_UserMachineRelationship](addsource-method-in-class-sms_usermachinerelationship.md)
##### [AddType Method in Class SMS_UserMachineRelationship](addtype-method-in-class-sms_usermachinerelationship.md)
##### [CreateRelationship Method in Class SMS_UserMachineRelationship](createrelationship-method-in-class-sms_usermachinerelationship.md)
##### [RemoveSource Method in Class SMS_UserMachineRelationship](removesource-method-in-class-sms_usermachinerelationship.md)
##### [RemoveType Method in Class SMS_UserMachineRelationship](removetype-method-in-class-sms_usermachinerelationship.md)
