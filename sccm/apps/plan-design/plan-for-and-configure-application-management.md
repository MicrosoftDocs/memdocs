...
|Client settings|Many client settings control how applications are installed on the client and the end user experience on the client. These client settings include the following:<br /><br /> - Computer Agent<br /><br /> - Computer Restart<br /><br /> - Software Deployment<br /><br /> - User and Device Affinity<br /><br /> For more information about these client settings, see [About client settings in System Center Configuration Manager](../../core/clients/deploy/about-client-settings.md).<br /><br /> For information about how to configure client settings, see [How to configure client settings in System Center Configuration Manager](../../core/clients/deploy/configure-client-settings.md).|  
|For the Application Catalog:<br /><br /> Discovered user accounts|Users must first be discovered by Configuration Manager before they can view and request applications from the Application Catalog. For more information, see [Run discovery for System Center Configuration Manager](/sccm/core/servers/deploy/configure/run-discovery).|  
