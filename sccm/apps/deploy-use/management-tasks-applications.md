...
|**Copy Applications**|Copy, or duplicate, Configuration Manager applications to create a new one. This action is useful to test something or when you need to create a similar application.|
