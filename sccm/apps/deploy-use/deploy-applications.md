...
On the **Scheduling** page of the Deploy Software wizard, set the time when this application will be deployed or made available to client devices.
...
3.  In the **Applications** list, select the application that includes the deployment you will delete.
