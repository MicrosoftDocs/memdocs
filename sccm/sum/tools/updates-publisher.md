...
> [!TIP]  
> The previous version, [System Center Updates Publisher 2011](http://go.microsoft.com/fwlink/?LinkId=83534), remains in support. This updated version retains the same functionality, but supports additional operating systems, new features to simplify some tasks, and has an updated user interface.
