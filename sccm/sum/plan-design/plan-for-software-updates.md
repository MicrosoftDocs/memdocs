...
-   If a superseding software update was not approved for deployment in your production environment.  
    ...
    > [!NOTE]  
    >  When Configuration Manager sets a superseded software update to **expired**, it does not set the update to **expired** in WSUS. This means that clients will continue to scan for an expired update.
